...
public class DartMenuItem extends DartItem implements IMenuItem {
    ...
    void releaseWidget() {
        super.releaseWidget();
        accelerator = 0;
        if (this.getApi() == ((DartMenu) parent.getImpl()).defaultItem)
            ((DartMenu) parent.getImpl()).defaultItem = null;
    }
    ...
    public void setAccelerator(int accelerator) {
        ...
        if (key == SWT.ESC && /* no masks */
        key == accelerator && !((DartDisplay) display.getImpl()).escAsAcceleratorPresent) {
            ((DartDisplay) display.getImpl()).escAsAcceleratorPresent = true;
        }
    }
    ...
    public void setMenu(Menu menu) {
        ...
        if (menu != null) {
            ...
            if (((DartMenu) parent.getImpl()).parent != null && ((DartMenu) menu.getImpl()).parent != ((DartMenu) parent.getImpl()).parent) {
