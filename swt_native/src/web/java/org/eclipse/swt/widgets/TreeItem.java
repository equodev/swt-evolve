...
public class TreeItem extends Item {
    ...
    public TreeItem(Tree parent, int style) {
        this((ITreeItem) null);
        setImpl(new DartTreeItem(parent, style, this));
    }
    ...
    public TreeItem(Tree parent, int style, int index) {
        this((ITreeItem) null);
        setImpl(new DartTreeItem(parent, style, index, this));
    }
    ...
    public TreeItem(TreeItem parentItem, int style) {
        this((ITreeItem) null);
        setImpl(new DartTreeItem(parentItem, style, this));
    }
    ...
    public TreeItem(TreeItem parentItem, int style, int index) {
        this((ITreeItem) null);
        setImpl(new DartTreeItem(parentItem, style, index, this));
    }

    TreeItem(Tree parent, TreeItem parentItem, int style, int index, boolean create) {
        this((ITreeItem) null);
        setImpl(new DartTreeItem(parent, parentItem, style, index, create, this));
    }
