 ...
 */
public class DartDirectoryDialog extends DartDialog implements IDirectoryDialog {
     ...
     * </ul>
     */
    public DartDirectoryDialog(Shell parent, DirectoryDialog api) {
     ...
     * </ul>
     */
    public DartDirectoryDialog(Shell parent, int style, DirectoryDialog api) {
    ...
    public DirectoryDialog getApi() {
        if (api == null)
            api = DirectoryDialog.createApi(this);
        return (DirectoryDialog) api;
    }

    public VDirectoryDialog getValue() {
        if (value == null)
            value = new VDirectoryDialog(this);
        return (VDirectoryDialog) value;
    }
}
