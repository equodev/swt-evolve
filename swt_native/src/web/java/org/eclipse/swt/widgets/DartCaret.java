...
public class DartCaret extends DartWidget implements ICaret {
    ...
    void createWidget() {
        super.createWidget();
        blinkRate = display.getImpl().getCaretBlinkTime();
        isVisible = true;
    ...
    boolean isFocusCaret() {
        return this.getApi() == ((DartDisplay) display.getImpl()).currentCaret;
    }

    void killFocus() {
        if (((DartDisplay) display.getImpl()).currentCaret != this.getApi())
            return;
        display.getImpl().setCurrentCaret(null);
        if (isVisible)
            hideCaret();
    }
    ...
    void setFocus() {
        if (((DartDisplay) display.getImpl()).currentCaret == this.getApi())
            return;
        display.getImpl().setCurrentCaret(this.getApi());
        if (isVisible)
            showCaret();
    }
