 ...
 */
public class DartFontDialog extends DartDialog implements IFontDialog {
     ...
     * </ul>
     */
    public DartFontDialog(Shell parent, FontDialog api) {
     ...
     * </ul>
     */
    public DartFontDialog(Shell parent, int style, FontDialog api) {
    ...
    public FontData open() {
        Display display = parent != null ? ((DartWidget) parent.getImpl()).display : DartDisplay.getCurrent();
    ...
    public boolean _effectsVisible() {
        return effectsVisible;
    }
    ...
    public FontDialog getApi() {
        if (api == null)
            api = FontDialog.createApi(this);
        return (FontDialog) api;
    }

    public VFontDialog getValue() {
        if (value == null)
            value = new VFontDialog(this);
        return (VFontDialog) value;
    }
}
