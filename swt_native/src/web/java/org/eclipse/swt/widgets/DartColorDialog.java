 ...
 */
public class DartColorDialog extends DartDialog implements IColorDialog {
     ...
     * @see Widget#getStyle
     */
    public DartColorDialog(Shell parent, ColorDialog api) {
     ...
     * @see Widget#getStyle
     */
    public DartColorDialog(Shell parent, int style, ColorDialog api) {
    ...
    public VColorDialog getValue() {
        if (value == null)
            value = new VColorDialog(this);
        return (VColorDialog) value;
    }
}
