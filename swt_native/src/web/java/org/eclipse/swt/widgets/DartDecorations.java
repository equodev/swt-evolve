 ...
 */
public class DartDecorations extends DartCanvas implements IDecorations {
    ...
    DartDecorations(Decorations api) {
        super(api);
        /* Do nothing */
    }
     ...
     * @see Widget#getStyle
     */
    public DartDecorations(Composite parent, int style, Decorations api) {
    ...
    void fixDecorations(Decorations newDecorations, Control control, Menu[] menus) {
        ...
        if (menus == null)
            return;
        Menu menu = ((DartControl) control.getImpl()).menu;
        if (menu != null) {
            int index = 0;
    ...
    void releaseChildren(boolean destroy) {
        ...
        Menu[] menus = ((DartDisplay) display.getImpl()).getMenus(this.getApi());
        if (menus != null) {
    ...
    public void setDefaultButton(Button button) {
        ...
        ((DartDisplay) display.getImpl()).updateDefaultButton();
    }
    ...
    public void setMenuBar(Menu menu) {
        ...
        if (menu != null) {
            ...
            if (((DartMenu) menu.getImpl()).parent != this.getApi())
                error(SWT.ERROR_INVALID_PARENT);
        }
        menuBar = menu;
    }
    ...
    boolean traverseReturn() {
        ...
        if (!defaultButton.isVisible() || !defaultButton.isEnabled())
            return false;
        ((DartButton) defaultButton.getImpl()).click();
        return true;
    }
    ...
    public VDecorations getValue() {
        if (value == null)
            value = new VDecorations(this);
        return (VDecorations) value;
    }
}
