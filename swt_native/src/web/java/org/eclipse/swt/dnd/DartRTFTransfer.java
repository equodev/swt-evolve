 ...
 * @see Transfer
 */
public class DartRTFTransfer extends DartByteArrayTransfer implements IRTFTransfer {

    static RTFTransfer _instance = new RTFTransfer();

    static final String RTF = "public.rtf";

    static final int RTFID = registerType(RTF);

    DartRTFTransfer(RTFTransfer api) {
        super(api);
    }
    ...
    public VRTFTransfer getValue() {
        if (value == null)
            value = new VRTFTransfer(this);
        return (VRTFTransfer) value;
    }
}
