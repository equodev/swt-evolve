 ...
 */
public class DartDragSourceAdapter implements DragSourceListener, IDragSourceAdapter {
    ...
    public DragSourceAdapter getApi() {
        if (api == null)
            api = DragSourceAdapter.createApi(this);
        return (DragSourceAdapter) api;
    }

    protected DragSourceAdapter api;
    ...
    public DartDragSourceAdapter(DragSourceAdapter api) {
        setApi(api);
    }
}
