 ...
 */
public class DartTransferData implements ITransferData {
    ...
    protected VTransferData value;

    public VTransferData getValue() {
        if (value == null)
            value = new VTransferData(this);
        return (VTransferData) value;
    }

    public DartTransferData(TransferData api) {
        setApi(api);
    }
}
