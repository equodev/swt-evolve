 ...
 * @since 3.3
 */
public class DartDropTargetEffect extends DartDropTargetAdapter implements IDropTargetEffect {
     ...
     * </ul>
     */
    public DartDropTargetEffect(Control control, DropTargetEffect api) {
        super(api);
        if (control == null)
