 ...
 */
public class DartDropTargetAdapter implements DropTargetListener, IDropTargetAdapter {
    ...
    public DropTargetAdapter getApi() {
        if (api == null)
            api = DropTargetAdapter.createApi(this);
        return (DropTargetAdapter) api;
    }

    protected DropTargetAdapter api;
    ...
    public DartDropTargetAdapter(DropTargetAdapter api) {
        setApi(api);
    }
}
