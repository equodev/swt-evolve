...
public class SelectionEvent extends TypedEvent {
    ...
    public String toString() {
        ...
        string.substring(0, string.length() - 1) + " item=" + item + " detail=" + detail + " x=" + x + " y=" + y + " width=" + width + " height=" + height + " stateMask=0x" + Integer.toHexString(stateMask) + " text=" + text + " doit=" + doit + "}";
    }
}
