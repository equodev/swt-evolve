...
public class KeyEvent extends TypedEvent {
    ...
    public String toString() {
        ...
        string.substring(0, string.length() - 1) + " character='" + ((character == 0) ? "\\0" : String.valueOf(character)) + "'=0x" + Integer.toHexString(character) + " keyCode=0x" + Integer.toHexString(keyCode) + " keyLocation=0x" + Integer.toHexString(keyLocation) + " stateMask=0x" + Integer.toHexString(stateMask) + " doit=" + doit + "}";
    }
}
