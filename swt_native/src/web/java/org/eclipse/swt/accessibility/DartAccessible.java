...
public class DartAccessible implements IAccessible {
    ...
    public DartAccessible(Accessible parent, Accessible api) {
        ...
        this.parent = parent;
        this.control = ((DartAccessible) parent.getImpl()).control;
    }
    ...
    public void addRelation(int type, Accessible target) {
        ...
        ((DartRelation) relations[type].getImpl()).addTarget(target);
    }
    ...
    public void removeRelation(int type, Accessible target) {
        ...
        if (target == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
        if (relations[type] != null) {
            ((DartRelation) relations[type].getImpl()).removeTarget(target);
        }
    }
