...
public class DartScrolledComposite extends DartComposite implements IScrolledComposite {
     ...
     * @see #getStyle()
     */
    public DartScrolledComposite(Composite parent, int style, ScrolledComposite api) {
    ...
    public ScrolledComposite getApi() {
        if (api == null)
            api = ScrolledComposite.createApi(this);
        return (ScrolledComposite) api;
    }

    public VScrolledComposite getValue() {
        if (value == null)
            value = new VScrolledComposite(this);
        return (VScrolledComposite) value;
    }
}
