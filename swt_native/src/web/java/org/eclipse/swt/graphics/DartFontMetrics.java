...
public final class DartFontMetrics implements IFontMetrics {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FontMetrics metrics))
            return false;
        return ascent == ((DartFontMetrics) metrics.getImpl()).ascent && descent == ((DartFontMetrics) metrics.getImpl()).descent && leading == ((DartFontMetrics) metrics.getImpl()).leading && height == ((DartFontMetrics) metrics.getImpl()).height && (Double.compare(averageCharWidth, ((DartFontMetrics) metrics.getImpl()).averageCharWidth) == 0);
    }
