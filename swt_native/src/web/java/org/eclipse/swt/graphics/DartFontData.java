...
public final class DartFontData implements IFontData {
    ...
    public DartFontData(FontData fontData, FontData api) {
        ...
        this.getApi().name = fontData.name;
        this.getApi().height = fontData.height;
        this.getApi().style = fontData.style;
        this.getApi().nsName = fontData.nsName;
        this.lang = ((DartFontData) fontData.getImpl()).lang;
        this.country = ((DartFontData) fontData.getImpl()).country;
        this.variant = ((DartFontData) fontData.getImpl()).variant;
    }
