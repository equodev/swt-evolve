 ...
 */
public abstract class DartDevice implements Drawable, IDevice {

    boolean debug = Device.DEBUG;

    boolean tracking = Device.DEBUG;
...
*/
     ...
     * @see DeviceData
     */
    public DartDevice(DeviceData data, Device api) {
        setApi(api);
    ...
    FontData[] fontList = new FontData[0];
    ...
    public boolean _warnings() {
        return warnings;
    }

    public Color _COLOR_BLACK() {
        return COLOR_BLACK;
    }

    public Color _COLOR_DARK_RED() {
        return COLOR_DARK_RED;
    }

    public Color _COLOR_DARK_GREEN() {
        return COLOR_DARK_GREEN;
    }

    public Color _COLOR_DARK_YELLOW() {
        return COLOR_DARK_YELLOW;
    }

    public Color _COLOR_DARK_BLUE() {
        return COLOR_DARK_BLUE;
    }

    public Color _COLOR_DARK_MAGENTA() {
        return COLOR_DARK_MAGENTA;
    }

    public Color _COLOR_DARK_CYAN() {
        return COLOR_DARK_CYAN;
    }

    public Color _COLOR_GRAY() {
        return COLOR_GRAY;
    }

    public Color _COLOR_DARK_GRAY() {
        return COLOR_DARK_GRAY;
    }

    public Color _COLOR_RED() {
        return COLOR_RED;
    }

    public Color _COLOR_TRANSPARENT() {
        return COLOR_TRANSPARENT;
    }

    public Color _COLOR_GREEN() {
        return COLOR_GREEN;
    }

    public Color _COLOR_YELLOW() {
        return COLOR_YELLOW;
    }

    public Color _COLOR_BLUE() {
        return COLOR_BLUE;
    }

    public Color _COLOR_MAGENTA() {
        return COLOR_MAGENTA;
    }

    public Color _COLOR_CYAN() {
        return COLOR_CYAN;
    }

    public Color _COLOR_WHITE() {
        return COLOR_WHITE;
    }

    public Font _systemFont() {
        return systemFont;
    }
    ...
    protected VDevice value;

    public VDevice getValue() {
        if (value == null)
            value = new VDevice(this);
