...
import org.eclipse.swt.custom.ITableEditor;
 ...
 */
public class TableEditor extends ControlEditor implements ITableEditor {
     ...
     */
    public void setItem(ITableItem iitem) {
    ...
    @Override
    public void setEditor(IControl ieditor) {
        Control editor = (Control) ieditor;
     ...
     * @param column the zero based index of the column of the cell being tracked by this editor
     */
    public void setEditor(IControl ieditor, ITableItem iitem, int column) {
        TableItem item = (TableItem) iitem;
        Control editor = (Control) ieditor;
        setItem(item);
        setColumn(column);
    ...
    public static TableEditor safeDelegate(org.eclipse.swt.custom.TableEditor api) {
        return (api != null) ? (TableEditor) api.getDelegate() : null;
    }
}
