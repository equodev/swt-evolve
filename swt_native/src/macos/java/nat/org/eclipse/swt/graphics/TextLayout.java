 ...
 * @since 3.0
 */
public final class TextLayout extends Resource implements ITextLayout {
	...
	*/
     ...
     * </ul>
     */
    public void draw(IGC igc, int x, int y) {
        GC gc = (GC) igc;
     ...
     * </ul>
     */
    public void draw(IGC igc, int x, int y, int selectionStart, int selectionEnd, IColor iselectionForeground, IColor iselectionBackground) {
        Color selectionBackground = (Color) iselectionBackground;
        Color selectionForeground = (Color) iselectionForeground;
        GC gc = (GC) igc;
     ...
     * @since 3.3
     */
    public void draw(IGC igc, int x, int y, int selectionStart, int selectionEnd, IColor iselectionForeground, IColor iselectionBackground, int flags) {
        Color selectionBackground = (Color) iselectionBackground;
        Color selectionForeground = (Color) iselectionForeground;
        GC gc = (GC) igc;
        checkLayout();
                                ...
                                if (range.length > 0) {
                                    ...
                                    switch(style.borderStyle) {
                                        ...
                                        case SWT.BORDER_DASH:
                                            ...
                                            break;
                                        case SWT.BORDER_DOT:
                                            dashes = width != 0 ? GC.LINE_DOT : GC.LINE_DOT_ZERO;
                                            break;
                                    }
                                    double[] lengths = null;
                                    if (dashes != null) {
 ...
 */
    ...
    public static TextLayout safeDelegate(org.eclipse.swt.graphics.TextLayout api) {
        return (api != null) ? (TextLayout) api.getDelegate() : null;
    }
}
