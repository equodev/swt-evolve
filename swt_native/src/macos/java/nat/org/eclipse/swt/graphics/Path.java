 ...
 * @since 3.1
 */
public class Path extends Resource implements IPath {
     ...
     * </ul>
     */
    public void addString(String string, float x, float y, IFont ifont) {
     ...
     * </ul>
     */
    public boolean contains(float x, float y, IGC igc, boolean outline) {
        GC gc = (GC) igc;
        if (isDisposed())
            SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
        if (gc == null)
