 ...
 */
public class DropTarget extends Widget implements IDropTarget {
     ...
     * @since 3.3
     */
    public void setDropTargetEffect(IDropTargetEffect ieffect) {
        DropTargetEffect effect = (DropTargetEffect) ieffect;
        dropEffect = effect;
    }
