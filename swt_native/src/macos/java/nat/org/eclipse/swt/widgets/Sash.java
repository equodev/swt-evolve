...
import org.eclipse.swt.widgets.ISash;
 ...
 */
public class Sash extends Control implements ISash {
	...
	*/
    ...
    public static Sash safeDelegate(org.eclipse.swt.widgets.Sash api) {
        return (api != null) ? (Sash) api.getDelegate() : null;
    }
}
