 ...
 */
public final class Rectangle implements Serializable, IRectangle {
     ...
     * </ul>
     */
    public Rectangle intersection(IRectangle irect) {
        Rectangle rect = (Rectangle) irect;
        if (rect == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
        if (this == rect)
     ...
     * @see #add(Rectangle)
     */
    public Rectangle union(IRectangle irect) {
        Rectangle rect = (Rectangle) irect;
        if (rect == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
        int left = x < rect.x ? x : rect.x;
    ...
    public static Rectangle safeDelegate(org.eclipse.swt.graphics.Rectangle api) {
        return (api != null) ? (Rectangle) api.getDelegate() : null;
    }
}
