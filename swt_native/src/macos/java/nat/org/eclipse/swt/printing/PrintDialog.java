 ...
 * *****************************************************************************
 */
package nat.org.eclipse.swt.printing;

import org.eclipse.swt.*;
import org.eclipse.swt.internal.*;
import org.eclipse.swt.internal.cocoa.*;
import nat.org.eclipse.swt.widgets.*;
import org.eclipse.swt.printing.IPrintDialog;
import org.eclipse.swt.printing.IPrinterData;
...
public class PrintDialog extends Dialog implements IPrintDialog {
     ...
     * @since 3.4
     */
    public void setPrinterData(IPrinterData idata) {
        PrinterData data = (PrinterData) idata;
        if (data == null)
    ...
    public org.eclipse.swt.printing.PrintDialog getApi() {
        return (org.eclipse.swt.printing.PrintDialog) super.getApi();
    }
}
