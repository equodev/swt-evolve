...
import org.eclipse.swt.custom.IScrolledComposite;
 ...
 */
public class ScrolledComposite extends Composite implements IScrolledComposite {
     ...
     * @since 2.0
     */
    public void setOrigin(IPoint iorigin) {
        Point origin = (Point) iorigin;
     ...
     * </ul>
     */
    public void setMinSize(IPoint isize) {
     ...
     * @since 3.4
     */
    public void showControl(IControl icontrol) {
