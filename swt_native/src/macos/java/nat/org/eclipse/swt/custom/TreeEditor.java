...
import org.eclipse.swt.custom.ITreeEditor;
 ...
 */
public class TreeEditor extends ControlEditor implements ITreeEditor {
     ...
     */
    public void setItem(ITreeItem iitem) {
     ...
     * @since 3.1
     */
    public void setEditor(IControl ieditor, ITreeItem iitem, int column) {
        TreeItem item = (TreeItem) iitem;
     ...
     * @param item the TreeItem for the row of the cell being tracked by this editor
     */
    public void setEditor(IControl ieditor, ITreeItem iitem) {
        TreeItem item = (TreeItem) iitem;
        Control editor = (Control) ieditor;
        setItem(item);
        setEditor(editor);
