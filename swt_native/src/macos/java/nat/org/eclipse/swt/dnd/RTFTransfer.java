...
import org.eclipse.swt.dnd.IRTFTransfer;
 ...
 * @see Transfer
 */
public class RTFTransfer extends ByteArrayTransfer implements IRTFTransfer {
    ...
    public org.eclipse.swt.dnd.RTFTransfer getApi() {
        return (org.eclipse.swt.dnd.RTFTransfer) super.getApi();
    }
}
