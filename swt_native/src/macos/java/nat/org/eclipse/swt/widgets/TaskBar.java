 ...
 */
public class TaskBar extends Widget implements ITaskBar {
    ...
    public static TaskBar safeDelegate(org.eclipse.swt.widgets.TaskBar api) {
        return (api != null) ? (TaskBar) api.getDelegate() : null;
    }
}
