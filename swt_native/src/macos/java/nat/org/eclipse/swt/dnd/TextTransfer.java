...
import org.eclipse.swt.dnd.ITextTransfer;
 ...
 * @see Transfer
 */
public class TextTransfer extends ByteArrayTransfer implements ITextTransfer {
    ...
    public static TextTransfer safeDelegate(org.eclipse.swt.dnd.TextTransfer api) {
        return (api != null) ? (TextTransfer) api.getDelegate() : null;
    }
}
