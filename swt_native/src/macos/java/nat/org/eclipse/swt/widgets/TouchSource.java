 ...
 * @since 3.7
 */
public final class TouchSource implements ITouchSource {
    ...
    public static TouchSource safeDelegate(org.eclipse.swt.widgets.TouchSource api) {
        return (api != null) ? (TouchSource) api.getDelegate() : null;
    }
}
