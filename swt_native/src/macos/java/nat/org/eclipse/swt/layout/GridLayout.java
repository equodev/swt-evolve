 ...
 */
public final class GridLayout extends Layout implements IGridLayout {
    ...
    public static GridLayout safeDelegate(org.eclipse.swt.layout.GridLayout api) {
        return (api != null) ? (GridLayout) api.getDelegate() : null;
    }
}
