...
import org.eclipse.swt.widgets.ITray;
 ...
 */
public class Tray extends Widget implements ITray {
    ...
    public static Tray safeDelegate(org.eclipse.swt.widgets.Tray api) {
        return (api != null) ? (Tray) api.getDelegate() : null;
    }
}
