 ...
 */
public class TableColumn extends Item implements ITableColumn {
	 ...
	 */
        ...
        if (headerRect.x != cellRect.x || headerRect.width != cellRect.width) {
            if (parent.headerBackground != null) {
                ...
                double[] /* float */
                colorRGB = parent.headerBackground;
    ...
    public org.eclipse.swt.widgets.TableColumn getApi() {
        return (org.eclipse.swt.widgets.TableColumn) super.getApi();
    }
}
