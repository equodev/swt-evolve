 ...
 */
public class StyleRange extends TextStyle implements Cloneable, IStyleRange {
     ...
     */
    public boolean similarTo(IStyleRange istyle) {
        StyleRange style = (StyleRange) istyle;
    ...
    public static StyleRange safeDelegate(org.eclipse.swt.custom.StyleRange api) {
        return (api != null) ? (StyleRange) api.getDelegate() : null;
    }
}
