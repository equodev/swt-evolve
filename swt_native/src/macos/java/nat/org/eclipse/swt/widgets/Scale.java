...
import org.eclipse.swt.widgets.IScale;
 ...
 */
public class Scale extends Control implements IScale {
    ...
    public static Scale safeDelegate(org.eclipse.swt.widgets.Scale api) {
        return (api != null) ? (Scale) api.getDelegate() : null;
    }
}
