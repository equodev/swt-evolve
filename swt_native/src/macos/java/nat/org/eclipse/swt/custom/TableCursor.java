...
import org.eclipse.swt.custom.ITableCursor;
 ...
 */
public class TableCursor extends Canvas implements ITableCursor {
     ...
     * </ul>
     */
    public void setSelection(ITableItem irow, int column) {
        TableItem row = (TableItem) irow;
        checkWidget();
        int columnCount = table.getColumnCount();
        int maxColumnIndex = columnCount == 0 ? 0 : columnCount - 1;
