 ...
 */
public final class PrinterData extends DeviceData implements IPrinterData {
    ...
    public org.eclipse.swt.printing.PrinterData getApi() {
        return (org.eclipse.swt.printing.PrinterData) super.getApi();
    }
}
