...
import org.eclipse.swt.dnd.IFileTransfer;
 ...
 * @see Transfer
 */
public class FileTransfer extends ByteArrayTransfer implements IFileTransfer {
    ...
    public static FileTransfer safeDelegate(org.eclipse.swt.dnd.FileTransfer api) {
        return (api != null) ? (FileTransfer) api.getDelegate() : null;
    }
}
