...
import org.eclipse.swt.custom.IST;
 ...
 */
public class ST implements IST {
    ...
    public org.eclipse.swt.custom.ST getApi() {
        return (org.eclipse.swt.custom.ST) api;
    }

    org.eclipse.swt.custom.ST api;

    public void setApi(org.eclipse.swt.custom.ST api) {
        this.api = api;
    }
}
