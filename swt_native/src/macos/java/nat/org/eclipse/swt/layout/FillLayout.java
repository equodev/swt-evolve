 ...
 */
public final class FillLayout extends Layout implements IFillLayout {
    ...
    public org.eclipse.swt.layout.FillLayout getApi() {
        return (org.eclipse.swt.layout.FillLayout) super.getApi();
    }
}
