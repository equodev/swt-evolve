...
import org.eclipse.swt.dnd.ITreeDragSourceEffect;
 ...
 * @since 3.3
 */
public class TreeDragSourceEffect extends DragSourceEffect implements ITreeDragSourceEffect {
    ...
    public void dragStart(DragSourceEvent event) {
        event.image = getDragSourceImage(event).getApi();
    }
    ...
    public static TreeDragSourceEffect safeDelegate(org.eclipse.swt.dnd.TreeDragSourceEffect api) {
        return (api != null) ? (TreeDragSourceEffect) api.getDelegate() : null;
    }
}
