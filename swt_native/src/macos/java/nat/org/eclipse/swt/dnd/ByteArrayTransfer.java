...
import org.eclipse.swt.dnd.IByteArrayTransfer;
 ...
 *  @see Transfer
 */
public abstract class ByteArrayTransfer extends Transfer implements IByteArrayTransfer {
    ...
    @Override
    public boolean isSupportedType(ITransferData itransferData) {
    ...
    public static ByteArrayTransfer safeDelegate(org.eclipse.swt.dnd.ByteArrayTransfer api) {
        return (api != null) ? (ByteArrayTransfer) api.getDelegate() : null;
    }
}
