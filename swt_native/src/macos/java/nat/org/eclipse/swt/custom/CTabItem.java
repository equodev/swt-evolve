 ...
 */
public class CTabItem extends Item implements ICTabItem {
    ...
    public static CTabItem safeDelegate(org.eclipse.swt.custom.CTabItem api) {
        return (api != null) ? (CTabItem) api.getDelegate() : null;
    }
}
