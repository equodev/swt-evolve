 ...
 */
public abstract class Transfer implements ITransfer {
     ...
     * agent
     */
    abstract public boolean isSupportedType(ITransferData transferData);
    ...
    public org.eclipse.swt.dnd.Transfer getApi() {
        return (org.eclipse.swt.dnd.Transfer) api;
    }

    protected org.eclipse.swt.dnd.Transfer api;
