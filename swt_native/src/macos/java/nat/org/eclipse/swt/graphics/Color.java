 ...
 */
public final class Color extends Resource implements IColor {
    ...
    public org.eclipse.swt.graphics.Color getApi() {
        return (org.eclipse.swt.graphics.Color) super.getApi();
    }
}
