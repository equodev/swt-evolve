...
import org.eclipse.swt.opengl.IGLCanvas;
 ...
 * @since 3.2
 */
public class GLCanvas extends Canvas implements IGLCanvas {
    ...
    public org.eclipse.swt.opengl.GLCanvas getApi() {
        return (org.eclipse.swt.opengl.GLCanvas) super.getApi();
    }
}
