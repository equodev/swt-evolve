...
import org.eclipse.swt.custom.ICBanner;
 ...
 */
public class CBanner extends Composite implements ICBanner {
...
*/
     ...
     * @since 3.0
     */
    public void setBottom(IControl icontrol) {
     ...
     * @since 3.0
     */
    public void setLeft(IControl icontrol) {
        Control control = (Control) icontrol;
        checkWidget();
        if (control != null && control.getParent() != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
     ...
     * @since 3.0
     */
    public void setRight(IControl icontrol) {
        Control control = (Control) icontrol;
        checkWidget();
        if (control != null && control.getParent() != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
     ...
     * @since 3.1
     */
    public void setRightMinimumSize(IPoint isize) {
