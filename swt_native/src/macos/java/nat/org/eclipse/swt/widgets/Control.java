 ...
 */
public abstract class Control extends Widget implements Drawable, IControl {
 ...
 */
	...
	*/
    ...
    public static Control safeDelegate(org.eclipse.swt.widgets.Control api) {
        return (api != null) ? (Control) api.getDelegate() : null;
    }
}
