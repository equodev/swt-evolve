...
import org.eclipse.swt.custom.ICTabFolder;
 ...
 */
public class CTabFolder extends Composite implements ICTabFolder {
...
*/
     ...
     * 	</ul>
     */
    public CTabItem getItem(IPoint ipt) {
        Point pt = (Point) ipt;
        /*
	 * This call is intentionally commented out, to allow this getter method to be
	 * called from a thread which is different from one that created the widget.
 ...
 */
     ...
     * </ul>
     */
    public int indexOf(ICTabItem iitem) {
        CTabItem item = (CTabItem) iitem;
        checkWidget();
        if (item == null) {
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
        }
	...
	*/
     ...
     * </ul>
     */
    public void setInsertMark(ICTabItem iitem, boolean after) {
        CTabItem item = (CTabItem) iitem;
        checkWidget();
    }
     ...
     *  @since 3.6
     */
    public void setRenderer(ICTabFolderRenderer irenderer) {
        CTabFolderRenderer renderer = (CTabFolderRenderer) irenderer;
        checkWidget();
     ...
     * </ul>
     */
    public void setSelection(ICTabItem iitem) {
        CTabItem item = (CTabItem) iitem;
        checkWidget();
        if (item == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
    ...
    void setSelection(int index, boolean notify) {
        ...
        if (notify && selectedIndex != oldSelectedIndex && selectedIndex != -1) {
            ...
            event.item = getItem(selectedIndex).getApi();
 ...
 */
     ...
     * </ul>
     */
    public void setSelectionBackground(IImage iimage) {
        Image image = (Image) iimage;
        checkWidget();
        setSelectionHighlightGradientColor(null);
     ...
     * @since 2.1
     */
    public void setTopRight(IControl icontrol) {
     ...
     * @since 3.0
     */
    public void setTopRight(IControl icontrol, int alignment) {
        Control control = (Control) icontrol;
        checkWidget();
     ...
     * @since 2.0
     */
    public void showItem(ICTabItem iitem) {
        CTabItem item = (CTabItem) iitem;
        checkWidget();
        if (item == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
