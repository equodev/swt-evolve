 ...
 */
public class DragSource extends Widget implements IDragSource {
     ...
     * @since 3.3
     */
    public void setDragSourceEffect(IDragSourceEffect ieffect) {
        DragSourceEffect effect = (DragSourceEffect) ieffect;
        dragEffect = effect;
    }
