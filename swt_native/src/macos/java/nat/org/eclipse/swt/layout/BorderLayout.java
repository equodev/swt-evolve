 ...
 * *****************************************************************************
 */
package nat.org.eclipse.swt.layout;
 ...
 * @since 3.119
 */
public class BorderLayout extends Layout implements IBorderLayout {
    ...
    public String toString() {
        return //
        "BorderLayout [" + "type=" + //
        ((type == SWT.HORIZONTAL) ? "SWT.HORIZONTAL" : "SWT.VERTICAL") + ", marginWidth=" + //
        marginWidth + ", marginHeight=" + //
        marginHeight + ", spacing=" + //
        spacing + ", controlSpacing=" + //
        controlSpacing + ", widthDistributionFactor=" + //
        widthDistributionFactor + ", heightDistributionFactor=" + //
        heightDistributionFactor + "]";
    }

    public org.eclipse.swt.layout.BorderLayout getApi() {
        return (org.eclipse.swt.layout.BorderLayout) super.getApi();
    }
}
