 ...
 */
public final class Font extends Resource implements IFont {
    ...
    public static Font safeDelegate(org.eclipse.swt.graphics.Font api) {
        return (api != null) ? (Font) api.getDelegate() : null;
    }
}
