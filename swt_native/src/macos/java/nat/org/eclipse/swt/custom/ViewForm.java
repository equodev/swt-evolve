...
import org.eclipse.swt.custom.IViewForm;
 ...
 */
public class ViewForm extends Composite implements IViewForm {
     ...
     * </ul>
     */
    public void setContent(IControl icontent) {
        Control content = (Control) icontent;
        checkWidget();
     ...
     * </ul>
     */
    public void setTopCenter(IControl itopCenter) {
        Control topCenter = (Control) itopCenter;
        checkWidget();
     ...
     * </ul>
     */
    public void setTopLeft(IControl ic) {
        Control c = (Control) ic;
        checkWidget();
     ...
     * </ul>
     */
    public void setTopRight(IControl ic) {
        Control c = (Control) ic;
        checkWidget();
        if (c != null && c.getParent() != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
