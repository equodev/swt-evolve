 ...
 */
public abstract class Device implements Drawable, IDevice {
...
* TEMPORARY CODE.
*/
    static synchronized public Device getDevice() {
    ...
    public org.eclipse.swt.graphics.Device getApi() {
    ...
    public static Device safeDelegate(org.eclipse.swt.graphics.Device api) {
        return (api != null) ? (Device) api.getDelegate() : null;
    }
}
