 ...
 */
public class ExpandItem extends Item implements IExpandItem {
    ...
    public static ExpandItem safeDelegate(org.eclipse.swt.widgets.ExpandItem api) {
        return (api != null) ? (ExpandItem) api.getDelegate() : null;
    }
}
