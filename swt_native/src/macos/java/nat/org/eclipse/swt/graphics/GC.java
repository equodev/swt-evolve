 ...
 */
public final class GC extends Resource implements IGC {
     ...
     * </ul>
     */
    public void copyArea(IImage iimage, int x, int y) {
     ...
     * </ul>
     */
    public void drawImage(IImage iimage, int x, int y) {
        Image image = (Image) iimage;
        if (handle == null)
            SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
        if (image == null)
     ...
     * </ul>
     */
    public void drawImage(IImage iimage, int srcX, int srcY, int srcWidth, int srcHeight, int destX, int destY, int destWidth, int destHeight) {
        Image image = (Image) iimage;
        if (handle == null)
            SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
     ...
     * @since 3.1
     */
    public void fillPath(IPath ipath) {
        Path path = (Path) ipath;
        if (handle == null)
            SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
        if (path == null)
     ...
     * </ul>
     */
    public void getClipping(IRegion iregion) {
     ...
     * @since 3.1
     */
    public void getTransform(ITransform itransform) {
        Transform transform = (Transform) itransform;
        if (handle == null)
            SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
        if (transform == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
     ...
     * @since 3.1
     */
    public void setBackgroundPattern(IPattern ipattern) {
     ...
     * @since 3.1
     */
    public void setClipping(IPath ipath) {
        Path path = (Path) ipath;
        if (handle == null)
            SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
     ...
     * @since 3.1
     */
    public void setForegroundPattern(IPattern ipattern) {
        Pattern pattern = (Pattern) ipattern;
        if (handle == null)
            SWT.error(SWT.ERROR_GRAPHIC_DISPOSED);
        if (pattern != null && pattern.isDisposed())
