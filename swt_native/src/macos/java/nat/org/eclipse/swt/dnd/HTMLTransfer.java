 ...
 * @see Transfer
 */
public class HTMLTransfer extends ByteArrayTransfer implements IHTMLTransfer {
    ...
    public org.eclipse.swt.dnd.HTMLTransfer getApi() {
        return (org.eclipse.swt.dnd.HTMLTransfer) super.getApi();
    }
}
