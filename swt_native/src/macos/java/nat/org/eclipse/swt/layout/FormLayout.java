 ...
 *  @since 2.0
 */
public final class FormLayout extends Layout implements IFormLayout {
 ...
 */
    ...
    public static FormLayout safeDelegate(org.eclipse.swt.layout.FormLayout api) {
        return (api != null) ? (FormLayout) api.getDelegate() : null;
    }
}
