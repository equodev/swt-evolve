...
public final class JPEGFileFormat extends StaticImageFileFormat {
    ...
    public static final RGB[] RGB16 = new RGB[] { new RGB(0, 0, 0), new RGB(0x80, 0, 0), new RGB(0, 0x80, 0), new RGB(0x80, 0x80, 0), new RGB(0, 0, 0x80), new RGB(0x80, 0, 0x80), new RGB(0, 0x80, 0x80), new RGB(0xC0, 0xC0, 0xC0), new RGB(0x80, 0x80, 0x80), new RGB(0xFF, 0, 0), new RGB(0, 0xFF, 0), new RGB(0xFF, 0xFF, 0), new RGB(0, 0, 0xFF), new RGB(0xFF, 0, 0xFF), new RGB(0, 0xFF, 0xFF), new RGB(0xFF, 0xFF, 0xFF) };
    ...
    public static final int[] RYTable, GYTable, BYTable, RCbTable, GCbTable, BCbTable, RCrTable, GCrTable, BCrTable, NBitsTable;
    ...
    JPEGSegment processTables() {
        while (true) {
            ...
            switch(marker) {
                case // there should only be one SOI per file
                SOI:
                    SWT.error(SWT.ERROR_INVALID_IMAGE);
                case EOI:
                case SOS:
