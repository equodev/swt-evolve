 ...
 * @since 3.3
 */
public class DartDragSourceEffect extends DartDragSourceAdapter implements IDragSourceEffect {
     ...
     * </ul>
     */
    public DartDragSourceEffect(Control control, DragSourceEffect api) {
        super(api);
        if (control == null)
