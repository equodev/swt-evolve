 ...
 * @since 3.3
 */
public class DartTableDropTargetEffect extends DartDropTargetEffect implements ITableDropTargetEffect {
     ...
     */
    public DartTableDropTargetEffect(Table table, TableDropTargetEffect api) {
        super(table, api);
    }
