...
import org.eclipse.swt.custom.VTableEditor.*;
import dev.equo.swt.*;
 ...
 */
public class DartTableEditor extends DartControlEditor implements ITableEditor {
     ...
     */
    public DartTableEditor(Table table, TableEditor api) {
        super(table, api);
        this.table = table;
    ...
    public void dispose() {
        ...
        if (table != null && !table.isDisposed() && table.getImpl() instanceof DartTable) {
            ((DartTable) table.getImpl())._removeEditor(getApi());
        }
        columnListener = null;
        table = null;
        item = null;
    ...
    public TableEditor getApi() {
        ...
        return (TableEditor) api;
    }

    public VTableEditor getValue() {
        if (value == null)
            value = new VTableEditor(this);
        return (VTableEditor) value;
    }
}
