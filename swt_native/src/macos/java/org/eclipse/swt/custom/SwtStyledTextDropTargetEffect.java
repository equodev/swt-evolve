 ...
 * @since 3.3
 */
public class SwtStyledTextDropTargetEffect extends SwtDropTargetEffect implements IStyledTextDropTargetEffect {
    ...
    public void dragOver(DropTargetEvent event) {
        ...
        if ((effect & DND.FEEDBACK_SELECT) != 0) {
            ...
            int newOffset = ((SwtStyledText) text.getImpl()).getOffsetAtPoint(pt.x, pt.y, trailing, false);
