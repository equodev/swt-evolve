...
public final class SwtFontMetrics implements IFontMetrics {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FontMetrics metrics))
            return false;
        return ascent == ((SwtFontMetrics) metrics.getImpl()).ascent && descent == ((SwtFontMetrics) metrics.getImpl()).descent && leading == ((SwtFontMetrics) metrics.getImpl()).leading && height == ((SwtFontMetrics) metrics.getImpl()).height && (Double.compare(averageCharWidth, ((SwtFontMetrics) metrics.getImpl()).averageCharWidth) == 0);
    }
