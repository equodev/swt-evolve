...
public final class SwtRegion extends SwtResource implements IRegion {
    ...
    void add(int[] pointArray, int count) {
        ...
        try {
            ...
            OS.UnionRgn(getApi().handle, polyRgn, getApi().handle);
    ...
    public void add(int x, int y, int width, int height) {
        ...
        try {
            ...
            OS.RectRgn(rectRgn, r);
            OS.UnionRgn(getApi().handle, rectRgn, getApi().handle);
            OS.DisposeRgn(rectRgn);
        } finally {
            if (pool != null)
                pool.release();
    ...
    public void add(Region region) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            OS.UnionRgn(getApi().handle, region.handle, getApi().handle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public boolean contains(int x, int y) {
        ...
        try {
            ...
            return OS.PtInRgn(point, getApi().handle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    void convertRgn(NSAffineTransform transform) {
        ...
        this.transform = null;
        callback.dispose();
        OS.CopyRgn(newRgn, getApi().handle);
    ...
    public Rectangle getBounds() {
        ...
        try {
            ...
            OS.GetRegionBounds(getApi().handle, bounds);
    ...
    public void intersect(int x, int y, int width, int height) {
        ...
        try {
            ...
            OS.SetRect(r, (short) x, (short) y, (short) (x + width), (short) (y + height));
            OS.RectRgn(rectRgn, r);
            OS.SectRgn(getApi().handle, rectRgn, getApi().handle);
            OS.DisposeRgn(rectRgn);
        } finally {
            if (pool != null)
                pool.release();
    ...
    public void intersect(Region region) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            OS.SectRgn(getApi().handle, region.handle, getApi().handle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public boolean intersects(int x, int y, int width, int height) {
        ...
        try {
            short[] r = new short[4];
            OS.SetRect(r, (short) x, (short) y, (short) (x + width), (short) (y + height));
            return OS.RectInRgn(r, getApi().handle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public boolean isEmpty() {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            return OS.EmptyRgn(getApi().handle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public void subtract(int[] pointArray) {
        ...
        try {
            ...
            OS.DiffRgn(getApi().handle, polyRgn, getApi().handle);
            OS.DisposeRgn(polyRgn);
        } finally {
            if (pool != null)
                pool.release();
    ...
    public void subtract(int x, int y, int width, int height) {
        ...
        try {
            ...
            OS.SetRect(r, (short) x, (short) y, (short) (x + width), (short) (y + height));
            OS.RectRgn(rectRgn, r);
            OS.DiffRgn(getApi().handle, rectRgn, getApi().handle);
            OS.DisposeRgn(rectRgn);
        } finally {
            if (pool != null)
                pool.release();
    ...
    public void subtract(Region region) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            OS.DiffRgn(getApi().handle, region.handle, getApi().handle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public void translate(int x, int y) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            OS.OffsetRgn(getApi().handle, (short) x, (short) y);
        } finally {
            if (pool != null)
                pool.release();
        }
