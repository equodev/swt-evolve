 ...
 * @since 3.1
 */
public class SwtTransform extends SwtResource implements ITransform {
    ...
    public SwtTransform(Device device, float m11, float m12, float m21, float m22, float dx, float dy) {
        ...
        try {
            getApi().handle = NSAffineTransform.transform();
    ...
    public void getElements(float[] elements) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            NSAffineTransformStruct struct = getApi().handle.transformStruct();
    ...
    public void identity() {
        ...
        try {
            ...
            struct.m11 = 1;
            struct.m22 = 1;
            getApi().handle.setTransformStruct(struct);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public void multiply(Transform matrix) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            getApi().handle.prependTransform(matrix.handle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public void rotate(float angle) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            getApi().handle.rotateByDegrees(angle);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public void scale(float scaleX, float scaleY) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            getApi().handle.scaleXBy(scaleX, scaleY);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public void shear(float shearX, float shearY) {
        ...
        try {
            ...
            getApi().handle.prependTransform(matrix);
        } finally {
            if (pool != null)
                pool.release();
        }
    ...
    public void transform(float[] pointArray) {
        ...
        try {
            ...
            for (int i = 0, j = 0; i < length; i++, j += 2) {
                ...
                point = getApi().handle.transformPoint(point);
    ...
    public void translate(float offsetX, float offsetY) {
        ...
        if (!NSThread.isMainThread())
            pool = (NSAutoreleasePool) new NSAutoreleasePool().alloc().init();
        try {
            getApi().handle.translateXBy(offsetX, offsetY);
        } finally {
            if (pool != null)
                pool.release();
        }
