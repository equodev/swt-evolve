...
*/
    ...
    void createDisplay(DeviceData data) {
        ...
        if (!NSThread.isMainThread()) {
            //$NON-NLS-1$
            System.out.println("***WARNING: Display must be created on main thread due to Cocoa restrictions. Use vmarg -XstartOnFirstThread");
            error(SWT.ERROR_THREAD_INVALID_ACCESS);
        }
    ...
    double[] getWidgetColorRGB(int id) {
        ...
        switch(id) {
            ...
            case SWT.COLOR_INFO_BACKGROUND:
                return new double[] { 236 / 255f, 235 / 255f, 236 / 255f, 1 };
	 ...
	 */
        if (!SwtDisplay.launched) {
            application.finishLaunching();
            SwtDisplay.launched = true;
    ...
    private static NSString getAwtRunLoopMode() {
        ...
        version.feature() == 15 && Version.parse("15.0.5").compareToIgnoreOptional(version) <= 0 || version.feature() == 13 && Version.parse("13.0.9").compareToIgnoreOptional(version) <= 0) {
	...
	*/
	 ...
	 */
        if (tray != null && ((SwtTray) tray.getImpl()).itemCount > 0) {
            /*
    ...
    void setWindowsAppearance(APPEARANCE newMode) {
        ...
        if (appearance != null) {
            ...
            for (int i = 0; i < shells.length; i++) {
                Shell shell = shells[i];
                if (!shell.isDisposed()) {
                    setWindowAppearance(((SwtShell) shell.getImpl()).window, appearance);
                }
            }
            appAppearance = newMode;
        }
	...
	*/
    ...
    public void update() {
        ...
        for (int i = 0; i < shells.length; i++) {
            Shell shell = shells[i];
            if (!shell.isDisposed())
                ((SwtControl) shell.getImpl()).update(true);
        }
    }
	...
	*/
        ...
        switch(type) {
            ...
            case OS.NSScrollWheel:
                ...
                if (window != null) {
                    ...
                    if (shell != null) {
                        Shell modalShell = ((SwtShell) shell.getImpl()).getModalShell();
                        if (modalShell != null) {
                            if (activate) {
                                if (application.isActive()) {
                                    ((SwtShell) modalShell.getImpl()).window.orderFrontRegardless();
                                } else {
    ...
    static long applicationProc(long id, long sel) {
        ...
        if (sel == OS.sel_finishLaunching) {
            ((SwtDisplay) display.getImpl()).finishLaunching(id, sel);
        }
        return 0;
    }
    ...
    static long applicationProc(long id, long sel, long arg0) {
        ...
        if (sel == OS.sel_appAppearanceChanged) {
            ((SwtDisplay) display.getImpl()).setAppAppearance(arg0 == 1 ? APPEARANCE.Dark : APPEARANCE.Light);
            return 0;
        }
        switch(Selector.valueOf(sel)) {
            case sel_sendEvent_:
                {
                    ((SwtDisplay) display.getImpl()).applicationSendEvent(id, sel, arg0);
                    return 0;
                }
            case sel_applicationDidFinishLaunching_:
                {
                    ((SwtDisplay) display.getImpl()).applicationDidFinishLaunching(id, sel, arg0);
                    return 0;
                }
            case sel_applicationWillFinishLaunching_:
                {
                    ((SwtDisplay) display.getImpl()).applicationWillFinishLaunching(id, sel, arg0);
                    return 0;
                }
            case sel_applicationShouldTerminate_:
                {
                    int returnVal = OS.NSTerminateCancel;
                    if (!((SwtDisplay) display.getImpl()).disposing) {
                        Event event = new Event();
                        ((SwtDisplay) display.getImpl()).sendEvent(SWT.Close, event);
                        if (event.doit) {
                            display.dispose();
            ...
            case sel_applicationDidBecomeActive_:
                {
                    ((SwtDisplay) display.getImpl()).applicationDidBecomeActive(id, sel, arg0);
                    return 0;
                }
            case sel_applicationDidResignActive_:
                {
                    ((SwtDisplay) display.getImpl()).applicationDidResignActive(id, sel, arg0);
                    return 0;
                }
            case sel_applicationDockMenu_:
                {
                    TaskBar taskbar = ((SwtDisplay) display.getImpl()).taskBar;
                    if (taskbar != null && ((SwtTaskBar) taskbar.getImpl()).itemCount != 0) {
            ...
            case sel_application_openFile_:
                {
                    ...
                    Event event = new Event();
                    event.text = file;
                    ((SwtDisplay) display.getImpl()).sendEvent(SWT.OpenDocument, event);
                    return 1;
                }
            ...
            case sel_application_openUrls_:
                {
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        Event event = new Event();
                        event.text = url;
                        ((SwtDisplay) display.getImpl()).sendEvent(SWT.OpenUrl, event);
                    }
            ...
            case sel_applicationShouldHandleReopen_hasVisibleWindows_:
                {
                    ...
                    ((SwtDisplay) display.getImpl()).sendEvent(SWT.Activate, event);
    ...
    static long applicationProc(long id, long sel, long arg0, long arg1, long arg2, long arg3) {
        ...
        if (sel == OS.sel_nextEventMatchingMask_untilDate_inMode_dequeue_) {
            return ((SwtDisplay) display.getImpl()).applicationNextEventMatchingMask(id, sel, arg0, arg1, arg2, arg3);
        }
        return 0;
    }
            ...
            case sel_changeFont_:
                {
                    ...
                    if (dialog == null)
                        return 0;
                    ((SwtFontDialog) dialog.getImpl()).changeFont(id, sel, arg0);
                    return 0;
                }
            case sel_validModesForFontPanel_:
                {
                    ...
                    if (dialog == null)
                        return 0;
                    return ((SwtFontDialog) dialog.getImpl()).validModesForFontPanel(id, sel, arg0);
                }
            case sel_sendSelection_:
                {
                    ...
                    if (dialog == null)
                        return 0;
                    ((SwtFileDialog) dialog.getImpl()).sendSelection(id, sel, arg0);
                    return 0;
                }
    ...
    static long dialogProc(long id, long sel, long arg0, long arg1) {
        ...
        if (sel == OS.sel_panel_shouldEnableURL_) {
            ...
            if (dialog == null)
                return 0;
            return ((SwtFileDialog) dialog.getImpl()).panel_shouldEnableURL(id, sel, arg0, arg1);
        }
        if (sel == OS.sel_setColor_forAttribute_) {
            FontDialog dialog = (FontDialog) OS.JNIGetObject(jniRef[0]);
            if (dialog == null)
                return 0;
            ((SwtFontDialog) dialog.getImpl()).setColor_forAttribute(id, sel, arg0, arg1);
            return 0;
        }
        return 0;
    }
    ...
    static long dialogProc(long id, long sel, long arg0, long arg1, long arg2) {
        ...
        if (sel == OS.sel_panel_userEnteredFilename_confirmed_) {
            ...
            if (dialog == null)
                return 0;
            return ((SwtFileDialog) dialog.getImpl()).panel_userEnteredFilename_confirmed(id, sel, arg0, arg1, arg2);
        }
        return 0;
    }
	...
	*/
        ...
        return switch(Selector.valueOf(sel)) {
            case sel_sendSelection ->
                {
                    ((SwtWidget) widget.getImpl()).sendSelection();
                    yield 0;
                }
            case sel_dealloc ->
                {
                    ((SwtWidget) widget.getImpl()).dealloc(id, sel);
                    yield 0;
                }
            case sel_sendDoubleSelection ->
                {
                    ((SwtWidget) widget.getImpl()).sendDoubleSelection();
                    yield 0;
                }
            case sel_sendVerticalSelection ->
                {
                    ((SwtWidget) widget.getImpl()).sendVerticalSelection();
                    yield 0;
                }
            case sel_sendHorizontalSelection ->
                {
                    ((SwtWidget) widget.getImpl()).sendHorizontalSelection();
                    yield 0;
                }
            case sel_sendSearchSelection ->
                {
                    ((SwtWidget) widget.getImpl()).sendSearchSelection();
                    yield 0;
                }
            case sel_sendCancelSelection ->
                {
                    ((SwtWidget) widget.getImpl()).sendCancelSelection();
                    yield 0;
                }
            case sel_acceptsFirstResponder ->
                ((SwtWidget) widget.getImpl()).acceptsFirstResponder(id, sel) ? 1 : 0;
            case sel_becomeFirstResponder ->
                ((SwtWidget) widget.getImpl()).becomeFirstResponder(id, sel) ? 1 : 0;
            case sel_resignFirstResponder ->
                ((SwtWidget) widget.getImpl()).resignFirstResponder(id, sel) ? 1 : 0;
            case sel_isOpaque ->
                ((SwtWidget) widget.getImpl()).isOpaque(id, sel) ? 1 : 0;
            case sel_isFlipped ->
                ((SwtWidget) widget.getImpl()).isFlipped(id, sel) ? 1 : 0;
            case sel_canBecomeKeyView ->
                ((SwtWidget) widget.getImpl()).canBecomeKeyView(id, sel) ? 1 : 0;
            case sel_needsPanelToBecomeKey ->
                ((SwtWidget) widget.getImpl()).needsPanelToBecomeKey(id, sel) ? 1 : 0;
            case sel_becomeKeyWindow ->
                {
                    ((SwtWidget) widget.getImpl()).becomeKeyWindow(id, sel);
                    yield 0;
                }
            case sel_unmarkText ->
                /*TODO not called? */
            ...
            case sel_validAttributesForMarkedText ->
                ((SwtWidget) widget.getImpl()).validAttributesForMarkedText(id, sel);
            case sel_markedRange ->
                {
                    NSRange range = ((SwtWidget) widget.getImpl()).markedRange(id, sel);
            ...
            case sel_selectedRange ->
                {
                    NSRange range = ((SwtWidget) widget.getImpl()).selectedRange(id, sel);
                    /* NOTE that this is freed in C */
                    long result = C.malloc(NSRange.sizeof);
                    OS.memmove(result, range, NSRange.sizeof);
                    yield result;
            ...
            case sel_cellSize ->
                {
                    NSSize size = ((SwtWidget) widget.getImpl()).cellSize(id, sel);
                    /* NOTE that this is freed in C */
            ...
            case sel_hasMarkedText ->
                ((SwtWidget) widget.getImpl()).hasMarkedText(id, sel) ? 1 : 0;
            case sel_canBecomeKeyWindow ->
                ((SwtWidget) widget.getImpl()).canBecomeKeyWindow(id, sel) ? 1 : 0;
            case sel_accessibilityActionNames ->
                ((SwtWidget) widget.getImpl()).accessibilityActionNames(id, sel);
            case sel_accessibilityAttributeNames ->
                ((SwtWidget) widget.getImpl()).accessibilityAttributeNames(id, sel);
            case sel_accessibilityParameterizedAttributeNames ->
                ((SwtWidget) widget.getImpl()).accessibilityParameterizedAttributeNames(id, sel);
            case sel_getImageView ->
                ((SwtWidget) widget.getImpl()).imageView();
            case sel_mouseDownCanMoveWindow ->
                (((SwtWidget) widget.getImpl()).mouseDownCanMoveWindow(id, sel) ? 1 : 0);
            case sel_accessibilityFocusedUIElement ->
                ((SwtWidget) widget.getImpl()).accessibilityFocusedUIElement(id, sel);
            case sel_accessibilityIsIgnored ->
                (((SwtWidget) widget.getImpl()).accessibilityIsIgnored(id, sel) ? 1 : 0);
            case sel_nextState ->
                ((SwtWidget) widget.getImpl()).nextState(id, sel);
            case sel_resetCursorRects ->
                {
                    ((SwtWidget) widget.getImpl()).resetCursorRects(id, sel);
                    yield 0;
                }
            case sel_updateTrackingAreas ->
                {
                    ((SwtWidget) widget.getImpl()).updateTrackingAreas(id, sel);
                    yield 0;
                }
            case sel_viewDidMoveToWindow ->
                {
                    ((SwtWidget) widget.getImpl()).viewDidMoveToWindow(id, sel);
                    yield 0;
                }
            case sel_image ->
                ((SwtWidget) widget.getImpl()).image(id, sel);
            case sel_shouldDrawInsertionPoint ->
                ((SwtWidget) widget.getImpl()).shouldDrawInsertionPoint(id, sel) ? 1 : 0;
            case sel_accessibleHandle ->
                ((SwtWidget) widget.getImpl()).accessibleHandle();
            case sel_clearDeferFlushing ->
                {
                    ((SwtWidget) widget.getImpl()).clearDeferFlushing(id, sel);
                    yield 0;
                }
            default ->
                0;
	...
	*/
            ...
            case sel_timerProc_:
                {
                    ...
                    if (display == null)
                        return 0;
                    return ((SwtDisplay) display.getImpl()).timerProc(id, sel, arg0);
                }
            case sel_screenParametersChanged_:
                {
                    ...
                    if (display == null)
                        return 0;
                    ((SwtDisplay) display.getImpl()).runSettings = true;
                    ((SwtDisplay) display.getImpl()).setDeviceZoom();
                    return 0;
                }
        ...
        return switch(Selector.valueOf(sel)) {
            case sel_windowWillClose_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowWillClose(id, sel, arg0);
                    yield 0;
                }
            case sel_drawRect_ ->
                {
                    ...
                    ((SwtWidget) widget.getImpl()).drawRect(id, sel, rect);
                    yield 0;
                }
            case sel_columnAtPoint_ ->
                {
                    ...
                    yield ((SwtWidget) widget.getImpl()).columnAtPoint(id, sel, point);
                }
            case sel__drawThemeProgressArea_ ->
                {
                    ((SwtWidget) widget.getImpl())._drawThemeProgressArea(id, sel, arg0);
                    yield 0;
                }
            case sel_setFrameOrigin_ ->
                {
                    NSPoint point = new NSPoint();
                    OS.memmove(point, arg0, NSPoint.sizeof);
                    ((SwtWidget) widget.getImpl()).setFrameOrigin(id, sel, point);
                    yield 0;
                }
            case sel_setFrameSize_ ->
                {
                    ...
                    ((SwtWidget) widget.getImpl()).setFrameSize(id, sel, size);
                    yield 0;
                }
            case sel_hitTest_ ->
                {
                    NSPoint point = new NSPoint();
                    OS.memmove(point, arg0, NSPoint.sizeof);
                    yield ((SwtWidget) widget.getImpl()).hitTest(id, sel, point);
                }
            case sel_windowShouldClose_ ->
                ((SwtWidget) widget.getImpl()).windowShouldClose(id, sel, arg0) ? 1 : 0;
            case sel_mouseDown_ ->
                {
                    ((SwtWidget) widget.getImpl()).mouseDown(id, sel, arg0);
                    yield 0;
                }
            case sel_keyDown_ ->
                {
                    ((SwtWidget) widget.getImpl()).keyDown(id, sel, arg0);
                    yield 0;
                }
            case sel_keyUp_ ->
                {
                    ((SwtWidget) widget.getImpl()).keyUp(id, sel, arg0);
                    yield 0;
                }
            case sel_flagsChanged_ ->
                {
                    ((SwtWidget) widget.getImpl()).flagsChanged(id, sel, arg0);
                    yield 0;
                }
            case sel_mouseUp_ ->
                {
                    ((SwtWidget) widget.getImpl()).mouseUp(id, sel, arg0);
                    yield 0;
                }
            case sel_rightMouseDown_ ->
                {
                    ((SwtWidget) widget.getImpl()).rightMouseDown(id, sel, arg0);
                    yield 0;
                }
            case sel_rightMouseDragged_ ->
                {
                    ((SwtWidget) widget.getImpl()).rightMouseDragged(id, sel, arg0);
                    yield 0;
                }
            case sel_rightMouseUp_ ->
                {
                    ((SwtWidget) widget.getImpl()).rightMouseUp(id, sel, arg0);
                    yield 0;
                }
            case sel_otherMouseDown_ ->
                {
                    ((SwtWidget) widget.getImpl()).otherMouseDown(id, sel, arg0);
                    yield 0;
                }
            case sel_otherMouseUp_ ->
                {
                    ((SwtWidget) widget.getImpl()).otherMouseUp(id, sel, arg0);
                    yield 0;
                }
            case sel_otherMouseDragged_ ->
                {
                    ((SwtWidget) widget.getImpl()).otherMouseDragged(id, sel, arg0);
                    yield 0;
                }
            case sel_mouseMoved_ ->
                {
                    ((SwtWidget) widget.getImpl()).mouseMoved(id, sel, arg0);
                    yield 0;
                }
            case sel_mouseDragged_ ->
                {
                    ((SwtWidget) widget.getImpl()).mouseDragged(id, sel, arg0);
                    yield 0;
                }
            case sel_mouseEntered_ ->
                {
                    ((SwtWidget) widget.getImpl()).mouseEntered(id, sel, arg0);
                    yield 0;
                }
            case sel_mouseExited_ ->
                {
                    ((SwtWidget) widget.getImpl()).mouseExited(id, sel, arg0);
                    yield 0;
                }
            case sel_cursorUpdate_ ->
                {
                    ((SwtWidget) widget.getImpl()).cursorUpdate(id, sel, arg0);
                    yield 0;
                }
            case sel_menuForEvent_ ->
                ((SwtWidget) widget.getImpl()).menuForEvent(id, sel, arg0);
            case sel_noResponderFor_ ->
                {
                    ((SwtWidget) widget.getImpl()).noResponderFor(id, sel, arg0);
                    yield 0;
                }
            case sel_shouldDelayWindowOrderingForEvent_ ->
                ((SwtWidget) widget.getImpl()).shouldDelayWindowOrderingForEvent(id, sel, arg0) ? 1 : 0;
            case sel_acceptsFirstMouse_ ->
                ((SwtWidget) widget.getImpl()).acceptsFirstMouse(id, sel, arg0) ? 1 : 0;
            case sel_numberOfRowsInTableView_ ->
                ((SwtWidget) widget.getImpl()).numberOfRowsInTableView(id, sel, arg0);
            case sel_tableViewSelectionDidChange_ ->
                {
                    ((SwtWidget) widget.getImpl()).tableViewSelectionDidChange(id, sel, arg0);
                    yield 0;
                }
            case sel_tableViewSelectionIsChanging_ ->
                {
                    ((SwtWidget) widget.getImpl()).tableViewSelectionIsChanging(id, sel, arg0);
                    yield 0;
                }
            case sel_windowDidResignKey_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowDidResignKey(id, sel, arg0);
                    yield 0;
                }
            case sel_windowDidBecomeKey_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowDidBecomeKey(id, sel, arg0);
                    yield 0;
                }
            case sel_windowDidResize_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowDidResize(id, sel, arg0);
                    yield 0;
                }
            case sel_windowDidMove_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowDidMove(id, sel, arg0);
                    yield 0;
                }
            case sel_menuWillOpen_ ->
                {
                    ((SwtWidget) widget.getImpl()).menuWillOpen(id, sel, arg0);
                    yield 0;
                }
            case sel_menuDidClose_ ->
                {
                    ((SwtWidget) widget.getImpl()).menuDidClose(id, sel, arg0);
                    yield 0;
                }
            case sel_menuNeedsUpdate_ ->
                {
                    ((SwtWidget) widget.getImpl()).menuNeedsUpdate(id, sel, arg0);
                    yield 0;
                }
            case sel_outlineViewSelectionDidChange_ ->
                {
                    ((SwtWidget) widget.getImpl()).outlineViewSelectionDidChange(id, sel, arg0);
                    yield 0;
                }
            case sel_outlineViewSelectionIsChanging_ ->
                {
                    ((SwtWidget) widget.getImpl()).outlineViewSelectionIsChanging(id, sel, arg0);
                    yield 0;
                }
            case sel_sendEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowSendEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_helpRequested_ ->
                {
                    ((SwtWidget) widget.getImpl()).helpRequested(id, sel, arg0);
                    yield 0;
                }
            case sel_scrollWheel_ ->
                {
                    ((SwtWidget) widget.getImpl()).scrollWheel(id, sel, arg0);
                    yield 0;
                }
            case sel_pageDown_ ->
                {
                    ((SwtWidget) widget.getImpl()).pageDown(id, sel, arg0);
                    yield 0;
                }
            case sel_pageUp_ ->
                {
                    ((SwtWidget) widget.getImpl()).pageUp(id, sel, arg0);
                    yield 0;
                }
            case sel_textViewDidChangeSelection_ ->
                {
                    ((SwtWidget) widget.getImpl()).textViewDidChangeSelection(id, sel, arg0);
                    yield 0;
                }
            case sel_textDidChange_ ->
                {
                    ((SwtWidget) widget.getImpl()).textDidChange(id, sel, arg0);
                    yield 0;
                }
            case sel_textDidEndEditing_ ->
                {
                    ((SwtWidget) widget.getImpl()).textDidEndEditing(id, sel, arg0);
                    yield 0;
                }
            case sel_attributedSubstringFromRange_ ->
                ((SwtWidget) widget.getImpl()).attributedSubstringFromRange(id, sel, arg0);
            case sel_characterIndexForPoint_ ->
                ((SwtWidget) widget.getImpl()).characterIndexForPoint(id, sel, arg0);
            case sel_firstRectForCharacterRange_ ->
                {
                    NSRect rect = ((SwtWidget) widget.getImpl()).firstRectForCharacterRange(id, sel, arg0);
                    /* NOTE that this is freed in C */
                    long /* int */
                    result = C.malloc(NSRect.sizeof);
                    OS.memmove(result, rect, NSRect.sizeof);
                    yield result;
                }
            case sel_insertText_ ->
                ((SwtWidget) widget.getImpl()).insertText(id, sel, arg0) ? 1 : 0;
            case sel_doCommandBySelector_ ->
                {
                    ((SwtWidget) widget.getImpl()).doCommandBySelector(id, sel, arg0);
                    yield 0;
                }
            case sel_highlightSelectionInClipRect_ ->
                {
                    ((SwtWidget) widget.getImpl()).highlightSelectionInClipRect(id, sel, arg0);
                    yield 0;
                }
            case sel_reflectScrolledClipView_ ->
                {
                    ((SwtWidget) widget.getImpl()).reflectScrolledClipView(id, sel, arg0);
                    yield 0;
                }
            case sel_accessibilityHitTest_ ->
                {
                    NSPoint point = new NSPoint();
                    OS.memmove(point, arg0, NSPoint.sizeof);
                    yield ((SwtWidget) widget.getImpl()).accessibilityHitTest(id, sel, point);
                }
            case sel_accessibilityAttributeValue_ ->
                ((SwtWidget) widget.getImpl()).accessibilityAttributeValue(id, sel, arg0);
            case sel_accessibilityPerformAction_ ->
                {
                    ((SwtWidget) widget.getImpl()).accessibilityPerformAction(id, sel, arg0);
                    yield 0;
                }
            case sel_accessibilityActionDescription_ ->
                ((SwtWidget) widget.getImpl()).accessibilityActionDescription(id, sel, arg0);
            case sel_accessibilityIsAttributeSettable_ ->
                ((SwtWidget) widget.getImpl()).accessibilityIsAttributeSettable(id, sel, arg0) ? 1 : 0;
            case sel_makeFirstResponder_ ->
                ((SwtWidget) widget.getImpl()).makeFirstResponder(id, sel, arg0) ? 1 : 0;
            case sel_tableViewColumnDidMove_ ->
                {
                    ((SwtWidget) widget.getImpl()).tableViewColumnDidMove(id, sel, arg0);
                    yield 0;
                }
            case sel_tableViewColumnDidResize_ ->
                {
                    ((SwtWidget) widget.getImpl()).tableViewColumnDidResize(id, sel, arg0);
                    yield 0;
                }
            case sel_outlineViewColumnDidMove_ ->
                {
                    ((SwtWidget) widget.getImpl()).outlineViewColumnDidMove(id, sel, arg0);
                    yield 0;
                }
            case sel_outlineViewColumnDidResize_ ->
                {
                    ((SwtWidget) widget.getImpl()).outlineViewColumnDidResize(id, sel, arg0);
                    yield 0;
                }
            case sel_setNeedsDisplay_ ->
                {
                    ((SwtWidget) widget.getImpl()).setNeedsDisplay(id, sel, arg0 != 0);
                    yield 0;
                }
            case sel_setNeedsDisplayInRect_ ->
                {
                    ((SwtWidget) widget.getImpl()).setNeedsDisplayInRect(id, sel, arg0);
                    yield 0;
                }
            case sel_setImage_ ->
                {
                    ((SwtWidget) widget.getImpl()).setImage(id, sel, arg0);
                    yield 0;
                }
            case sel_headerRectOfColumn_ ->
                {
                    NSRect rect = ((SwtWidget) widget.getImpl()).headerRectOfColumn(id, sel, arg0);
                    /* NOTE that this is freed in C */
                    long /* int */
                    result = C.malloc(NSRect.sizeof);
                    OS.memmove(result, rect, NSRect.sizeof);
            ...
            case sel_imageRectForBounds_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    rect = ((SwtWidget) widget.getImpl()).imageRectForBounds(id, sel, rect);
                    /* NOTE that this is freed in C */
                    long /* int */
                    result = C.malloc(NSRect.sizeof);
                    OS.memmove(result, rect, NSRect.sizeof);
            ...
            case sel_titleRectForBounds_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    rect = ((SwtWidget) widget.getImpl()).titleRectForBounds(id, sel, rect);
                    /* NOTE that this is freed in C */
                    long /* int */
                    result = C.malloc(NSRect.sizeof);
                    OS.memmove(result, rect, NSRect.sizeof);
            ...
            case sel_cellSizeForBounds_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    NSSize size = ((SwtWidget) widget.getImpl()).cellSizeForBounds(id, sel, rect);
                    /* NOTE that this is freed in C */
                    long /* int */
                    result = C.malloc(NSSize.sizeof);
                    OS.memmove(result, size, NSSize.sizeof);
                    yield result;
                }
            case sel_setObjectValue_ ->
                {
                    ((SwtWidget) widget.getImpl()).setObjectValue(id, sel, arg0);
                    yield 0;
                }
            case sel_updateOpenGLContext_ ->
                {
                    ((SwtWidget) widget.getImpl()).updateOpenGLContext(id, sel, arg0);
                    yield 0;
                }
            case sel_sizeOfLabel_ ->
                {
                    NSSize size = ((SwtWidget) widget.getImpl()).sizeOfLabel(id, sel, arg0 != 0);
                    /* NOTE that this is freed in C */
                    long /* int */
                    result = C.malloc(NSSize.sizeof);
                    OS.memmove(result, size, NSSize.sizeof);
            ...
            case sel_comboBoxSelectionDidChange_ ->
                {
                    ((SwtWidget) widget.getImpl()).comboBoxSelectionDidChange(id, sel, arg0);
                    yield 0;
                }
            case sel_comboBoxWillDismiss_ ->
                {
                    ((SwtWidget) widget.getImpl()).comboBoxWillDismiss(id, sel, arg0);
                    yield 0;
                }
            case sel_comboBoxWillPopUp_ ->
                {
                    ((SwtWidget) widget.getImpl()).comboBoxWillPopUp(id, sel, arg0);
                    yield 0;
                }
            case sel_drawViewBackgroundInRect_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    ((SwtWidget) widget.getImpl()).drawViewBackgroundInRect(id, sel, rect);
                    yield 0;
                }
            case sel_drawBackgroundInClipRect_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    ((SwtWidget) widget.getImpl()).drawBackgroundInClipRect(id, sel, rect);
                    yield 0;
                }
            case sel_windowDidMiniaturize_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowDidMiniturize(id, sel, arg0);
                    yield 0;
                }
            case sel_windowDidDeminiaturize_ ->
                {
                    ((SwtWidget) widget.getImpl()).windowDidDeminiturize(id, sel, arg0);
                    yield 0;
                }
            case sel_touchesBeganWithEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).touchesBeganWithEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_touchesMovedWithEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).touchesMovedWithEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_touchesEndedWithEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).touchesEndedWithEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_touchesCancelledWithEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).touchesCancelledWithEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_swipeWithEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).swipeWithEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_magnifyWithEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).magnifyWithEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_rotateWithEvent_ ->
                {
                    ((SwtWidget) widget.getImpl()).rotateWithEvent(id, sel, arg0);
                    yield 0;
                }
            case sel_toolbarAllowedItemIdentifiers_ ->
                ((SwtWidget) widget.getImpl()).toolbarAllowedItemIdentifiers(id, sel, arg0);
            case sel_toolbarDefaultItemIdentifiers_ ->
                ((SwtWidget) widget.getImpl()).toolbarDefaultItemIdentifiers(id, sel, arg0);
            case sel_toolbarSelectableItemIdentifiers_ ->
                ((SwtWidget) widget.getImpl()).toolbarSelectableItemIdentifiers(id, sel, arg0);
            case sel_validateMenuItem_ ->
                (((SwtWidget) widget.getImpl()).validateMenuItem(id, sel, arg0) ? 1 : 0);
            case sel_readSelectionFromPasteboard_ ->
                (((SwtWidget) widget.getImpl()).readSelectionFromPasteboard(id, sel, arg0) ? 1 : 0);
            case sel_viewWillMoveToWindow_ ->
                {
                    ((SwtWidget) widget.getImpl()).viewWillMoveToWindow(id, sel, arg0);
                    yield 0;
                }
            case sel_cancelOperation_ ->
                {
                    ((SwtWidget) widget.getImpl()).cancelOperation(id, sel, arg0);
                    yield 0;
                }
            case sel_setShouldExpandItem_ ->
                {
                    ((SwtWidget) widget.getImpl()).setShouldExpandItem(id, sel, arg0 != 0);
                    yield 0;
                }
            case sel_setShouldScrollClipView_ ->
                {
                    ((SwtWidget) widget.getImpl()).setShouldScrollClipView(id, sel, arg0 != 0);
                    yield 0;
                }
            case sel_deselectRow_ ->
                {
                    ((SwtWidget) widget.getImpl()).deselectRow(id, sel, arg0);
                    yield 0;
                }
            case sel_deselectAll_ ->
                {
                    ((SwtWidget) widget.getImpl()).deselectAll(id, sel, arg0);
                    yield 0;
                }
            default ->
                0;
    ...
    static long windowProc(long id, long sel, long arg0, long arg1) {
        ...
        return switch(Selector.valueOf(sel)) {
            case sel_tabView_willSelectTabViewItem_ ->
                {
                    ((SwtWidget) widget.getImpl()).tabView_willSelectTabViewItem(id, sel, arg0, arg1);
                    yield 0;
                }
            case sel_tabView_didSelectTabViewItem_ ->
                {
                    ((SwtWidget) widget.getImpl()).tabView_didSelectTabViewItem(id, sel, arg0, arg1);
                    yield 0;
                }
            case sel_outlineView_isItemExpandable_ ->
                ((SwtWidget) widget.getImpl()).outlineView_isItemExpandable(id, sel, arg0, arg1) ? 1 : 0;
            case sel_outlineView_numberOfChildrenOfItem_ ->
                ((SwtWidget) widget.getImpl()).outlineView_numberOfChildrenOfItem(id, sel, arg0, arg1);
            case sel_menu_willHighlightItem_ ->
                {
                    ((SwtWidget) widget.getImpl()).menu_willHighlightItem(id, sel, arg0, arg1);
                    yield 0;
                }
            case sel_setMarkedText_selectedRange_ ->
                {
                    ((SwtWidget) widget.getImpl()).setMarkedText_selectedRange(id, sel, arg0, arg1);
                    yield 0;
                }
            case sel_cacheDisplayInRect_toBitmapImageRep_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    ((SwtWidget) widget.getImpl()).cacheDisplayInRect_toBitmapImageRep(id, sel, rect, arg1);
                    yield 0;
                }
            case sel_drawInteriorWithFrame_inView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    ((SwtWidget) widget.getImpl()).drawInteriorWithFrame_inView(id, sel, rect, arg1);
                    yield 0;
                }
            case sel_drawWithExpansionFrame_inView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    ((SwtWidget) widget.getImpl()).drawWithExpansionFrame_inView(id, sel, rect, arg1);
                    yield 0;
                }
            case sel_drawBezelWithFrame_inView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    ((SwtWidget) widget.getImpl()).drawBezelWithFrame_inView(id, sel, rect, arg1);
                    yield 0;
                }
            case sel_accessibilityAttributeValue_forParameter_ ->
                ((SwtWidget) widget.getImpl()).accessibilityAttributeValue_forParameter(id, sel, arg0, arg1);
            case sel_tableView_didClickTableColumn_ ->
                {
                    ((SwtWidget) widget.getImpl()).tableView_didClickTableColumn(id, sel, arg0, arg1);
                    yield 0;
                }
            case sel_outlineView_didClickTableColumn_ ->
                {
                    ((SwtWidget) widget.getImpl()).outlineView_didClickTableColumn(id, sel, arg0, arg1);
                    yield 0;
                }
            case sel_shouldChangeTextInRange_replacementString_ ->
                ((SwtWidget) widget.getImpl()).shouldChangeTextInRange_replacementString(id, sel, arg0, arg1) ? 1 : 0;
            case sel_canDragRowsWithIndexes_atPoint_ ->
                {
                    NSPoint clickPoint = new NSPoint();
                    OS.memmove(clickPoint, arg1, NSPoint.sizeof);
                    yield ((SwtWidget) widget.getImpl()).canDragRowsWithIndexes_atPoint(id, sel, arg0, clickPoint) ? 1 : 0;
                }
            case sel_expandItem_expandChildren_ ->
                {
                    ((SwtWidget) widget.getImpl()).expandItem_expandChildren(id, sel, arg0, arg1 != 0);
                    yield 0;
                }
            case sel_collapseItem_collapseChildren_ ->
                {
                    ((SwtWidget) widget.getImpl()).collapseItem_collapseChildren(id, sel, arg0, arg1 != 0);
                    yield 0;
                }
            case sel_expansionFrameWithFrame_inView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    rect = ((SwtWidget) widget.getImpl()).expansionFrameWithFrame_inView(id, sel, rect, arg1);
                    /* NOTE that this is freed in C */
            ...
            case sel_focusRingMaskBoundsForFrame_inView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg0, NSRect.sizeof);
                    rect = ((SwtWidget) widget.getImpl()).focusRingMaskBoundsForFrame(id, sel, rect, arg1);
                    /* NOTE that this is freed in C */
                    long result = C.malloc(NSRect.sizeof);
                    OS.memmove(result, rect, NSRect.sizeof);
                    yield result;
            ...
            case sel_drawLabel_inRect_ ->
                {
                    ...
                    ((SwtWidget) widget.getImpl()).drawLabelInRect(id, sel, arg0 == 1, rect);
                    yield 0;
                }
            case sel_scrollClipView_toPoint_ ->
                {
                    ...
                    ((SwtWidget) widget.getImpl()).scrollClipViewToPoint(id, sel, arg0, point);
                    yield 0;
                }
            case sel_accessibilitySetValue_forAttribute_ ->
                {
                    ((SwtWidget) widget.getImpl()).accessibilitySetValue_forAttribute(id, sel, arg0, arg1);
                    yield 0;
                }
            case sel_validRequestorForSendType_returnType_ ->
                ((SwtWidget) widget.getImpl()).validRequestorForSendType(id, sel, arg0, arg1);
            case sel_writeSelectionToPasteboard_types_ ->
                (((SwtWidget) widget.getImpl()).writeSelectionToPasteboard(id, sel, arg0, arg1) ? 1 : 0);
            case sel_outlineView_shouldExpandItem_ ->
                (((SwtWidget) widget.getImpl()).outlineView_shouldExpandItem_item(id, sel, arg0, arg1) ? 1 : 0);
            case sel_selectRowIndexes_byExtendingSelection_ ->
                {
                    ((SwtWidget) widget.getImpl()).selectRowIndexes_byExtendingSelection(id, sel, arg0, arg1 != 0);
                    yield 0;
                }
            default ->
                0;
    ...
    static long windowProc(long id, long sel, long arg0, long arg1, long arg2) {
        ...
        return switch(Selector.valueOf(sel)) {
            case sel_tableView_objectValueForTableColumn_row_ ->
                ((SwtWidget) widget.getImpl()).tableView_objectValueForTableColumn_row(id, sel, arg0, arg1, arg2);
            case sel_tableView_shouldReorderColumn_toColumn_ ->
                ((SwtWidget) widget.getImpl()).tableView_shouldReorderColumn_toColumn(id, sel, arg0, arg1, arg2) ? 1 : 0;
            case sel_tableView_shouldEditTableColumn_row_ ->
                ((SwtWidget) widget.getImpl()).tableView_shouldEditTableColumn_row(id, sel, arg0, arg1, arg2) ? 1 : 0;
            case sel_outlineView_shouldReorderColumn_toColumn_ ->
                ((SwtWidget) widget.getImpl()).outlineView_shouldReorderColumn_toColumn(id, sel, arg0, arg1, arg2) ? 1 : 0;
            case sel_outlineView_shouldEditTableColumn_item_ ->
                ((SwtWidget) widget.getImpl()).outlineView_shouldEditTableColumn_row(id, sel, arg0, arg1, arg2) ? 1 : 0;
            case sel_textView_clickedOnLink_atIndex_ ->
                ((SwtWidget) widget.getImpl()).textView_clickOnLink_atIndex(id, sel, arg0, arg1, arg2) ? 1 : 0;
            case sel_outlineView_child_ofItem_ ->
                ((SwtWidget) widget.getImpl()).outlineView_child_ofItem(id, sel, arg0, arg1, arg2);
            case sel_outlineView_objectValueForTableColumn_byItem_ ->
                ((SwtWidget) widget.getImpl()).outlineView_objectValueForTableColumn_byItem(id, sel, arg0, arg1, arg2);
            case sel_textView_willChangeSelectionFromCharacterRange_toCharacterRange_ ->
                {
                    NSRange range = ((SwtWidget) widget.getImpl()).textView_willChangeSelectionFromCharacterRange_toCharacterRange(id, sel, arg0, arg1, arg2);
                    /* NOTE that this is freed in C */
                    long result = C.malloc(NSRange.sizeof);
                    OS.memmove(result, range, NSRange.sizeof);
                    yield result;
            ...
            case sel_dragSelectionWithEvent_offset_slideBack_ ->
                {
                    ...
                    yield (((SwtWidget) widget.getImpl()).dragSelectionWithEvent(id, sel, arg0, arg1, arg2) ? 1 : 0);
                }
            case sel_drawImage_withFrame_inView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg1, NSRect.sizeof);
                    ((SwtWidget) widget.getImpl()).drawImageWithFrameInView(id, sel, arg0, rect, arg2);
                    yield 0;
                }
            case sel_drawTitle_withFrame_inView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg1, NSRect.sizeof);
                    rect = ((SwtWidget) widget.getImpl()).drawTitleWithFrameInView(id, sel, arg0, rect, arg2);
                    /* NOTE that this is freed in C */
                    long result = C.malloc(NSRect.sizeof);
                    OS.memmove(result, rect, NSRect.sizeof);
                    yield result;
            ...
            case sel_hitTestForEvent_inRect_ofView_ ->
                {
                    NSRect rect = new NSRect();
                    OS.memmove(rect, arg1, NSRect.sizeof);
                    yield ((SwtWidget) widget.getImpl()).hitTestForEvent(id, sel, arg0, rect, arg2);
                }
            case sel_tableView_writeRowsWithIndexes_toPasteboard_ ->
                (((SwtWidget) widget.getImpl()).tableView_writeRowsWithIndexes_toPasteboard(id, sel, arg0, arg1, arg2) ? 1 : 0);
            case sel_outlineView_writeItems_toPasteboard_ ->
                (((SwtWidget) widget.getImpl()).outlineView_writeItems_toPasteboard(id, sel, arg0, arg1, arg2) ? 1 : 0);
            case sel_toolbar_itemForItemIdentifier_willBeInsertedIntoToolbar_ ->
                ((SwtWidget) widget.getImpl()).toolbar_itemForItemIdentifier_willBeInsertedIntoToolbar(id, sel, arg0, arg1, arg2 != 0);
            default ->
                0;
        };
    }
    ...
    static long windowProc(long id, long sel, long arg0, long arg1, long arg2, long arg3) {
        ...
        return switch(Selector.valueOf(sel)) {
            case sel_tableView_willDisplayCell_forTableColumn_row_ ->
                {
                    ((SwtWidget) widget.getImpl()).tableView_willDisplayCell_forTableColumn_row(id, sel, arg0, arg1, arg2, arg3);
                    yield 0;
                }
            case sel_outlineView_willDisplayCell_forTableColumn_item_ ->
                {
                    ((SwtWidget) widget.getImpl()).outlineView_willDisplayCell_forTableColumn_item(id, sel, arg0, arg1, arg2, arg3);
                    yield 0;
                }
            case sel_outlineView_setObjectValue_forTableColumn_byItem_ ->
                {
                    ((SwtWidget) widget.getImpl()).outlineView_setObjectValue_forTableColumn_byItem(id, sel, arg0, arg1, arg2, arg3);
                    yield 0;
                }
            case sel_tableView_setObjectValue_forTableColumn_row_ ->
                {
                    ((SwtWidget) widget.getImpl()).tableView_setObjectValue_forTableColumn_row(id, sel, arg0, arg1, arg2, arg3);
                    yield 0;
                }
            case sel_view_stringForToolTip_point_userData_ ->
                ((SwtWidget) widget.getImpl()).view_stringForToolTip_point_userData(id, sel, arg0, arg1, arg2, arg3);
            case sel_tableView_shouldTrackCell_forTableColumn_row_ ->
                ((SwtWidget) widget.getImpl()).tableView_shouldTrackCell_forTableColumn_row(id, sel, arg0, arg1, arg2, arg3) ? 1 : 0;
            case sel_outlineView_shouldTrackCell_forTableColumn_item_ ->
                ((SwtWidget) widget.getImpl()).outlineView_shouldTrackCell_forTableColumn_item(id, sel, arg0, arg1, arg2, arg3) ? 1 : 0;
            default ->
                0;
        };
    }
