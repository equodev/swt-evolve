 ...
 * @since 3.0
 */
public final class SwtMonitor implements IMonitor {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Monitor monitor))
            return false;
        return handle == ((SwtMonitor) monitor.getImpl()).handle;
    }
    ...
    public Monitor getApi() {
        if (api == null)
            api = Monitor.createApi(this);
        return (Monitor) api;
    }

    protected Monitor api;
