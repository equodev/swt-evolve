...
public class SwtProgressBar extends SwtControl implements IProgressBar {
    ...
    NSFont defaultNSFont() {
        return ((SwtDisplay) display.getImpl()).progressIndicatorFont;
    }
	...
	*/
    ...
    public int getMaximum() {
        checkWidget();
        return (int) ((NSProgressIndicator) getApi().view).maxValue();
    }
    ...
    public int getMinimum() {
        checkWidget();
        return (int) ((NSProgressIndicator) getApi().view).minValue();
    }
    ...
    public int getSelection() {
        checkWidget();
        return (int) ((NSProgressIndicator) getApi().view).doubleValue();
    }
    ...
    public void setMaximum(int value) {
        checkWidget();
        int minimum = (int) ((NSProgressIndicator) getApi().view).minValue();
        if (value <= minimum)
            return;
        ((NSProgressIndicator) getApi().view).setMaxValue(value);
        int selection = (int) ((NSProgressIndicator) getApi().view).doubleValue();
        int newSelection = Math.min(selection, value);
        if (selection != newSelection) {
            ((NSProgressIndicator) getApi().view).setDoubleValue(newSelection);
        }
    }
    ...
    public void setMinimum(int value) {
        checkWidget();
        int maximum = (int) ((NSProgressIndicator) getApi().view).maxValue();
        if (!(0 <= value && value < maximum))
            return;
        ((NSProgressIndicator) getApi().view).setMinValue(value);
        int selection = (int) ((NSProgressIndicator) getApi().view).doubleValue();
    ...
    public void setSelection(int value) {
        checkWidget();
        ((NSProgressIndicator) getApi().view).setDoubleValue(value);
        /*
