...
public class SwtTreeColumn extends SwtItem implements ITreeColumn {
	 ...
	 */
        int columnIndex = ((SwtTree) parent.getImpl()).indexOf(nsColumn);
        NSRect headerRect = ((SwtTree) parent.getImpl()).headerView.headerRectOfColumn(columnIndex);
        double borderWidth = ((SwtControl) parent.getImpl()).hasBorder() ? 0.5 : 0;
        if (headerRect.x != cellRect.x || headerRect.width != cellRect.width) {
            if (((SwtTree) parent.getImpl()).headerBackground != null) {
                ...
                double[] colorRGB = ((SwtTree) parent.getImpl()).headerBackground;
			 ...
			 */
                ...
                /* 0.5 -> header-row separator width */
		 ...
		 */
            ...
            if (((SwtTree) parent.getImpl()).headerForeground != null) {
                colorRGB = ((SwtTree) parent.getImpl()).headerForeground;
        ...
        if (((SwtTree) parent.getImpl()).sortColumn == this.getApi() && ((SwtTree) parent.getImpl()).sortDirection != SWT.NONE) {
            ...
            if (((SwtTree) parent.getImpl()).headerBackground != null || ((SwtTree) parent.getImpl()).headerForeground != null) {
                ...
                context.saveGraphicsState();
                if (((SwtTree) parent.getImpl()).headerForeground != null) {
                    double[] colorRGB = ((SwtTree) parent.getImpl()).headerForeground;
    ...
    public void setWidth(int width) {
        ...
        if (width < 0)
            return;
        // TODO how to differentiate 0 and 1 cases?
        width = Math.max(0, width - SwtTree.CELL_GAP);
