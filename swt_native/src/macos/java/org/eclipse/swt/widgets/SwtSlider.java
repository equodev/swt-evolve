...
public class SwtSlider extends SwtControl implements ISlider {
    ...
    public Point computeSize(int wHint, int hHint, boolean changed) {
        ...
        if ((style & SWT.HORIZONTAL) != 0) {
            ...
            width = (int) NSScroller.scrollerWidthForControlSize(((NSScroller) getApi().view).controlSize());
            height = width * 10;
        }
    ...
    NSFont defaultNSFont() {
        return ((SwtDisplay) display.getImpl()).scrollerFont;
    }
    ...
    void enableWidget(boolean enabled) {
        ...
        if (enabled) {
            ...
            if (range <= 0)
                ((NSScroller) getApi().view).setEnabled(false);
        }
    }
    ...
    public int getSelection() {
        checkWidget();
        NSScroller widget = (NSScroller) getApi().view;
    ...
    void sendSelection() {
        ...
        int hitPart = (int) ((NSScroller) getApi().view).hitPart();
