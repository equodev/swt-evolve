...
public class SwtTableColumn extends SwtItem implements ITableColumn {
	 ...
	 */
        int columnIndex = ((SwtTable) parent.getImpl()).indexOf(nsColumn);
        NSRect headerRect = ((SwtTable) parent.getImpl()).headerView.headerRectOfColumn(columnIndex);
        ...
        if (headerRect.x != cellRect.x || headerRect.width != cellRect.width) {
            if (((SwtTable) parent.getImpl()).headerBackground != null) {
                ...
                double[] /* float */
                colorRGB = ((SwtTable) parent.getImpl()).headerBackground;
        ...
        if (((SwtTable) parent.getImpl()).headerBackground != null) {
            ...
            context.saveGraphicsState();
            double[] colorRGB = ((SwtTable) parent.getImpl()).headerBackground;
		 ...
		 */
            ...
            if (((SwtTable) parent.getImpl()).headerForeground != null) {
                colorRGB = ((SwtTable) parent.getImpl()).headerForeground;
        ...
        if (((SwtTable) parent.getImpl()).sortColumn == this.getApi() && ((SwtTable) parent.getImpl()).sortDirection != SWT.NONE) {
            ...
            if (((SwtTable) parent.getImpl()).headerBackground != null || ((SwtTable) parent.getImpl()).headerForeground != null) {
                ...
                context.saveGraphicsState();
                if (((SwtTable) parent.getImpl()).headerForeground != null) {
                    double[] colorRGB = ((SwtTable) parent.getImpl()).headerForeground;
    ...
    public void setWidth(int width) {
        ...
        if (width < 0)
            return;
        // TODO how to differentiate 0 and 1 cases?
        width = Math.max(0, width - SwtTable.CELL_GAP);
