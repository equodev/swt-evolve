...
public class SwtScale extends SwtControl implements IScale {
    ...
    NSFont defaultNSFont() {
        return ((SwtDisplay) display.getImpl()).sliderFont;
    }
    ...
    public int getMaximum() {
        checkWidget();
        return (int) ((NSSlider) getApi().view).maxValue();
    }
    ...
    public int getMinimum() {
        checkWidget();
        return (int) ((NSSlider) getApi().view).minValue();
    }
    ...
    public int getSelection() {
        checkWidget();
        return (int) ((NSSlider) getApi().view).doubleValue();
    }
    ...
    public void setMaximum(int value) {
        checkWidget();
        int minimum = (int) ((NSSlider) getApi().view).minValue();
        if (value <= minimum)
            return;
        ((NSSlider) getApi().view).setMaxValue(value);
    }
    ...
    public void setMinimum(int value) {
        checkWidget();
        int maximum = (int) ((NSSlider) getApi().view).maxValue();
        if (!(0 <= value && value < maximum))
            return;
        ((NSSlider) getApi().view).setMinValue(value);
    }
