...
class StyledTextSerializeTest extends SerializeTestBase {
    ...
    void should_serialize_filled_StyledText() {
        ...
        assertJ.satisfies(node("alwaysShowScroll").equalsTo(w.getAlwaysShowScrollBars(), orAbsentIfFalse));
        ...
        assertJ.satisfies(node("caretOffsets").equalsTo(w.getCaretOffset(), orAbsentIf0));
        ...
        assertJ.satisfies(node("horizontalPixel").equalsTo(value(w).getHorizontalPixel(), orAbsentIf0));
        ...
        assertJ.satisfies(node("tabLength").equalsTo(w.getTabs(), orAbsentIf0));
        assertJ.satisfies(node("tabs").equalsTo(value(w).getTabs(), orAbsentIfNull));
