 ...
 * @since 3.3
 */
public class DartTreeDragSourceEffect extends DartDragSourceEffect implements ITreeDragSourceEffect {
     ...
     */
    public DartTreeDragSourceEffect(Tree tree, TreeDragSourceEffect api) {
        super(tree, api);
    }
