...
import org.eclipse.swt.custom.VControlEditor.*;
import dev.equo.swt.*;
...
public class DartControlEditor implements IControlEditor {
     ...
     */
    public DartControlEditor(Composite parent, ControlEditor api) {
        setApi(api);
        this.parent = parent;
    ...
    protected VControlEditor value;

    public VControlEditor getValue() {
        if (value == null)
            value = new VControlEditor(this);
        return (VControlEditor) value;
    }
}
