...
public class SwtIME extends SwtWidget implements IIME {
            ...
            if (pangoAttrs[0] != 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (attr != 0) {
                        ...
                        styles[i].foreground = SwtColor.gtk_new(display, rgba);
                    }
                    ...
                    if (attr != 0) {
                        ...
                        rgba.green = (attrColor.color_green & 0xFFFF) / (float) 0xFFFF;
                        rgba.blue = (attrColor.color_blue & 0xFFFF) / (float) 0xFFFF;
                        styles[i].background = SwtColor.gtk_new(display, rgba);
                    }
                    ...
                    if (attr != 0) {
                        ...
                        if (styles[i].underline) {
                            ...
                            if (attr != 0) {
                                ...
                                rgba.green = (attrColor.color_green & 0xFFFF) / (float) 0xFFFF;
                                rgba.blue = (attrColor.color_blue & 0xFFFF) / (float) 0xFFFF;
                                styles[i].underlineColor = SwtColor.gtk_new(display, rgba);
                            }
                        }
                    }
    ...
    long imHandle() {
        return ((SwtComposite) parent.getImpl()).imHandle();
    }
