...
public final class SwtColor extends SwtResource implements IColor {
    ...
    public boolean equals(Object object) {
        if (object != null && ((Color) object).getImpl() instanceof DartColor)
            return ((DartColor) ((Color) object).getImpl()).getBlue() == getBlue() && ((DartColor) ((Color) object).getImpl()).getRed() == getRed() && ((DartColor) ((Color) object).getImpl()).getGreen() == getGreen() && ((DartColor) ((Color) object).getImpl()).getAlpha() == getAlpha();
	 ...
	 */
        int b = (((int) (getApi().handle.blue * 65535.0 + 0.5)) >> 8);
	 ...
	 * and color_to_pixel() functions. See bug 549181 and 549101 for more info.
	 */
        int g = (((int) (getApi().handle.green * 65535.0 + 0.5)) >> 8);
	 ...
	 * and color_to_pixel() functions. See bug 549181 and 549101 for more info.
	 */
        int r = (((int) (getApi().handle.red * 65535.0 + 0.5)) >> 8);
    ...
    public static Color gtk_new(Device device, GdkRGBA gdkRGBA) {
        ...
        if (color.getImpl() instanceof DartColor) {
            ((DartColor) color.getImpl()).alpha = (int) (gdkRGBA.alpha * 255);
        }
        if (color.getImpl() instanceof SwtColor) {
            ((SwtColor) color.getImpl()).alpha = (int) (gdkRGBA.alpha * 255);
        }
        return color;
    }
