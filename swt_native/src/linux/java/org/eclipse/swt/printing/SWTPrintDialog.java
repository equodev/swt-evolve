...
public class SWTPrintDialog extends SWTDialog implements IPrintDialog {
     ...
     * @see Widget#getStyle
     */
    public SWTPrintDialog(SWTShell parent) {
     ...
     * @see Widget#getStyle
     */
    public SWTPrintDialog(SWTShell parent, int style) {
    ...
    static int checkStyleBit(SWTShell parent, int style) {
    ...
    public PrinterData open() {
        ...
        long topHandle = ((SWTShell) (getParent())).handle;
	 ...
	 */
        ...
        SWTDisplay display = (SWTDisplay) (getParent() != null ? getParent().getDisplay() : SWTDisplay.getCurrent());
        int signalId = 0;
        long hookId = 0;
        ...
        if (response == GTK.GTK_RESPONSE_OK) {
            ...
            if (printer != 0) {
                ...
                // TODO: GTK_FILE_BACKEND is not GTK API (see gtk bug 345590)
                data.printToFile = Printer.GTK_FILE_BACKEND.equals(data.driver);
                if (data.printToFile) {
