...
public class AccessibleTextAttributeEvent extends EventObject {
    ...
    public String toString() {
        return //$NON-NLS-1$
        "AccessibleAttributeEvent {" + " offset=" + //$NON-NLS-1$
        offset + " start=" + //$NON-NLS-1$
        start + " end=" + //$NON-NLS-1$
        end + " textStyle=" + //$NON-NLS-1$
        textStyle + " attributes=" + //$NON-NLS-1$
        toAttributeString(attributes) + " result=" + //$NON-NLS-1$
        result + //$NON-NLS-1$
        "}";
    }
