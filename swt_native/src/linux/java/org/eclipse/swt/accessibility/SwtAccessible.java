...
public class SwtAccessible implements IAccessible {
    ...
    SwtAccessible(Control control, Accessible api) {
        ...
        accessibleObject = new AccessibleObject(type, getControlHandle(), this.getApi(), false);
        addRelations();
    }
    ...
    AccessibleObject getAccessibleObject() {
        if (accessibleObject == null) {
            ...
            if (parent == null) {
                accessibleObject = new AccessibleObject(type, widget, this.getApi(), false);
            } else {
                accessibleObject = new AccessibleObject(type, 0, this.getApi(), true);
                accessibleObject.parent = ((SwtAccessible) parent.getImpl()).getAccessibleObject();
            }
        }
