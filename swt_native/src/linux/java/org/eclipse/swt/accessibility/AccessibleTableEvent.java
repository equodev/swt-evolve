...
public class AccessibleTableEvent extends EventObject {
    ...
    public String toString() {
        return //$NON-NLS-1$
        "AccessibleTableEvent {" + "accessible=" + //$NON-NLS-1$
        accessible + " accessibles=" + //$NON-NLS-1$
        Arrays.toString(accessibles) + " string=" + //$NON-NLS-1$
        result + " isSelected=" + //$NON-NLS-1$
        isSelected + " column=" + //$NON-NLS-1$
        column + " count=" + //$NON-NLS-1$
        count + " row=" + //$NON-NLS-1$
        row + " selected=" + //$NON-NLS-1$
        Arrays.toString(selected) + //$NON-NLS-1$
        "}";
    }
}
