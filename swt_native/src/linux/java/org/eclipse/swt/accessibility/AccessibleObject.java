    ...
    static long atkComponent_ref_accessible_at_point(long atkObject, long x, long y, long coord_type) {
        ...
        if (object != null) {
            ...
            if (length > 0) {
                ...
                AccessibleObject accObj = result != null ? ((SwtAccessible) result.getImpl()).getAccessibleObject() : object.getChildByID(event.childID);
                if (accObj != null) {
    ...
    static long atkEditableText_set_run_attributes(long atkObject, long attrib_set, long start_offset, long end_offset) {
        ...
        if (object != null) {
            ...
            if (length > 0) {
                ...
                if (createFont) {
                    style.font = SwtFont.gtk_new(display, fontDesc);
                }
    ...
    static long atkHypertext_get_link(long atkObject, long link_index) {
        ...
        if (object != null) {
            ...
            if (length > 0) {
                ...
                Accessible result = event.accessible;
                return result != null ? ((SwtAccessible) result.getImpl()).getAccessibleObject().atkHandle : 0;
            }
        }
        long parentResult = 0;
    ...
    static long atkObject_get_attributes(long atkObject) {
        ...
        if (object != null) {
            ...
            if (length > 0) {
                ...
                event.topMargin = event.bottomMargin = event.leftMargin = event.rightMargin = event.alignment = event.indent = event.groupLevel = event.groupCount = event.groupIndex = -1;
                for (int i = 0; i < length; i++) {
                ...
                if (event.topMargin != -1) {
                    long attrPtr = OS.g_malloc(AtkAttribute.sizeof);
                    //$NON-NLS-1$
                    attr.name = getStringPtr("top-margin");
                ...
                if (event.bottomMargin != -1) {
                    long attrPtr = OS.g_malloc(AtkAttribute.sizeof);
                    //$NON-NLS-1$
                    attr.name = getStringPtr("bottom-margin");
                ...
                if (setsize != 0) {
                    long attrPtr = OS.g_malloc(AtkAttribute.sizeof);
                    //$NON-NLS-1$
                    attr.name = getStringPtr("setsize");
                ...
                if (posinset != 0) {
                    long attrPtr = OS.g_malloc(AtkAttribute.sizeof);
                    //$NON-NLS-1$
                    attr.name = getStringPtr("posinset");
            ...
            if (length > 0) {
                ...
                if (event.detail != -1) {
                    switch(event.detail) {
                        ...
                        case ACC.ROLE_ROW:
                            return ATK.ATK_ROLE_TABLE_ROW;
                        //Column role doesn't exist on Gtk.
        ...
        if (object != null && object.id == ACC.CHILDID_SELF) {
            ...
            if (length > 0) {
                ...
                if (event.accessible != null) {
                    AccessibleObject accObject = ((SwtAccessible) event.accessible.getImpl()).getAccessibleObject();
                    if (accObject != null) {
    ...
    static long atkSelection_is_child_selected(long atkObject, long index) {
        ...
        if (object != null) {
            ...
            if (length > 0) {
                ...
                Accessible result = event.accessible;
                AccessibleObject accessibleObject = result != null ? ((SwtAccessible) result.getImpl()).getAccessibleObject() : object.getChildByID(event.childID);
    ...
    static long atkTable_ref_at(long atkObject, long row, long column) {
        ...
        if (object != null) {
            ...
            if (length > 0) {
                ...
                Accessible result = event.accessible;
                if (result != null) {
                    AccessibleObject accessibleObject = ((SwtAccessible) result.getImpl()).getAccessibleObject();
    ...
    static long atkTable_get_caption(long atkObject) {
        ...
        if (object != null) {
            ...
            if (length > 0) {
                ...
                Accessible result = event.accessible;
                if (result != null)
                    return ((SwtAccessible) result.getImpl()).getAccessibleObject().atkHandle;
            }
        }
        long parentResult = 0;
        AtkTableIface iface = getParentTableIface(atkObject);
            ...
            if (length > 0) {
                ...
                if (accessibles != null) {
                    if (0 <= column && column < accessibles.length) {
                        return ((SwtAccessible) accessibles[(int) column].getImpl()).getAccessibleObject().atkHandle;
                    }
                }
            }
        }
            ...
            if (length > 0) {
                ...
                if (accessibles != null) {
                    if (0 <= row && row < accessibles.length) {
                        return ((SwtAccessible) accessibles[(int) row].getImpl()).getAccessibleObject().atkHandle;
                    }
                }
            }
        }
            ...
            if (length > 0) {
                ...
                if (style != null) {
                    ...
                    if (color != null && !color.isDisposed()) {
                        ...
                        //$NON-NLS-1$ //$NON-NLS-2$
                        attr.value = getStringPtr((color.handle.red * 255) + "," + (color.handle.green * 255) + "," + (color.handle.blue * 255));
                        ATK.memmove(attrPtr, attr, AtkAttribute.sizeof);
                        result = OS.g_slist_append(result, attrPtr);
                    }
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child instanceof Integer) {
                ...
                if (object == null || object.id != id) {
                    ...
                    if (event.accessible != null) {
                        object = ((SwtAccessible) event.accessible.getImpl()).getAccessibleObject();
                        if (object != null)
                            OS.g_object_ref(object.atkHandle);
                    } else {
                        long type = OS.G_OBJECT_TYPE(((SwtAccessible) accessible.getImpl()).getControlHandle());
                        long widget = ((SwtAccessible) accessible.getImpl()).getControlHandle();
                ...
                object = ((SwtAccessible) ((Accessible) child).getImpl()).getAccessibleObject();
                if (object != null)
                    OS.g_object_ref(object.atkHandle);
            }
            if (object != null) {
