...
public class SWTBrowserFunction implements IBrowserFunction {
     ...
     * @see org.eclipse.swt.browser.LocationListener#changed(LocationEvent)
     */
    public SWTBrowserFunction(SWTBrowser browser, String name) {
     ...
     * @since 3.8
     */
    public SWTBrowserFunction(SWTBrowser browser, String name, boolean top, String[] frameNames) {
        this(browser, name, top, frameNames, true);
    }

    SWTBrowserFunction(SWTBrowser browser, String name, boolean top, String[] frameNames, boolean create) {
        super();
        if (browser == null)
