...
public class WindowEvent extends TypedEvent {
    ...
    public String toString() {
        ...
        string.substring(0, string.length() - 1) + " required=" + required + " browser=" + browser + " location=" + location + " size=" + size + " addressBar=" + addressBar + " menuBar=" + menuBar + " statusBar=" + statusBar + " toolBar=" + toolBar + "}";
    }
}
