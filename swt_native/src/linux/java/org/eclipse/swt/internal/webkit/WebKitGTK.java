...
public class WebKitGTK extends C {
    ...
    static {
        ...
        // Note, this is read in multiple places.
        String swt_lib_versions = OS.getEnvironmentalVariable(OS.SWT_LIB_VERSIONS);
    ...
    // $NON-NLS-1$
    public static final byte[] load_failed_with_tls_errors = ascii("load-failed-with-tls-errors");
    ...
    // $NON-NLS-1$
    public static final byte[] decide_destination = ascii("decide-destination");
    ...
    // $NON-NLS-1$
    public static final byte[] failed = ascii("failed");

    // $NON-NLS-1$
    public static final byte[] finished = ascii("finished");
    ...
    // $NON-NLS-1$
    public static final byte[] enable_javascript = ascii("enable-javascript");

    public static final byte[] enable_developer_extras = ascii("enable-developer-extras");

    // $NON-NLS-1$
    public static final byte[] enable_webgl = ascii("enable-webgl");

    // $NON-NLS-1$
    public static final byte[] hardware_acceleration_policy = ascii("hardware-acceleration-policy");

    // $NON-NLS-1$
    public static final byte[] enable_back_forward_navigation_gestures = ascii("enable-back-forward-navigation-gestures");

    // Since 2.14
    // $NON-NLS-1$
    public static final byte[] allow_universal_access_from_file_urls = ascii("allow-universal-access-from-file-urls");
 ...
 */
     ...
     * @method flags=dynamic
     */
    public static final native void webkit_web_view_evaluate_javascript(long web_view, byte[] script, long length, long world_name, long source_uri, long cancellable, long callback, long user_data);
