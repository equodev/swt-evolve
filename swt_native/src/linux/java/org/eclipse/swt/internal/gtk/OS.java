...
public class OS extends C {
    ...
    static {
        ...
        String swt_lib_versions = getEnvironmentalVariable(OS.SWT_LIB_VERSIONS);
     ...
     * @category gdbus
     */
    // Not used by Dbus, but implemented by GDBus.
    ...
    // Gtk3/4, Guesture related.
    public static final byte[] angle_changed = ascii("angle-changed");
	...
	*/
     ...
     */
    public static final native boolean /*long*/
    g_file_test(byte[] file, int test);
     ...
     * @category gdbus
     */
    public static final native long g_dbus_proxy_new_for_bus_sync(int bus_type, int flags, long info, byte[] name, byte[] object_path, byte[] interface_name, long cancellable, long[] error);
