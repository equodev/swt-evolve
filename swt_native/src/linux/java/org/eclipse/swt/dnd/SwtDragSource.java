...
public class SwtDragSource extends SwtWidget implements IDragSource {
    ...
    static long dragPrepareProc(long source, double x, double y) {
        ...
        if (dragSource == null)
            return 0;
        return ((SwtDragSource) dragSource.getImpl()).dragPrepare();
    }
    ...
    static long DragBegin(long widget, long context) {
        ...
        if (source == null)
            return 0;
        ((SwtDragSource) source.getImpl()).dragBegin(widget, context);
        return 0;
    }
    ...
    static long DragDataDelete(long widget, long context) {
        ...
        if (source == null)
            return 0;
        ((SwtDragSource) source.getImpl()).dragDataDelete(widget, context);
        return 0;
    }
    ...
    static long DragEnd(long widget, long context) {
        ...
        if (source == null)
            return 0;
        ((SwtDragSource) source.getImpl()).dragEnd(widget, context);
        return 0;
    }
    ...
    static long DragGetData(long widget, long context, long selection_data, long info, long time) {
        ...
        if (source == null)
            return 0;
        ((SwtDragSource) source.getImpl()).dragGetData(widget, context, selection_data, (int) info, (int) time);
        return 0;
    }
