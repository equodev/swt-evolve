 ...
 * @since 3.4
 */
public class SwtImageTransfer extends SwtByteArrayTransfer implements IImageTransfer {
    ...
    public Object nativeToJava(TransferData transferData) {
        ...
        if (transferData.length > 0) {
            ...
            try {
                ...
                if (pixbuf != 0) {
                    Image img = SwtImage.gtk_new_from_pixbuf(SwtDisplay.getCurrent(), SWT.BITMAP, pixbuf);
