...
public class DartDropTarget extends DartWidget implements IDropTarget {
    ...
    static long Drag_Data_Received(long widget, long context, long x, long y, long data, long info, long time) {
        ...
        if (target == null)
            return 0;
        ((DartDropTarget) target.getImpl()).drag_data_received(widget, context, (int) x, (int) y, data, (int) info, (int) time);
        return 0;
    }
    ...
    static long Drag_Drop(long widget, long context, long x, long y, long time) {
        ...
        if (target == null)
            return 0;
        return ((DartDropTarget) target.getImpl()).drag_drop(widget, context, (int) x, (int) y, (int) time) ? 1 : 0;
    }
    ...
    static long Drag_Leave(long widget, long context, long time) {
        ...
        if (target == null)
            return 0;
        ((DartDropTarget) target.getImpl()).drag_leave(widget, context, (int) time);
        return 0;
    }
    ...
    static long Drag_Motion(long widget, long context, long x, long y, long time) {
        ...
        if (target == null)
            return 0;
        return ((DartDropTarget) target.getImpl()).drag_motion(widget, context, (int) x, (int) y, (int) time) ? 1 : 0;
    }
