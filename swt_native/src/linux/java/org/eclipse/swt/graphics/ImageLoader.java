...
public class ImageLoader {
            ...
            if (isStatic) {
                ...
                for (int i = 0; i < num_frames; i++) {
                    ...
                    if (update) {
                        ...
                        // copy because curr_pixbuf might get disposed on next advance
    ...
    static ImageData pixbufToImageData(long pixbuf) {
        ...
        // only 3 or 4 samples per pixel are supported
        int n_channels = GDK.gdk_pixbuf_get_n_channels(pixbuf);
        // only 8 bit per sample are supported
