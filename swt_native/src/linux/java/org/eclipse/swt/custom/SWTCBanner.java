 ...
 */
public class SWTCBanner extends SWTComposite implements ICBanner {
     ...
     * </ul>
     */
    public SWTCBanner(SWTComposite parent, int style) {
        super(parent, checkStyle(style));
        super.setLayout(new CBannerLayout());
        resizeCursor = ((SWTDisplay) (getDisplay())).getSystemCursor(SWT.CURSOR_SIZEWE);
        listener = e -> {
            switch(e.type) {
                case SWT.Dispose:
                    onDispose(e);
...
*/
    ...
    void onPaint(GC gc) {
        ...
        if (left == null && right == null)
            return;
        Point size = getSize();
        Color border1 = ((SWTDisplay) (getDisplay())).getSystemColor(BORDER1);
        if (bottom != null) {
     ...
     * @since 3.0
     */
    public void setBottom(IControl control_) {
     ...
     * @since 3.0
     */
    public void setLeft(IControl control_) {
        SWTControl control = (SWTControl) control_;
        checkWidget();
        if (control != null && ((SWTComposite) (control.getParent())) != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
     ...
     * @since 3.0
     */
    public void setRight(IControl control_) {
        SWTControl control = (SWTControl) control_;
        checkWidget();
        if (control != null && ((SWTComposite) (control.getParent())) != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
