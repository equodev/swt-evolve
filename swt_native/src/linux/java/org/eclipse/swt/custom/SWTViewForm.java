 ...
 */
public class SWTViewForm extends SWTComposite implements IViewForm {
     ...
     * @see #getStyle()
     */
    public SWTViewForm(SWTComposite parent, int style) {
    ...
    void onPaint(GC gc) {
        ...
        Point size = getSize();
        Color border = ((SWTDisplay) (getDisplay())).getSystemColor(BORDER1_COLOR);
        if (showBorder) {
            ...
            if (highlight > 0) {
                ...
                Color highlightColor = ((SWTDisplay) (getDisplay())).getSystemColor(SWT.COLOR_LIST_SELECTION);
    ...
    public void setContent(IControl content_) {
        ...
        checkWidget();
        if (content != null && ((SWTComposite) (content.getParent())) != this) {
     ...
     * </ul>
     */
    public void setTopCenter(IControl topCenter_) {
        SWTControl topCenter = (SWTControl) topCenter_;
        checkWidget();
        if (topCenter != null && ((SWTComposite) (topCenter.getParent())) != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
        }
     ...
     * </ul>
     */
    public void setTopLeft(IControl c_) {
        SWTControl c = (SWTControl) c_;
        checkWidget();
        if (c != null && ((SWTComposite) (c.getParent())) != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
        }
     ...
     * </ul>
     */
    public void setTopRight(IControl c_) {
        SWTControl c = (SWTControl) c_;
        checkWidget();
        if (c != null && ((SWTComposite) (c.getParent())) != this) {
            SWT.error(SWT.ERROR_INVALID_ARGUMENT);
