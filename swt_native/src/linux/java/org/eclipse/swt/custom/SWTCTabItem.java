 ...
 */
public class SWTCTabItem extends SWTItem implements ICTabItem {

    SWTCTabFolder parent;
     ...
     * @see Widget#getStyle()
     */
    public SWTCTabItem(SWTCTabFolder parent, int style) {
     ...
     * @see Widget#getStyle()
     */
    public SWTCTabItem(SWTCTabFolder parent, int style, int index) {
        super(parent, style);
    ...
    public void setControl(IControl control_) {
        ...
        if (control != null) {
            ...
            if (((SWTComposite) (control.getParent())) != parent)
        ...
        if (this.control != null) {
            ...
            if (index == parent.getSelectionIndex()) {
                ...
                SWTControl selectedControl = (SWTControl) (null);
                if (selectedIndex != -1) {
                    selectedControl = ((SWTCTabItem) (parent.getItem(selectedIndex))).control;
                }
    ...
    public void setFont(Font font) {
        ...
        if (font != null && font.equals(this.font))
            return;
        this.font = font;
        parent.updateFolder(SWTCTabFolder.UPDATE_TAB_HEIGHT | SWTCTabFolder.REDRAW_TABS);
    }
    ...
    public void setForeground(Color color) {
        ...
        if (color == foreground)
            return;
        foreground = color;
        parent.updateFolder(SWTCTabFolder.REDRAW_TABS);
    }
