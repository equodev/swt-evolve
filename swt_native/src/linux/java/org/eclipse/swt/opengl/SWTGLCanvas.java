 ...
 * @since 3.2
 */
public class SWTGLCanvas extends SWTCanvas implements IGLCanvas {
     ...
     * </ul>
     */
    public SWTGLCanvas(SWTComposite parent, int style, GLData data) {
        super(parent, style);
        if (data == null)
        ...
        glxAttrib[pos++] = 0;
        GTK.gtk_widget_realize(getHandle());
        long window = GTK3.gtk_widget_get_window(getHandle());
        ...
        long share = data.shareContext != null ? data.shareContext.getContext() : 0;
        ...
        attrs.width = 1;
        attrs.height = 1;
        attrs.event_mask = GDK.GDK_KEY_PRESS_MASK | GDK.GDK_KEY_RELEASE_MASK | GDK.GDK_FOCUS_CHANGE_MASK | GDK.GDK_POINTER_MOTION_MASK | GDK.GDK_BUTTON_PRESS_MASK | GDK.GDK_BUTTON_RELEASE_MASK | GDK.GDK_ENTER_NOTIFY_MASK | GDK.GDK_LEAVE_NOTIFY_MASK | GDK.GDK_EXPOSURE_MASK | GDK.GDK_POINTER_MOTION_HINT_MASK;
        attrs.window_type = GDK.GDK_WINDOW_CHILD;
        attrs.visual = gdkvisual;
        glWindow = GTK3.gdk_window_new(window, attrs, GDK.GDK_WA_VISUAL);
        GDK.gdk_window_set_user_data(glWindow, getHandle());
        ...
        Listener listener = event -> {
            switch(event.type) {
                ...
                case SWT.Resize:
                    ...
                    break;
                case SWT.Dispose:
                    long window1 = GTK3.gtk_widget_get_window(getHandle());
