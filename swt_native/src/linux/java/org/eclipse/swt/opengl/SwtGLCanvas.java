...
public class SwtGLCanvas extends SwtCanvas implements IGLCanvas {
    ...
    public SwtGLCanvas(Composite parent, int style, GLData data, GLCanvas api) {
        ...
        long window = GTK3.gtk_widget_get_window(getApi().handle);
        ...
        long share = data.shareContext != null ? ((SwtGLCanvas) data.shareContext.getImpl()).context : 0;
        ...
        GDK.gdk_window_set_user_data(glWindow, getApi().handle);
        ...
        Listener listener = event -> {
            switch(event.type) {
                ...
                case SWT.Resize:
                    ...
                    break;
                case SWT.Dispose:
                    long window1 = GTK3.gtk_widget_get_window(getApi().handle);
