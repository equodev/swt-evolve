 ...
 */
public abstract class DynScrollable extends DynControl implements IScrollable {

    /**
     * Prevents uninitialized instances from being created outside the package.
     */
    DynScrollable(Scrollable api) {
        super(api);
    }
     ...
     * @see Widget#getStyle
     */
    public DynScrollable(Composite parent, int style, Scrollable api) {
    ...
    public Rectangle computeTrim(int x, int y, int width, int height) {
        System.out.println("+++ CONVERTING DynComposite from Scrollable#computeTrim(int, int, int, int) #" + getApi().hashCode());
        IScrollable newImpl = (IScrollable) convert();
        return newImpl.computeTrim(x, y, width, height);
    }

    @Override
    public void updateBackgroundMode() {
        System.out.println("+++ CONVERTING DynComposite from Scrollable#updateBackgroundMode() #" + getApi().hashCode());
        IScrollable newImpl = (IScrollable) convert();
    ...
    public Rectangle getClientArea() {
        System.out.println("+++ CONVERTING DynComposite from Scrollable#getClientArea() #" + getApi().hashCode());
        IScrollable newImpl = (IScrollable) convert();
        return newImpl.getClientArea();
    }
    ...
    public int getScrollbarsMode() {
        if (Config.isDebug())
            System.out.println("++ Called Scrollable#getScrollbarsMode() on DynScrollable" + " #" + getApi().hashCode());
    ...
    public void setScrollbarsMode(int mode) {
        if (Config.isDebug())
            System.out.println("++ Called Scrollable#setScrollbarsMode(int) on DynScrollable" + " #" + getApi().hashCode());
        scrollbarsModeSet = true;
    ...
    public long topHandle() {
        System.out.println("+++ CONVERTING DynComposite from Scrollable#topHandle() #" + getApi().hashCode());
        IScrollable newImpl = (IScrollable) convert();
