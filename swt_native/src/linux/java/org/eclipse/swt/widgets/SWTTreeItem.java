...
public class SWTTreeItem extends SWTItem implements ITreeItem {
     ...
     * @see Widget#getStyle
     */
    public SWTTreeItem(SWTTree parent, int style) {
     ...
     * @see Tree#setRedraw
     */
    public SWTTreeItem(SWTTree parent, int style, int index) {
     ...
     * @see Widget#getStyle
     */
    public SWTTreeItem(SWTTreeItem parentItem, int style) {
     ...
     * @see Tree#setRedraw
     */
    public SWTTreeItem(SWTTreeItem parentItem, int style, int index) {
        this(checkNull(parentItem).parent, parentItem.handle, style, checkIndex(index), 0);
    }

    SWTTreeItem(SWTTree parent, long parentIter, int style, int index, long iter) {
        super(parent, style);
        this.parent = parent;
        if (iter == 0) {
    ...
    static SWTTreeItem checkNull(SWTTreeItem item) {
        if (item == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
        return item;
    }

    static SWTTree checkNull(SWTTree control) {
        if (control == null)
            SWT.error(SWT.ERROR_NULL_ARGUMENT);
        return control;
    }
    ...
    Color _getBackground() {
        long[] ptr = new long[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTree.BACKGROUND_COLUMN, ptr, -1);
        if (ptr[0] == 0)
    ...
    Color _getBackground(int index) {
        ...
        long[] ptr = new long[1];
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTree.CELL_BACKGROUND, ptr, -1);
        if (ptr[0] == 0)
            return _getBackground();
        GdkRGBA gdkRGBA = new GdkRGBA();
        OS.memmove(gdkRGBA, ptr[0], GdkRGBA.sizeof);
    ...
    boolean _getChecked() {
        int[] ptr = new int[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTree.CHECKED_COLUMN, ptr, -1);
        return ptr[0] != 0;
    }

    Color _getForeground() {
        long[] ptr = new long[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTree.FOREGROUND_COLUMN, ptr, -1);
        if (ptr[0] == 0)
    ...
    Color _getForeground(int index) {
        ...
        long[] ptr = new long[1];
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTree.CELL_FOREGROUND, ptr, -1);
        if (ptr[0] == 0)
            return _getForeground();
        GdkRGBA gdkRGBA = new GdkRGBA();
        OS.memmove(gdkRGBA, ptr[0], GdkRGBA.sizeof);
    ...
    Image _getImage(int index) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTree.CELL_SURFACE, surfaceHandle, -1);
    ...
    String _getText(int index) {
        ...
        long[] ptr = new long[1];
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTree.CELL_TEXT, ptr, -1);
        //$NON-NLS-1$
        if (ptr[0] == 0)
            return "";
    ...
    public ITreeItem[] getItems() {
        ...
        if (!parent.checkData(this))
            error(SWT.ERROR_WIDGET_DISPOSED);
        return ((SWTTreeItem[]) (parent.getItems(handle)));
    }
    ...
    public void dispose() {
        ...
        SWTTree tmpParent = (SWTTree) (null);
    ...
    public void removeAll() {
        ...
        while (GTK.gtk_tree_model_iter_children(modelHandle, iter, handle)) {
            ...
            SWTTreeItem item = (SWTTreeItem) (value[0] != -1 ? parent.items[value[0]] : null);
    ...
    public void setBackground(Color color) {
        ...
        GTK.gtk_tree_store_set(parent.modelHandle, handle, SWTTree.BACKGROUND_COLUMN, gdkRGBA, -1);
        cached = true;
    }
    ...
    public void setBackground(int index, Color color) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        GdkRGBA gdkRGBA = color != null ? color.handle : null;
        GTK.gtk_tree_store_set(parent.modelHandle, handle, modelIndex + SWTTree.CELL_BACKGROUND, gdkRGBA, -1);
        cached = true;
        updated = true;
        if (color != null) {
    ...
    public void setChecked(boolean checked) {
        ...
        if (_getChecked() == checked)
            return;
        GTK.gtk_tree_store_set(parent.modelHandle, handle, SWTTree.CHECKED_COLUMN, checked, -1);
        /*
	...
	*/
        GTK.gtk_tree_store_set(parent.modelHandle, handle, SWTTree.GRAYED_COLUMN, !checked ? false : grayed, -1);
        cached = true;
    }
    ...
    public void setFont(Font font) {
        ...
        GTK.gtk_tree_store_set(parent.modelHandle, handle, SWTTree.FONT_COLUMN, fontHandle, -1);
        cached = true;
    }
    ...
    public void setFont(int index, Font font) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        long fontHandle = font != null ? font.handle : 0;
        GTK.gtk_tree_store_set(parent.modelHandle, handle, modelIndex + SWTTree.CELL_FONT, fontHandle, -1);
        cached = true;
        if (font != null) {
            boolean customDraw = (parent.columnCount == 0) ? parent.firstCustomDraw : parent.columns[index].customDraw;
            if (!customDraw) {
    ...
    public void setForeground(Color color) {
        ...
        if (_getForeground().equals(color))
            return;
        GdkRGBA gdkRGBA = color != null ? color.handle : null;
        GTK.gtk_tree_store_set(parent.modelHandle, handle, SWTTree.FOREGROUND_COLUMN, gdkRGBA, -1);
        cached = true;
    }
    ...
    public void setForeground(int index, Color color) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        GdkRGBA gdkRGBA = color != null ? color.handle : null;
        GTK.gtk_tree_store_set(parent.modelHandle, handle, modelIndex + SWTTree.CELL_FOREGROUND, gdkRGBA, -1);
        cached = true;
        updated = true;
        if (color != null) {
            boolean customDraw = (parent.columnCount == 0) ? parent.firstCustomDraw : parent.columns[index].customDraw;
	...
	*/
        int[] ptr = new int[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTree.CHECKED_COLUMN, ptr, -1);
        GTK.gtk_tree_store_set(parent.modelHandle, handle, SWTTree.GRAYED_COLUMN, ptr[0] == 0 ? false : grayed, -1);
        cached = true;
    }
    ...
    public void setImage(int index, Image image) {
        ...
        GTK.gtk_tree_store_set(parent.modelHandle, handle, modelIndex + SWTTree.CELL_PIXBUF, pixbuf, -1);
        /*
	 ...
	 */
        ...
        GTK.gtk_tree_store_set(parent.modelHandle, handle, modelIndex + SWTTree.CELL_SURFACE, surface, -1);
        cached = true;
        updated = true;
    }
    ...
    public void setText(int index, String string) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTree.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_store_set(parent.modelHandle, handle, modelIndex + SWTTree.CELL_TEXT, buffer, -1);
        cached = true;
        updated = true;
    }
