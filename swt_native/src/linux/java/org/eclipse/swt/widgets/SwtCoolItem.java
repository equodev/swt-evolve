 ...
 */
    void calculateChevronTrim() {
        ...
        size = ((SwtCoolBar) parent.getImpl()).fixPoint(size.x, size.y);
    ...
    Image createArrowImage(int width, int height) {
        Point point = ((SwtCoolBar) parent.getImpl()).fixPoint(width, height);
        width = point.x;
        height = point.y;
    ...
    public Rectangle getBounds() {
        checkWidget();
        return ((SwtCoolBar) parent.getImpl()).fixRectangle(itemBounds.x, itemBounds.y, itemBounds.width, itemBounds.height);
    }
    ...
    public Point getMinimumSize() {
        checkWidget();
        return ((SwtCoolBar) parent.getImpl()).fixPoint(minimumWidth, minimumHeight);
    }
    ...
    public Point getPreferredSize() {
        checkWidget();
        return ((SwtCoolBar) parent.getImpl()).fixPoint(preferredWidth, preferredHeight);
    }
    ...
    public Point getSize() {
        checkWidget();
        return ((SwtCoolBar) parent.getImpl()).fixPoint(itemBounds.width, itemBounds.height);
    }
 ...
 */
    ...
    void setBounds(int x, int y, int width, int height) {
        ...
        if (control != null) {
            ...
            control.setBounds(((SwtCoolBar) parent.getImpl()).fixRectangle(x + MINIMUM_WIDTH, y, controlWidth, height));
        }
        updateChevron();
    }
    ...
    public void setSize(int width, int height) {
        ...
        ((SwtCoolBar) parent.getImpl()).relayout();
        updateChevron();
    }
    ...
    void updateChevron() {
        if (control != null) {
            ...
            if ((getApi().style & SWT.DROP_DOWN) != 0 && width < preferredWidth) {
                ...
                chevron.setBounds(((SwtCoolBar) parent.getImpl()).fixRectangle(itemBounds.x + width - CHEVRON_LEFT_MARGIN - CHEVRON_IMAGE_WIDTH - CHEVRON_HORIZONTAL_TRIM, itemBounds.y, CHEVRON_IMAGE_WIDTH + CHEVRON_HORIZONTAL_TRIM, height));
