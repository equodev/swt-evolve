...
public class SwtDisplay extends SwtDevice implements Executor, IDisplay {
    ...
    Synchronizer synchronizer = new Synchronizer(this.getApi());
    ...
    private class SessionManagerListener implements SessionManagerDBus.IListener {
        ...
        public boolean isReadyToExit() {
            ...
            ((SwtDisplay) parent.getImpl()).sendEvent(SWT.Close, event);
            return event.doit;
        }
...
*/
    ...
    long cellDataProc(long tree_column, long cell, long tree_model, long iter, long data) {
        ...
        if (widget == null)
            return 0;
        return ((SwtWidget) widget.getImpl()).cellDataProc(tree_column, cell, tree_model, iter, data);
    }
        ...
        synchronized (SwtDisplay.class) {
            for (int i = 0; i < Displays.length; i++) {
                if (Displays[i] != null) {
                    ...
                    if (((SwtDisplay) Displays[i].getImpl()).thread == thread)
    ...
    void clearModal(Shell shell) {
        ...
        for (int i = 0; i < shells.length; i++) ((SwtShell) shells[i].getImpl()).updateModal();
    }
    ...
    Image createImage(String name) {
        ...
        return new Image(this.getApi(), imageData);
    }
	...
	*/
        ...
        dispatch = true;
        if (tracker != null) {
            dispatch = ((SwtTracker) tracker.getImpl()).processEvent(event);
        }
        if (dispatch)
    ...
    static long rendererGetPreferredWidthProc(long cell, long handle, long minimun_size, long natural_size) {
        ...
        Widget widget = ((SwtDisplay) display.getImpl()).getWidget(handle);
        if (widget != null)
            return ((SwtWidget) widget.getImpl()).rendererGetPreferredWidthProc(cell, handle, minimun_size, natural_size);
        return 0;
    }
    ...
    static long rendererRenderProc(long cell, long cr, long handle, long background_area, long cell_area, long flags) {
        ...
        Widget widget = ((SwtDisplay) display.getImpl()).getWidget(handle);
        if (widget != null)
            return ((SwtWidget) widget.getImpl()).rendererRenderProc(cell, cr, handle, background_area, cell_area, flags);
        return 0;
    }
    ...
    static long rendererSnapshotProc(long cell, long snapshot, long handle, long background_area, long cell_area, long flags) {
        ...
        Widget widget = ((SwtDisplay) display.getImpl()).getWidget(handle);
        if (widget != null)
            return ((SwtWidget) widget.getImpl()).rendererSnapshotProc(cell, snapshot, handle, background_area, cell_area, flags);
        return 0;
    }
	...
	*/
		 ...
		 */
            if (OS.isWayland() && activeShell != null) {
                ...
                while (tempShell.getParent() != null) {
                    GTK3.gtk_window_get_position(((SwtShell) tempShell.getImpl()).shellHandle, offsetX, offsetY);
                    x[0] += offsetX[0];
                    y[0] += offsetY[0];
    ...
    public Control getFocusControl() {
        ...
        if (activeShell == null)
            return null;
        long shellHandle = ((SwtShell) activeShell.getImpl()).shellHandle;
    ...
    public Color getSystemColor(int id) {
        ...
        return SwtColor.gtk_new(this.getApi(), gdkRGBA);
    }
	...
	*/
    ...
    void initializeSessionManager() {
        ...
        sessionManagerListener = new SessionManagerListener(this.getApi());
    ...
    long mouseHoverProc(long handle) {
        ...
        return ((SwtWidget) widget.getImpl()).hoverProc(handle);
    }
	...
	*/
    ...
    public void release() {
        try (ExceptionStash exceptions = new ExceptionStash()) {
            ...
            disposeList = null;
            ((SwtSynchronizer) synchronizer.getImpl()).releaseSynchronizer();
            synchronizer = null;
    ...
    boolean runAsyncMessages(boolean all) {
        return ((SwtSynchronizer) synchronizer.getImpl()).runAsyncMessages(all);
    }
	...
	*/
        while (eventQueue != null) {
            ...
            if (widget != null && !widget.isDisposed()) {
                ...
                if (item == null || !item.isDisposed()) {
                    run = true;
                    widget.getImpl().sendEvent(event);
                }
            }
            /*
    ...
    boolean runSettings() {
        ...
        for (int i = 0; i < shells.length; i++) {
            ...
            if (!shell.isDisposed()) {
                shell.getImpl().fixStyle();
                ((SwtControl) shell.getImpl()).redraw(true);
    ...
    public void setSynchronizer(Synchronizer synchronizer) {
        ...
        if (oldSynchronizer != null) {
            ((SwtSynchronizer) oldSynchronizer.getImpl()).moveAllEventsTo(synchronizer);
        }
    }
    ...
    void showIMWindow(Control control) {
        ...
        if (control.getImpl() instanceof SwtControl) {
            long imHandle = ((SwtControl) control.getImpl()).imHandle();
        ...
        if (preeditString[0] != 0 && C.strlen(preeditString[0]) > 0) {
            Control widget = control.getImpl().findBackgroundControl();
            if (widget == null)
                widget = control;
            if (control.getImpl() instanceof SwtControl) {
                if (widget.getImpl() instanceof SwtControl) {
                    ((SwtControl) widget.getImpl()).setBackgroundGdkRGBA(preeditWindow, ((SwtControl) control.getImpl()).getBackgroundGdkRGBA());
                }
            }
            if (control.getImpl() instanceof SwtControl) {
                if (widget.getImpl() instanceof SwtControl) {
                    ((SwtControl) widget.getImpl()).setForegroundGdkRGBA(preeditLabel, ((SwtControl) control.getImpl()).getForegroundGdkRGBA());
                }
            }
            if (control.getImpl() instanceof SwtControl) {
                long fontDesc = ((SwtControl) control.getImpl()).getFontDescription();
                ((SwtWidget) widget.getImpl()).setFontDescription(preeditLabel, fontDesc);
	 ...
	 */
        ...
        } while (!result && ((SwtSynchronizer) synchronizer.getImpl()).isMessagesEmpty() && !wake);
        wake = false;
        if (!GTK.GTK4)
            GDK.gdk_threads_enter();
    ...
    long caretProc(long clientData) {
        ...
        if (currentCaret.getImpl().blinkCaret()) {
            ...
            if (blinkRate == 0)
                return 0;
            if (currentCaret.getParent().getImpl() instanceof DartCanvas) {
                /*
		 ...
		 */
                ((DartCanvas) currentCaret.getParent().getImpl()).blink = true;
            }
            if (currentCaret.getParent().getImpl() instanceof SwtCanvas) {
                /*
		 * blink is set to true so that when gtk_draw() is called, we know it is the correct
		 * state to draw/redraw the caret. See Bug 517487.
		 */
                ((SwtCanvas) currentCaret.getParent().getImpl()).blink = true;
            }
            if (GTK.GTK4) {
 ...
 */
    void resetCaretTiming() {
        if (caretId != 0) {
            OS.g_source_remove(caretId);
            if (GTK.GTK4) {
                caretId = OS.g_timeout_add(currentCaret.getImpl()._blinkRate(), caretProc, 0);
            } else {
                caretId = GDK.gdk_threads_add_timeout(currentCaret.getImpl()._blinkRate(), caretProc, 0);
            }
        }
    }
    ...
    long sizeAllocateProc(long handle, long arg0, long user_data) {
        ...
        if (widget == null)
            return 0;
        return ((SwtWidget) widget.getImpl()).sizeAllocateProc(handle, arg0, user_data);
    }
    ...
    long sizeRequestProc(long handle, long arg0, long user_data) {
        ...
        if (widget == null)
            return 0;
        return ((SwtWidget) widget.getImpl()).sizeRequestProc(handle, arg0, user_data);
    }
    ...
    long shellMapProc(long handle, long arg0, long user_data) {
        ...
        if (widget == null)
            return 0;
        return ((SwtWidget) widget.getImpl()).shellMapProc(handle, arg0, user_data);
    }
    ...
    void enterMotionProc(long controller, double x, double y, long user_data) {
        ...
        Widget widget = getWidget(handle);
        if (widget != null)
            ((SwtWidget) widget.getImpl()).enterMotionProc(controller, x, y, user_data);
    }
    ...
    boolean scrollProc(long controller, double dx, double dy, long user_data) {
        ...
        Widget widget = getWidget(handle);
        if (widget != null)
            return ((SwtWidget) widget.getImpl()).scrollProc(controller, dx, dy, user_data);
        return false;
    }
    ...
    void focusProc(long controller, long user_data) {
        ...
        Widget widget = getWidget(handle);
        if (widget != null)
            ((SwtWidget) widget.getImpl()).focusProc(controller, user_data);
    }
    ...
    void windowActiveProc(long handle, long user_data) {
        ...
        Widget widget = getWidget(handle);
        if (widget != null)
            ((SwtWidget) widget.getImpl()).windowActiveProc(handle, user_data);
    }
    ...
    boolean keyPressReleaseProc(long controller, int keyval, int keycode, int state, long user_data) {
        ...
        if (widget == null)
            return false;
        return ((SwtWidget) widget.getImpl()).keyPressReleaseProc(controller, keyval, keycode, state, user_data);
    }
    ...
    void gesturePressReleaseProc(long gesture, int n_press, double x, double y, long user_data) {
        ...
        Widget widget = getWidget(handle);
        if (widget != null)
            ((SwtWidget) widget.getImpl()).gesturePressReleaseProc(gesture, n_press, x, y, user_data);
    }
    ...
    void leaveProc(long controller, long user_data) {
        ...
        Widget widget = getWidget(handle);
        if (widget != null)
            ((SwtWidget) widget.getImpl()).leaveProc(controller, handle, user_data);
    }
    ...
    void activateProc(long action, long parameter, long user_data) {
        ...
        if (widget == null)
            return;
        if (widget.getImpl() instanceof SwtWidget) {
            ((SwtWidget) widget.getImpl()).gtk_activate(user_data);
        }
    }
    ...
    void resizeProc(long handle, int width, int height) {
        Widget widget = getWidget(handle);
        if (widget != null)
            if (widget == null || widget.getImpl() instanceof SwtWidget) {
                ((SwtWidget) widget.getImpl()).gtk_size_allocate(handle, 0);
            }
    }
    ...
    long notifyProc(long object, long param_spec, long user_data) {
        ...
        if (widget == null) {
			 ...
			 * a GdkSurface.
			 */
                return ((SwtWidget) widget.getImpl()).notifyProc(object, param_spec, SwtWidget.NOTIFY_STATE);
            }
        }
        return ((SwtWidget) widget.getImpl()).notifyProc(object, param_spec, user_data);
    }
    ...
    boolean changeValue(long handle, int scroll, double value, long user_data) {
        ...
        if (widget == null)
            return false;
        return ((SwtWidget) widget.getImpl()).gtk_change_value(handle, scroll, value, user_data);
    }
    ...
    long windowProc(long handle, long user_data) {
        ...
        if (widget == null)
            return 0;
        if (widget.getImpl() instanceof SwtWidget) {
            return ((SwtWidget) widget.getImpl()).windowProc(handle, user_data);
        } else
            return 0;
    }
    ...
    long windowProc(long handle, long arg0, long user_data) {
        ...
        if (widget == null)
            return 0;
        if (widget.getImpl() instanceof SwtWidget) {
            return ((SwtWidget) widget.getImpl()).windowProc(handle, arg0, user_data);
        } else
            return 0;
    }
    ...
    long windowProc(long handle, long arg0, long arg1, long user_data) {
        ...
        if (widget == null)
            return 0;
        if (widget.getImpl() instanceof SwtWidget) {
            return ((SwtWidget) widget.getImpl()).windowProc(handle, arg0, arg1, user_data);
        } else
            return 0;
    }
    ...
    long windowProc(long handle, long arg0, long arg1, long arg2, long user_data) {
        ...
        if (widget == null)
            return 0;
        if (widget.getImpl() instanceof SwtWidget) {
            return ((SwtWidget) widget.getImpl()).windowProc(handle, arg0, arg1, arg2, user_data);
        } else
            return 0;
    }
    ...
    long windowProc(long handle, long arg0, long arg1, long arg2, long arg3, long user_data) {
        ...
        if (widget == null)
            return 0;
        if (widget.getImpl() instanceof SwtWidget) {
            return ((SwtWidget) widget.getImpl()).windowProc(handle, arg0, arg1, arg2, arg3, user_data);
        } else
            return 0;
    }
    ...
    long windowTimerProc(long handle) {
        ...
        if (widget == null)
            return 0;
        return ((SwtWidget) widget.getImpl()).timerProc(handle);
    }
