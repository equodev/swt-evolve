...
public class SWTExpandItem extends SWTItem implements IExpandItem {
     ...
     * @see Widget#getStyle
     */
    public SWTExpandItem(SWTExpandBar parent, int style) {
        super(parent, style);
        this.parent = parent;
     ...
     * @see Widget#getStyle
     */
    public SWTExpandItem(SWTExpandBar parent, int style, int index) {
        super(parent, style);
        this.parent = parent;
        createWidget(index);
    }
    ...
    long gtk_activate(long widget) {
        ...
        event.item = Widget.getInstance(this);
    ...
    void resizeControl() {
		...
		*/
            SWTScrollBar vBar = parent.verticalBar;
            if (vBar != null) {
