...
public class SWTTrayItem extends SWTItem implements ITrayItem {
     ...
     * @see Widget#getStyle
     */
    public SWTTrayItem(SWTTray parent, int style) {
        super(parent, style);
        this.parent = parent;
	...
	*/
     ...
     * @since 3.2
     */
    public void setToolTip(IToolTip toolTip_) {
        SWTToolTip toolTip = (SWTToolTip) toolTip_;
        checkWidget();
        SWTToolTip oldTip = this.toolTip, newTip = (SWTToolTip) (toolTip);
        if (oldTip != null)
            oldTip.item = null;
        this.toolTip = newTip;
        if (newTip != null)
