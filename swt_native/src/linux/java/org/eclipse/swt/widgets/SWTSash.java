...
public class SWTSash extends SWTControl implements ISash {
     ...
     * @see Widget#getStyle
     */
    public SWTSash(SWTComposite parent, int style) {
    ...
    void gtk_gesture_press_event(long gesture, int n_press, double x, double y, long event) {
        ...
        if ((parent.style & SWT.MIRRORED) != 0)
            jEvent.x = DPIUtil.autoScaleDown(parent.getClientWidth() - width) - jEvent.x;
    ...
    long gtk_key_press_event(long widget, long eventPtr) {
        ...
        switch(key[0]) {
            ...
            case GDK.GDK_Down:
                ...
                if ((parent.style & SWT.MIRRORED) != 0)
                    event.x = DPIUtil.autoScaleDown(parent.getClientWidth() - width) - event.x;
