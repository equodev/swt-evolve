 ...
 */
    ...
    public boolean setTabGroupFocus(boolean next) {
        System.out.println("+++ CONVERTING DynComposite from Widget#setTabGroupFocus(boolean) #" + getApi().hashCode());
        IWidget newImpl = (IWidget) convert();
        return newImpl.setTabGroupFocus(next);
    }

    public boolean setTabItemFocus(boolean next) {
        System.out.println("+++ CONVERTING DynComposite from Widget#setTabItemFocus(boolean) #" + getApi().hashCode());
        IWidget newImpl = (IWidget) convert();
    ...
    public long topHandle() {
        System.out.println("+++ CONVERTING DynComposite from Widget#topHandle() #" + getApi().hashCode());
        IWidget newImpl = (IWidget) convert();
