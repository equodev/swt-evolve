...
public class SwtList extends SwtScrollable implements IList {
	...
	*/
    ...
    int getItemHeightInPixels() {
        ...
        int[] h = new int[1];
        long layout = GTK.gtk_widget_create_pango_layout(getApi().handle, Converter.wcsToMbcs(" ", true));
	...
	*/
	 ...
	 */
        ...
        GTK.gtk_tree_view_get_visible_rect(getApi().handle, visibleRect);
        GdkRectangle cellRect = new GdkRectangle();
        GTK.gtk_tree_view_get_cell_area(getApi().handle, path, 0, cellRect);
        int[] tx = new int[1], ty = new int[1];
        GTK.gtk_tree_view_convert_bin_window_to_tree_coords(getApi().handle, cellRect.x, cellRect.y, tx, ty);
        if (ty[0] < visibleRect.y) {
            GTK.gtk_tree_view_scroll_to_point(getApi().handle, -1, ty[0]);
        } else {
