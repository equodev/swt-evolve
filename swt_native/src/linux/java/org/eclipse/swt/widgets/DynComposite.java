 ...
 */
public class DynComposite extends DynScrollable implements IComposite {

    DynComposite(Composite api) {
        super(api);
        /* Do nothing */
    }
     ...
     * @see Widget#getStyle
     */
    public DynComposite(Composite parent, int style, Composite api) {
    ...
    public Control[] _getChildren() {
        System.out.println("+++ CONVERTING DynComposite from Composite#_getChildren() #" + getApi().hashCode());
        IComposite newImpl = convert();
        return newImpl._getChildren();
    }

    public Control[] _getTabList() {
        System.out.println("+++ CONVERTING DynComposite from Composite#_getTabList() #" + getApi().hashCode());
        IComposite newImpl = convert();
        return newImpl._getTabList();
    }
    ...
    public void changed(Control[] changed) {
        System.out.println("+++ CONVERTING DynComposite from Composite#changed(Control[]) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.changed(changed);
    }
    ...
    public Widget[] computeTabList() {
        System.out.println("+++ CONVERTING DynComposite from Composite#computeTabList() #" + getApi().hashCode());
        IComposite newImpl = convert();
    ...
    public void drawBackground(GC gc, int x, int y, int width, int height, int offsetX, int offsetY) {
        System.out.println("+++ CONVERTING DynComposite from Composite#drawBackground(GC, int, int, int, int, int, int) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.drawBackground(gc, x, y, width, height, offsetX, offsetY);
    }

    public Composite findDeferredControl() {
        System.out.println("+++ CONVERTING DynComposite from Composite#findDeferredControl() #" + getApi().hashCode());
        IComposite newImpl = convert();
        return newImpl.findDeferredControl();
    }

    @Override
    public Menu[] findMenus(Control control) {
        System.out.println("+++ CONVERTING DynComposite from Composite#findMenus(Control) #" + getApi().hashCode());
        IComposite newImpl = convert();
    ...
    public void fixChildren(Shell newShell, Shell oldShell, Decorations newDecorations, Decorations oldDecorations, Menu[] menus) {
        System.out.println("+++ CONVERTING DynComposite from Composite#fixChildren(Shell, Shell, Decorations, Decorations, Menu[]) #" + getApi().hashCode());
        IComposite newImpl = convert();
    ...
    public void fixStyle() {
        System.out.println("+++ CONVERTING DynComposite from Composite#fixStyle() #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.fixStyle();
    }

    public void fixZOrder() {
        System.out.println("+++ CONVERTING DynComposite from Composite#fixZOrder() #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.fixZOrder();
    }
    ...
    public int getBackgroundMode() {
        if (Config.isDebug())
            System.out.println("++ Called Composite#getBackgroundMode() on DynComposite" + " #" + getApi().hashCode());
    ...
    public Control[] getChildren() {
        if (Config.isDebug())
            System.out.println("++ Called Composite#getChildren() on DynComposite" + " #" + getApi().hashCode());
    ...
    public Layout getLayout() {
        if (Config.isDebug())
            System.out.println("++ Called Composite#getLayout() on DynComposite" + " #" + getApi().hashCode());
        return this.layout;
    }
    ...
    public boolean getLayoutDeferred() {
        if (Config.isDebug())
            System.out.println("++ Called Composite#getLayoutDeferred() on DynComposite" + " #" + getApi().hashCode());
    ...
    public Control[] getTabList() {
        if (Config.isDebug())
            System.out.println("++ Called Composite#getTabList() on DynComposite" + " #" + getApi().hashCode());
        return this.tabList;
    }
    ...
    public boolean isLayoutDeferred() {
        System.out.println("+++ CONVERTING DynComposite from Composite#isLayoutDeferred() #" + getApi().hashCode());
        IComposite newImpl = convert();
        return newImpl.isLayoutDeferred();
    }

    @Override
    public boolean isTabGroup() {
        System.out.println("+++ CONVERTING DynComposite from Composite#isTabGroup() #" + getApi().hashCode());
        IComposite newImpl = convert();
     ...
     */
    public void layout() {
        System.out.println("+++ CONVERTING DynComposite from Composite#layout() #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.layout();
    }
    ...
    public void layout(boolean changed) {
        System.out.println("+++ CONVERTING DynComposite from Composite#layout(boolean) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.layout(changed);
    }
    ...
    public void layout(boolean changed, boolean all) {
        System.out.println("+++ CONVERTING DynComposite from Composite#layout(boolean, boolean) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.layout(changed, all);
    }
    ...
    public void layout(Control[] changed) {
        System.out.println("+++ CONVERTING DynComposite from Composite#layout(Control[]) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.layout(changed);
    }
    ...
    public void layout(Control[] changed, int flags) {
        System.out.println("+++ CONVERTING DynComposite from Composite#layout(Control[], int) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.layout(changed, flags);
    }

    @Override
    public void markLayout(boolean changed, boolean all) {
        System.out.println("+++ CONVERTING DynComposite from Composite#markLayout(boolean, boolean) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.markLayout(changed, all);
    }

    public void moveAbove(long child, long sibling) {
        System.out.println("+++ CONVERTING DynComposite from Composite#moveAbove(long, long) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.moveAbove(child, sibling);
    }

    public void moveBelow(long child, long sibling) {
        System.out.println("+++ CONVERTING DynComposite from Composite#moveBelow(long, long) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.moveBelow(child, sibling);
    }

    public long parentingHandle() {
        System.out.println("+++ CONVERTING DynComposite from Composite#parentingHandle() #" + getApi().hashCode());
        IComposite newImpl = convert();
        return newImpl.parentingHandle();
    }

    public void removeControl(Control control) {
        System.out.println("+++ CONVERTING DynComposite from Composite#removeControl(Control) #" + getApi().hashCode());
        IComposite newImpl = convert();
        newImpl.removeControl(control);
    }
    ...
    public void setBackgroundMode(int mode) {
        if (Config.isDebug())
            System.out.println("++ Called Composite#setBackgroundMode(int) on DynComposite" + " #" + getApi().hashCode());
    ...
    public void setLayout(Layout layout) {
        if (Config.isDebug())
            System.out.println("++ Called Composite#setLayout(Layout) on DynComposite" + " #" + getApi().hashCode());
        layoutSet = true;
        this.layout = layout;
    }
    ...
    public void setLayoutDeferred(boolean defer) {
        if (Config.isDebug())
            System.out.println("++ Called Composite#setLayoutDeferred(boolean) on DynComposite" + " #" + getApi().hashCode());
        layoutDeferredSet = true;
        this.layoutDeferred = defer;
    }

    @Override
    public boolean setTabGroupFocus(boolean next) {
        System.out.println("+++ CONVERTING DynComposite from Composite#setTabGroupFocus(boolean) #" + getApi().hashCode());
        IComposite newImpl = convert();
        return newImpl.setTabGroupFocus(next);
    }

    @Override
    public boolean setTabItemFocus(boolean next) {
        System.out.println("+++ CONVERTING DynComposite from Composite#setTabItemFocus(boolean) #" + getApi().hashCode());
        IComposite newImpl = convert();
    ...
    public void setTabList(Control[] tabList) {
        if (Config.isDebug())
            System.out.println("++ Called Composite#setTabList(Control[]) on DynComposite" + " #" + getApi().hashCode());
        tabListSet = true;
    ...
    public boolean translateMnemonic(Event event, Control control) {
        System.out.println("+++ CONVERTING DynComposite from Composite#translateMnemonic(Event, Control) #" + getApi().hashCode());
        IComposite newImpl = convert();
    ...
    public void updateBackgroundMode() {
        System.out.println("+++ CONVERTING DynComposite from Composite#updateBackgroundMode() #" + getApi().hashCode());
        IComposite newImpl = convert();
    ...
    public void updateLayout(boolean all) {
        System.out.println("+++ CONVERTING DynComposite from Composite#updateLayout(boolean) #" + getApi().hashCode());
        IComposite newImpl = convert();
    ...
    protected IComposite convert(IComposite newImpl) {
        super.convert(newImpl);
        if (backgroundModeSet)
            newImpl.setBackgroundMode(getBackgroundMode());
        //newImpl.children = getChildren();
        ;
        if (layoutSet)
            newImpl.setLayout(getLayout());
        if (layoutDeferredSet)
            newImpl.setLayoutDeferred(getLayoutDeferred());
        if (tabListSet)
            newImpl.setTabList(getTabList());
        return newImpl;
    }
}
