...
public class SwtTabItem extends SwtItem implements ITabItem {
    ...
    public void release(boolean destroy) {
        ...
        if (control != null && !control.isDisposed()) {
            SwtControl.gtk_widget_reparent(control, parent.getImpl().parentingHandle());
        }
    ...
    public void setControl(Control control) {
        ...
        if (GTK.GTK4) {
            ...
            if (control != null) {
                ...
                SwtControl.gtk_widget_reparent(control, pageHandle);
            }
            ...
            if (newControl != null) {
                ((SwtControl) newControl.getImpl()).setBoundsInPixels(((SwtTabFolder) parent.getImpl()).getClientAreaInPixels());
                newControl.setVisible(true);
            }
            if ((oldControl != null) && (oldControl != newControl)) {
                SwtControl.gtk_widget_reparent(oldControl, parent.getImpl().parentingHandle());
                if (newControl != null) {
    ...
    void setForegroundGdkRGBA(long handle, GdkRGBA rgba) {
        ...
        ((SwtControl) parent.getImpl()).cssForeground = css;
    ...
    public void setImage(Image image) {
        ...
        if (image != null) {
            ImageList imageList = ((SwtTabFolder) parent.getImpl()).imageList;
            if (imageList == null)
                imageList = ((SwtTabFolder) parent.getImpl()).imageList = new ImageList();
