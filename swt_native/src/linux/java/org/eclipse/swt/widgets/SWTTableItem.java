...
public class SWTTableItem extends SWTItem implements ITableItem {
     ...
     * @see Widget#getStyle
     */
    public SWTTableItem(SWTTable parent, int style, int index) {
     ...
     * @see Widget#getStyle
     */
    public SWTTableItem(SWTTable parent, int style) {
        this(parent, style, checkNull(parent).getItemCount(), true);
    }

    SWTTableItem(SWTTable parent, int style, int index, boolean create) {
        super(parent, style);
        this.parent = parent;
        if (create) {
    ...
    static SWTTable checkNull(SWTTable control) {
        if (control == null)
    ...
    Color _getBackground() {
        long[] ptr = new long[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTable.BACKGROUND_COLUMN, ptr, -1);
        if (ptr[0] == 0)
    ...
    Color _getBackground(int index) {
        ...
        long[] ptr = new long[1];
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTable.CELL_BACKGROUND, ptr, -1);
        if (ptr[0] == 0)
            return _getBackground();
        GdkRGBA gdkRGBA = new GdkRGBA();
        OS.memmove(gdkRGBA, ptr[0], GdkRGBA.sizeof);
    ...
    boolean _getChecked() {
        int[] ptr = new int[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTable.CHECKED_COLUMN, ptr, -1);
        return ptr[0] != 0;
    }

    Color _getForeground() {
        long[] ptr = new long[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTable.FOREGROUND_COLUMN, ptr, -1);
        if (ptr[0] == 0)
    ...
    Color _getForeground(int index) {
        ...
        long[] ptr = new long[1];
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTable.CELL_FOREGROUND, ptr, -1);
        if (ptr[0] == 0)
            return _getForeground();
        GdkRGBA gdkRGBA = new GdkRGBA();
        OS.memmove(gdkRGBA, ptr[0], GdkRGBA.sizeof);
    ...
    Image _getImage(int index) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTable.CELL_SURFACE, surfaceHandle, -1);
    ...
    String _getText(int index) {
        ...
        long[] ptr = new long[1];
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_tree_model_get(parent.modelHandle, handle, modelIndex + SWTTable.CELL_TEXT, ptr, -1);
        if (ptr[0] == 0)
            return "";
    ...
    public void dispose() {
        ...
        SWTTable tmpParent = (SWTTable) (null);
    ...
    public void setBackground(Color color) {
        ...
        GTK.gtk_list_store_set(parent.modelHandle, handle, SWTTable.BACKGROUND_COLUMN, gdkRGBA, -1);
        cached = true;
    }
    ...
    public void setBackground(int index, Color color) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GdkRGBA gdkRGBA = color != null ? color.handle : null;
        GTK.gtk_list_store_set(parent.modelHandle, handle, modelIndex + SWTTable.CELL_BACKGROUND, gdkRGBA, -1);
        cached = true;
        if (color != null) {
    ...
    public void setChecked(boolean checked) {
        ...
        if (_getChecked() == checked)
            return;
        GTK.gtk_list_store_set(parent.modelHandle, handle, SWTTable.CHECKED_COLUMN, checked, -1);
        /*
	...
	*/
        GTK.gtk_list_store_set(parent.modelHandle, handle, SWTTable.GRAYED_COLUMN, !checked ? false : grayed, -1);
        cached = true;
    }
    ...
    public void setFont(Font font) {
        ...
        GTK.gtk_list_store_set(parent.modelHandle, handle, SWTTable.FONT_COLUMN, fontHandle, -1);
        cached = true;
    }
    ...
    public void setFont(int index, Font font) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        long fontHandle = font != null ? font.handle : 0;
        GTK.gtk_list_store_set(parent.modelHandle, handle, modelIndex + SWTTable.CELL_FONT, fontHandle, -1);
        cached = true;
        if (font != null) {
            boolean customDraw = (parent.columnCount == 0) ? parent.firstCustomDraw : parent.columns[index].customDraw;
            if (!customDraw) {
    ...
    public void setForeground(Color color) {
        ...
        if (_getForeground().equals(color))
            return;
        GdkRGBA gdkRGBA = color != null ? color.handle : null;
        GTK.gtk_list_store_set(parent.modelHandle, handle, SWTTable.FOREGROUND_COLUMN, gdkRGBA, -1);
        cached = true;
    }
    ...
    public void setForeground(int index, Color color) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GdkRGBA gdkRGBA = color != null ? color.handle : null;
        GTK.gtk_list_store_set(parent.modelHandle, handle, modelIndex + SWTTable.CELL_FOREGROUND, gdkRGBA, -1);
        cached = true;
        if (color != null) {
            boolean customDraw = (parent.columnCount == 0) ? parent.firstCustomDraw : parent.columns[index].customDraw;
            if (!customDraw) {
	...
	*/
        int[] ptr = new int[1];
        GTK.gtk_tree_model_get(parent.modelHandle, handle, SWTTable.CHECKED_COLUMN, ptr, -1);
        GTK.gtk_list_store_set(parent.modelHandle, handle, SWTTable.GRAYED_COLUMN, ptr[0] == 0 ? false : grayed, -1);
        cached = true;
    }
    ...
    public void setImage(int index, Image image) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_list_store_set(parent.modelHandle, handle, modelIndex + SWTTable.CELL_PIXBUF, pixbuf, -1);
        /*
	 ...
	 */
        ...
        GTK.gtk_list_store_set(parent.modelHandle, handle, modelIndex + SWTTable.CELL_SURFACE, surface, -1);
        cached = true;
        /*
    ...
    public void setText(int index, String string) {
        ...
        int modelIndex = parent.columnCount == 0 ? SWTTable.FIRST_COLUMN : parent.columns[index].modelIndex;
        GTK.gtk_list_store_set(parent.modelHandle, handle, modelIndex + SWTTable.CELL_TEXT, buffer, -1);
        cached = true;
        /*
	 * Bug 465056: single column Tables have a very small initial width.
	 * Fix: when text or an image is set for a Table, compute its
