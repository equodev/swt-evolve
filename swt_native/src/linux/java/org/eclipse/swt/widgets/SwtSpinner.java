 ...
 */
public class SwtSpinner extends SwtComposite implements ISpinner {
	...
	*/
    ...
    Point computeSizeInPixels(int wHint, int hHint, boolean changed) {
        ...
        if (hHint != SWT.DEFAULT && hHint < 0)
            hHint = 0;
        if (GTK.GTK4) {
            GTK.gtk_widget_set_size_request(getApi().handle, wHint, hHint);
            ...
            long hAdjustment = GTK.gtk_spin_button_get_adjustment(getApi().handle);
            double upper = GTK.gtk_adjustment_get_upper(hAdjustment);
            int digits = GTK.gtk_spin_button_get_digits(getApi().handle);
    ...
    void createHandle(int index) {
        ...
        if (adjustment == 0)
            error(SWT.ERROR_NO_HANDLES);
        getApi().handle = GTK.gtk_spin_button_new(adjustment, climbRate, 0);
        if (getApi().handle == 0)
            error(SWT.ERROR_NO_HANDLES);
        ...
        if (GTK.GTK4) {
            ...
            entryHandle = GTK4.gtk_widget_get_first_child(getApi().handle);
        } else {
	...
	*/
    ...
    public String getText() {
        ...
        if (GTK.GTK4) {
            ...
            stringPtr = GTK3.gtk_entry_get_text(getApi().handle);
        }
        if (stringPtr == 0)
            return "";
    ...
    public int getDigits() {
        checkWidget();
        return GTK.gtk_spin_button_get_digits(getApi().handle);
    }
        ...
        if (length > 0) {
            ...
            if ((endptr[0] == stringPtr + length) && valueLength == length) {
                ...
                if (value != adjustment.value && adjustment.lower <= value && value <= adjustment.upper) {
                    GTK.gtk_spin_button_update(getApi().handle);
                }
            }
        }
        /*
	...
	*/
    ...
    long gtk_commit(long imContext, long text) {
        if (text == 0)
            return 0;
        if (!GTK.gtk_editable_get_editable(GTK.GTK4 ? entryHandle : getApi().handle))
            return 0;
	...
	*/
        ...
        if (fixStart != -1 && fixEnd != -1) {
            GTK.gtk_editable_set_position(GTK.GTK4 ? entryHandle : getApi().handle, fixStart);
            GTK.gtk_editable_select_region(GTK.GTK4 ? entryHandle : getApi().handle, fixStart, fixEnd);
        }
        fixStart = fixEnd = -1;
        return 0;
    }
    ...
    long gtk_delete_text(long widget, long start_pos, long end_pos) {
        if (!hooks(SWT.Verify) && !filters(SWT.Verify))
            return 0;
        long ptr = GTK3.gtk_entry_get_text(GTK.GTK4 ? entryHandle : getApi().handle);
        if (end_pos == -1)
        ...
        if (newText == null) {
            ...
            if (newText.length() > 0) {
                ...
                GTK.gtk_editable_insert_text(GTK.GTK4 ? entryHandle : getApi().handle, buffer, buffer.length, pos);
                ...
                GTK.gtk_editable_set_position(GTK.GTK4 ? entryHandle : getApi().handle, pos[0]);
            }
        }
        return 0;
    }
    ...
    long gtk_insert_text(long widget, long new_text, long new_text_length, long position) {
        ...
        if (newText != oldText) {
            ...
            GTK.gtk_editable_get_selection_bounds(GTK.GTK4 ? entryHandle : getApi().handle, newStart, newEnd);
            if (newText != null) {
                if (newStart[0] != newEnd[0]) {
                    OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, DELETE_TEXT);
                    OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, CHANGED);
                    GTK.gtk_editable_delete_selection(GTK.GTK4 ? entryHandle : getApi().handle);
                ...
                OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, INSERT_TEXT);
                GTK.gtk_editable_insert_text(GTK.GTK4 ? entryHandle : getApi().handle, buffer3, buffer3.length, pos);
                OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, INSERT_TEXT);
    ...
    void hookEvents() {
        ...
        OS.g_signal_connect_closure(getApi().handle, OS.value_changed, ((SwtDisplay) display.getImpl()).getClosure(VALUE_CHANGED), false);
        if (GTK.GTK4) {
            /* GtkText signals */
            long textHandle = GTK4.gtk_widget_get_first_child(getApi().handle);
            OS.g_signal_connect_closure(textHandle, OS.activate, ((SwtDisplay) display.getImpl()).getClosure(ACTIVATE), false);
        } else {
            /* GtkEntry signals */
    ...
    public void paste() {
        checkWidget();
        GTK3.gtk_editable_paste_clipboard(GTK.GTK4 ? entryHandle : getApi().handle);
    }
    ...
    void setBackgroundGdkRGBA(long context, long handle, GdkRGBA rgba) {
        ...
        if (GTK.GTK4) {
            ...
            String color = ((SwtDisplay) display.getImpl()).gtk_rgba_to_css_string(background);
    ...
    public void setIncrement(int value) {
        ...
        OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
        GTK.gtk_spin_button_set_increments(getApi().handle, newValue, page_increment);
        OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
    }
    ...
    public void setMaximum(int value) {
        ...
        if (newValue < lower)
            return;
        OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
        GTK.gtk_spin_button_set_range(getApi().handle, lower, newValue);
        OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
    }
    ...
    public void setMinimum(int value) {
        ...
        if (newValue > upper)
            return;
        OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
        GTK.gtk_spin_button_set_range(getApi().handle, newValue, upper);
        OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
    }
    ...
    public void setPageIncrement(int value) {
        ...
        for (int i = 0; i < digits; i++) newValue /= 10;
        OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
        GTK.gtk_spin_button_set_increments(getApi().handle, step_increment, newValue);
        OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
    }
    ...
    public void setSelection(int value) {
        ...
        for (int i = 0; i < digits; i++) newValue /= 10;
        OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
        GTK.gtk_spin_button_set_value(getApi().handle, newValue);
        OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
    }
    ...
    public void setDigits(int value) {
        ...
        OS.g_signal_handlers_block_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
        GTK.gtk_spin_button_configure(getApi().handle, hAdjustment, climbRate, value);
        OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
    }
	...
	*/
        ...
        long adjustment = GTK.gtk_spin_button_get_adjustment(getApi().handle);
        GTK.gtk_spin_button_configure(getApi().handle, adjustment, climbRate, digits);
        GTK.gtk_spin_button_set_range(getApi().handle, minimum / factor, maximum / factor);
        GTK.gtk_spin_button_set_increments(getApi().handle, increment / factor, pageIncrement / factor);
        GTK.gtk_spin_button_set_value(getApi().handle, selection / factor);
        OS.g_signal_handlers_unblock_matched(getApi().handle, OS.G_SIGNAL_MATCH_DATA, 0, 0, 0, 0, VALUE_CHANGED);
    }
    ...
    String verifyText(String string, int start, int end) {
        ...
        int index = 0;
        if (GTK.gtk_spin_button_get_digits(getApi().handle) > 0) {
