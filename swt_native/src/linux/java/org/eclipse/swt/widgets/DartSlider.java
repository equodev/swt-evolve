 ...
 */
public class DartSlider extends DartControl implements ISlider {
     ...
     * @see Widget#getStyle
     */
    public DartSlider(Composite parent, int style, Slider api) {
    ...
    public VSlider getValue() {
        if (value == null)
            value = new VSlider(this);
