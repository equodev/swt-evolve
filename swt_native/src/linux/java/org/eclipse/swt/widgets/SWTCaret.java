...
public class SWTCaret extends SWTWidget implements ICaret {
     ...
     * @see Widget#getStyle
     */
    public SWTCaret(SWTCanvas parent, int style) {
        super(parent, style);
        this.parent = parent;
        createWidget(0);
        SWTComposite p = ((SWTComposite) (parent.getParent()));
        while (p != null) {
            if (p instanceof SWTTree || p instanceof SWTTable) {
                embeddedInto = p;
                break;
            }
            p = ((SWTComposite) (p.getParent()));
        }
    }
    ...
    void createWidget(int index) {
        ...
        isVisible = true;
        if (((SWTCaret) (parent.getCaret())) == null) {
    ...
    public void setVisible(boolean visible) {
        checkWidget();
        SWTCanvas canvas = (SWTCanvas) (getParent());
        canvas.blink = true;
