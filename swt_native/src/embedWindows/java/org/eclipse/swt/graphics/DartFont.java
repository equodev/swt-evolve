...
public final class DartFont extends DartResource implements IFont {
    ...
    public boolean equals(Object object) {
        if (object != null && ((Font) object).getImpl() instanceof SwtFont)
            return java.util.Arrays.equals(this.getApi().getFontData(), ((SwtFont) ((Font) object).getImpl()).getApi().getFontData());
        if (object == this.getApi())
            return true;
        if (!(object instanceof Font))
            return false;
        return java.util.Arrays.equals(this._fontData, ((Font) object).getFontData());
    }
    ...
    public int hashCode() {
        if (fontData == null)
            return 0;
        return Objects.hash(fontData.getName(), fontData.getHeight(), fontData.getStyle());
    }
    ...
    public String toString() {
        ...
        return "Font {" + fd.getName() + ", " + (int) fd.getHeight() + ", " + fd.getStyle() + "}";
    }
