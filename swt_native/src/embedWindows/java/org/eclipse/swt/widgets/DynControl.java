...
public abstract class DynControl extends DynWidget implements Drawable, IControl {
    ...
    public long findBrush(long value, int lbStyle) {
        System.out.println("+++ CONVERTING DynComposite from Control#findBrush(long, int) #" + getApi().hashCode());
        IControl newImpl = (IControl) convert();
        return newImpl.findBrush(value, lbStyle);
    }
    ...
    public Control findThemeControl() {
        System.out.println("+++ CONVERTING DynComposite from Control#findThemeControl() #" + getApi().hashCode());
        IControl newImpl = (IControl) convert();
        return newImpl.findThemeControl();
    }
	...
	*/
    ...
    public int getBackgroundPixel() {
        System.out.println("+++ CONVERTING DynComposite from Control#getBackgroundPixel() #" + getApi().hashCode());
        IControl newImpl = (IControl) convert();
        return newImpl.getBackgroundPixel();
    }
    ...
    public void setCursor() {
        System.out.println("+++ CONVERTING DynComposite from Control#setCursor() #" + getApi().hashCode());
        IControl newImpl = (IControl) convert();
        newImpl.setCursor();
    }
    ...
    public boolean setRadioFocus(boolean tabbing) {
        System.out.println("+++ CONVERTING DynComposite from Control#setRadioFocus(boolean) #" + getApi().hashCode());
        IControl newImpl = (IControl) convert();
        return newImpl.setRadioFocus(tabbing);
    }
    ...
    public void updateLayout(boolean resize, boolean all) {
        System.out.println("+++ CONVERTING DynComposite from Control#updateLayout(boolean, boolean) #" + getApi().hashCode());
        IControl newImpl = (IControl) convert();
