...
public class VTableItem extends VItem {
    ...
    public Color getBackground() {
        return ((DartTableItem) impl).getBackground();
    }

    public void setBackground(Color value) {
        ((DartTableItem) impl).setBackground(value);
    }
    ...
    public Color getForeground() {
        return ((DartTableItem) impl).getForeground();
    }

    public void setForeground(Color value) {
        ((DartTableItem) impl).setForeground(value);
    }
    ...
    public static class TableItemJson implements Configuration {
        ...
        public static TableItem read(JsonReader<?> reader) throws IOException {
            return null;
        }
