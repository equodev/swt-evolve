...
public class OsVersion extends Platform {
    ...
    // "Windows 10 August 2016 Update"
    public static final boolean IS_WIN10_1607 = WIN32_BUILD >= WIN10_1607;

    // "Windows 10 October 2018 Update"
    public static final boolean IS_WIN10_1809 = WIN32_BUILD >= 17763;

    // "Windows 10 May 2020 Update"
    public static final boolean IS_WIN10_2004 = WIN32_BUILD >= 19041;

    // Initial Windows 11 release
    public static final boolean IS_WIN11_21H2 = WIN32_BUILD >= 22000;
    ...
    public static void checkCompatibleWindowsVersion() {
        ...
        if (!versionCheckDisabled && WIN32_BUILD < MINIMUM_COMPATIBLE_BUILD) {
            System.err.println(String.format("Incompatible OS: Minimum Windows build version is %s but current is %s", MINIMUM_COMPATIBLE_BUILD, WIN32_BUILD));
            System.exit(1);
        }
    }
