...
public class SwtPrintDialog extends SwtDialog implements IPrintDialog {
	...
	*/
        ...
        if (dialogOrientation != parentOrientation) {
            ...
            hwndOwner = OS.CreateWindowEx(exStyle, DialogClass, null, 0, OS.CW_USEDEFAULT, 0, OS.CW_USEDEFAULT, 0, hwndParent, 0, OS.GetModuleHandle(null), null);
        ...
        if (printerData.name != null) {
            ...
            for (PrinterData element : SwtPrinter.getPrinterList()) {
            ...
            if (success) {
                ...
                // offset 1 points to wDeviceOffset
