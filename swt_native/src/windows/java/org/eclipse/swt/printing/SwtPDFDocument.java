 ...
 */
public final class SwtPDFDocument extends SwtDevice implements IPDFDocument {
    ...
    private static PaperSize findBestPaperSize(double widthInPoints, double heightInPoints) {
        ...
        // 1 inch = 72 points
        int[][] standardSizes = { // 8.5 x 11 inches
        { OS.DMPAPER_LETTER, 612, 792 }, // 8.5 x 14 inches
        { OS.DMPAPER_LEGAL, 612, 1008 }, // 8.27 x 11.69 inches (210 x 297 mm)
        { OS.DMPAPER_A4, 595, 842 }, // 11 x 17 inches
        { OS.DMPAPER_TABLOID, 792, 1224 }, // 11.69 x 16.54 inches (297 x 420 mm)
        { OS.DMPAPER_A3, 842, 1191 }, // 7.25 x 10.5 inches
        { OS.DMPAPER_EXECUTIVE, 522, 756 }, // 5.83 x 8.27 inches (148 x 210 mm)
        { OS.DMPAPER_A5, 420, 595 } };
     ...
     * @see #getBounds()
     */
    public SwtPDFDocument(String filename, PageSize pageSize, PDFDocument api) {
        super(checkData(filename, pageSize), api);
    }
     ...
     * @see #getBounds()
     */
    public SwtPDFDocument(String filename, double widthInPoints, double heightInPoints, PDFDocument api) {
        this(filename, new PageSize(widthInPoints, heightInPoints), api);
    }
    ...
    public PDFDocument getApi() {
        if (api == null)
            api = PDFDocument.createApi(this);
        return (PDFDocument) api;
    }
}
