 ...
 */
public class DartCLabel extends DartCanvas implements ICLabel {
     ...
     * @see #getStyle()
     */
    public DartCLabel(Composite parent, int style, CLabel api) {
 ...
 */
    ...
    private void initAccessible() {
        ...
        accessible.addAccessibleListener(new AccessibleAdapter() {
            ...
            public void getKeyboardShortcut(AccessibleEvent e) {
                char mnemonic = _findMnemonic(DartCLabel.this.text);
                if (mnemonic != '\0') {
                    //$NON-NLS-1$
    ...
    public CLabel getApi() {
        if (api == null)
            api = CLabel.createApi(this);
        return (CLabel) api;
    }

    public VCLabel getValue() {
        if (value == null)
            value = new VCLabel(this);
        return (VCLabel) value;
    }
}
