 ...
 * @since 2.0
 */
public class SwtAccessible implements IIAccessible {
    ...
    COMObject objIAccessible, objIEnumVARIANT, objIServiceProvider, objIAccessibleApplication, /*objIAccessibleComponent,*/
    objIAccessibleEditableText, objIAccessibleHyperlink, objIAccessibleHypertext, /*objIAccessibleImage,*/
    objIAccessibleTable2, objIAccessibleTableCell, objIAccessibleValue;

    /* objIAccessibleRelation is defined in Relation class */
    ...
    SwtAccessible(Accessible parent, long iaccessible_address, Accessible api) {
        this(parent, api);
    ...
    void createIAccessible() {
        objIAccessible = new COMObject(new int[] { 2, 0, 0, /*IA>>*/
        1, 3, 5, 8, 1, 1, 2, 2, 2, 2, 2, 2, 2, 3, 2, 1, 1, 2, 2, 5, 3, 3, 1, 2, 2, /*<<IA*/
        1, 2, 3, 1, 1, 3, 3, 1, 1, 1, 1, 3, 3, 1, 1, 1, 1, 1 }) {
    ...
    void createIAccessibleHyperlink() {
        objIAccessibleHyperlink = new COMObject(new int[] { 2, 0, 0, /*IAA>>*/
        1, 1, 2, 4, 2, 2, /*<<IAA*/
        2, 2, 1, 1, 1 }) {
    ...
    void createIAccessibleHypertext() {
        objIAccessibleHypertext = new COMObject(new int[] { 2, 0, 0, /*IAT>>*/
        2, 4, 1, 6, 1, 4, 3, 3, 5, 5, 5, 1, 1, 3, 1, 3, 5, 1, 1, /*<<IAT*/
        1, 2, 2 }) {
            ...
            @Override
            public long method19(long[] args) {
                return scrollSubstringToPoint((int) args[0], (int) args[1], (int) args[2], (int) args[3], (int) args[4]);
            }
    ...
    public void sendEvent(int event, Object eventData) {
        ...
        switch(event) {
            ...
            case ACC.EVENT_DOCUMENT_LOAD_COMPLETE:
                OS.NotifyWinEvent(COM.IA2_EVENT_DOCUMENT_LOAD_COMPLETE, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            ...
            case ACC.EVENT_HYPERLINK_START_INDEX_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_HYPERLINK_START_INDEX_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            case ACC.EVENT_HYPERLINK_END_INDEX_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_HYPERLINK_END_INDEX_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            case ACC.EVENT_HYPERLINK_ANCHOR_COUNT_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_HYPERLINK_ANCHOR_COUNT_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            case ACC.EVENT_HYPERLINK_SELECTED_LINK_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_HYPERLINK_SELECTED_LINK_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            ...
            case ACC.EVENT_HYPERTEXT_LINK_COUNT_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_HYPERTEXT_LINK_COUNT_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            ...
            case ACC.EVENT_TABLE_COLUMN_DESCRIPTION_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_TABLE_COLUMN_DESCRIPTION_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            case ACC.EVENT_TABLE_COLUMN_HEADER_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_TABLE_COLUMN_HEADER_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            case ACC.EVENT_TABLE_ROW_DESCRIPTION_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_TABLE_ROW_DESCRIPTION_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            case ACC.EVENT_TABLE_ROW_HEADER_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_TABLE_ROW_HEADER_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
            ...
            case ACC.EVENT_TEXT_ATTRIBUTE_CHANGED:
                OS.NotifyWinEvent(COM.IA2_EVENT_TEXT_ATTRIBUTE_CHANGED, control.handle, OS.OBJID_CLIENT, eventChildID());
                break;
    ...
    int QueryInterface(long iid, long ppvObject) {
        ...
        if (COM.IsEqualGUID(guid, COM.IIDIUnknown) || COM.IsEqualGUID(guid, COM.IIDIDispatch) || COM.IsEqualGUID(guid, COM.IIDIAccessible)) {
            ...
            AddRef();
            if (DEBUG)
                print(this.getApi() + ".QueryInterface guid=" + guidString(guid) + " returning " + objIAccessible.getAddress() + hresult(COM.S_OK));
            return COM.S_OK;
        }
        ...
        if (COM.IsEqualGUID(guid, COM.IIDIServiceProvider)) {
            ...
            if (accessibleActionListenersSize() > 0 || accessibleAttributeListenersSize() > 0 || accessibleHyperlinkListenersSize() > 0 || accessibleTableListenersSize() > 0 || accessibleTableCellListenersSize() > 0 || accessibleTextExtendedListenersSize() > 0 || accessibleValueListenersSize() > 0 || accessibleControlListenersSize() > 0 || getRelationCount() > 0 || (control instanceof Button && ((control.getStyle() & SWT.RADIO) != 0)) || (control instanceof Composite)) {
                ...
                AddRef();
                if (DEBUG)
                    print(this.getApi() + ".QueryInterface guid=" + guidString(guid) + " returning " + objIServiceProvider.getAddress() + hresult(COM.S_OK));
                return COM.S_OK;
            }
            if (DEBUG)
                if (interesting(guid))
        ...
        if (code != COM.S_FALSE) {
            if (DEBUG)
                print(this.getApi() + ".QueryInterface guid=" + guidString(guid) + " returning" + hresult(code));
            return code;
        }
        if (iaccessible != null) {
        ...
        if (COM.IsEqualGUID(service, COM.IIDIAccessible)) {
            if (COM.IsEqualGUID(guid, COM.IIDIUnknown) || COM.IsEqualGUID(guid, COM.IIDIDispatch) || COM.IsEqualGUID(guid, COM.IIDIAccessible)) {
                if (objIAccessible == null)
                    createIAccessible();
                if (DEBUG)
                    print(this.getApi() + ".QueryService service=" + guidString(service) + " guid=" + guidString(guid) + " returning " + objIAccessible.getAddress() + hresult(COM.S_OK));
                OS.MoveMemory(ppvObject, new long[] { objIAccessible.getAddress() }, C.PTR_SIZEOF);
                AddRef();
                return COM.S_OK;
            }
            ...
            if (code != COM.S_FALSE) {
                if (DEBUG)
                    print(this.getApi() + ".QueryService service=" + guidString(service) + " guid=" + guidString(guid) + " returning" + hresult(code));
                return code;
            }
        }
    ...
    int accHitTest(int xLeft, int yTop, long pvarChild) {
        ...
        if (iaccessible != null) {
            ...
            if (code == COM.S_OK) {
                ...
                if (v.vt == COM.VT_I4)
                    ...
                    // TODO: don't use struct. lVal is an int.
                    osChildObject = v.lVal;
                    if (DEBUG)
                        print(this.getApi() + ".IAccessible::accHitTest() super returned VT_DISPATCH");
                }
            }
            if (accessibleControlListenersSize() == 0) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::accHitTest returning childID=" + osChild + " from super" + hresult(code));
                return code;
            }
        }
        ...
        if (accessible != null) {
            if (DEBUG)
                print(this.getApi() + ".IAccessible::accHitTest returning " + ((SwtAccessible) accessible.getImpl()).getAddress() + hresult(COM.S_OK));
            ((SwtAccessible) accessible.getImpl()).AddRef();
            setPtrVARIANT(pvarChild, COM.VT_DISPATCH, ((SwtAccessible) accessible.getImpl()).getAddress());
            return COM.S_OK;
        }
        ...
        if (childID == ACC.CHILDID_NONE) {
            if (osChildObject != 0) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::accHitTest returning osChildObject " + osChildObject + " from super" + hresult(COM.S_OK));
                return COM.S_OK;
            }
            if (DEBUG)
                print(this.getApi() + ".IAccessible::accHitTest returning VT_EMPTY" + hresult(COM.S_FALSE));
            setIntVARIANT(pvarChild, COM.VT_EMPTY, 0);
            return COM.S_FALSE;
        }
        if (DEBUG)
            print(this.getApi() + ".IAccessible::accHitTest returning " + childIDToOs(childID) + hresult(COM.S_OK));
    ...
    int accLocation(long pxLeft, long pyTop, long pcxWidth, long pcyHeight, long varChild) {
        ...
        if (iaccessible != null) {
            ...
            if (accessibleControlListenersSize() == 0) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::accLocation returning from super" + hresult(code));
                return code;
            }
            if (code == COM.S_OK) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::accLocation(" + v.lVal + ") returning x=" + event.x + " y=" + event.y + "w=" + event.width + "h=" + event.height + hresult(COM.S_OK));
    ...
    int accSelect(int flagsSelect, long varChild) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::accSelect(" + flagsSelect + ") returning" + hresult(code));
        return code;
    }
    ...
    int get_accChild(long varChild, long ppdispChild) {
        ...
        if (v.lVal == COM.CHILDID_SELF) {
            if (DEBUG)
                print(this.getApi() + ".IAccessible::get_accChild(" + v.lVal + ") returning " + getAddress() + hresult(COM.S_OK));
            AddRef();
                    ...
                    osAccessible.addAccessibleListener(new AccessibleAdapter() {
                        ...
                        public void getName(AccessibleEvent e) {
                            if (e.childID == ACC.CHILDID_SELF) {
                                AccessibleEvent event = new AccessibleEvent(SwtAccessible.this.getApi());
        ...
        if (accessible != null) {
            if (DEBUG)
                print(this.getApi() + ".IAccessible::get_accChild(" + v.lVal + ") returning " + ((SwtAccessible) accessible.getImpl()).getAddress() + hresult(COM.S_OK));
            ((SwtAccessible) accessible.getImpl()).AddRef();
            OS.MoveMemory(ppdispChild, new long[] { ((SwtAccessible) accessible.getImpl()).getAddress() }, C.PTR_SIZEOF);
            return COM.S_OK;
        }
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accChild(" + v.lVal + ") returning from super" + hresult(code));
        return code;
    }
    ...
    int get_accChildCount(long pcountChildren) {
        ...
        if (iaccessible != null) {
            ...
            if (accessibleControlListenersSize() == 0) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::get_accChildCount() returning " + osChildCount + " from super" + hresult(code));
                return code;
            }
        }
        AccessibleControlEvent event = new AccessibleControlEvent(this.getApi());
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accChildCount() returning " + event.detail + hresult(COM.S_OK));
    ...
    int get_accDescription(long varChild, long pszDescription) {
        ...
        if (iaccessible != null) {
            ...
            if (accessibleListenersSize() == 0 && !(control instanceof Tree)) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::get_accDescription(" + v.lVal + ") returning super" + hresult(code));
                return code;
            }
            if (code == COM.S_OK) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accDescription(" + v.lVal + ") returning " + event.result + hresult(event.result == null ? code : event.result.length() == 0 ? COM.S_FALSE : COM.S_OK));
        if (event.result == null)
            return code;
        if (event.result.length() == 0)
            return COM.S_FALSE;
    ...
    int get_accFocus(long pvarChild) {
        ...
        if (iaccessible != null) {
            ...
            if (accessibleControlListenersSize() == 0) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::get_accFocus() returning childID=" + osChild + " from super" + hresult(code));
                return code;
            }
        }
        AccessibleControlEvent event = new AccessibleControlEvent(this.getApi());
        ...
        if (accessible != null) {
            if (DEBUG)
                print(this.getApi() + ".IAccessible::get_accFocus() returning accessible " + ((SwtAccessible) accessible.getImpl()).getAddress() + hresult(COM.S_OK));
            ((SwtAccessible) accessible.getImpl()).AddRef();
            setPtrVARIANT(pvarChild, COM.VT_DISPATCH, ((SwtAccessible) accessible.getImpl()).getAddress());
            return COM.S_OK;
        }
        ...
        if (childID == ACC.CHILDID_NONE) {
            if (DEBUG)
                print(this.getApi() + ".IAccessible::get_accFocus() returning VT_EMPTY" + hresult(COM.S_FALSE));
            setIntVARIANT(pvarChild, COM.VT_EMPTY, 0);
            return COM.S_FALSE;
        }
        if (childID == ACC.CHILDID_SELF) {
            if (DEBUG)
                print(this.getApi() + ".IAccessible::get_accFocus() returning CHILDID_SELF " + hresult(COM.S_OK));
            AddRef();
            setIntVARIANT(pvarChild, COM.VT_I4, COM.CHILDID_SELF);
            return COM.S_OK;
        }
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accFocus() returning childID " + childIDToOs(childID) + hresult(COM.S_OK));
        setIntVARIANT(pvarChild, COM.VT_I4, childIDToOs(childID));
        return COM.S_OK;
    }
    ...
    int get_accName(long varChild, long pszName) {
        ...
        if (iaccessible != null) {
            ...
            if (accessibleListenersSize() == 0 && !(control instanceof Text)) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::get_accName(" + v.lVal + ") returning name=" + osName + " from super" + hresult(code));
                return code;
            }
        }
        AccessibleEvent event = new AccessibleEvent(this.getApi());
		...
		*/
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accName(" + v.lVal + ") returning " + event.result + hresult(event.result == null ? code : event.result.length() == 0 ? COM.S_FALSE : COM.S_OK));
        if (event.result == null)
            return code;
        if (event.result.length() == 0)
            return COM.S_FALSE;
    ...
    int get_accParent(long ppdispParent) {
        ...
        if (parent != null) {
            ...
            ((SwtAccessible) parent.getImpl()).AddRef();
            OS.MoveMemory(ppdispParent, new long[] { ((SwtAccessible) parent.getImpl()).getAddress() }, C.PTR_SIZEOF);
            code = COM.S_OK;
        }
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accParent() returning" + (parent != null ? " " + ((SwtAccessible) parent.getImpl()).getAddress() : " from super") + hresult(code));
        return code;
    }
    ...
    int get_accRole(long varChild, long pvarRole) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accRole(" + v.lVal + ") returning " + getRoleString(roleToOs(event.detail)) + hresult(COM.S_OK));
    ...
    int get_accSelection(long pvarChildren) {
        ...
        if (accessible != null) {
            ((SwtAccessible) accessible.getImpl()).AddRef();
            setPtrVARIANT(pvarChildren, COM.VT_DISPATCH, ((SwtAccessible) accessible.getImpl()).getAddress());
            return COM.S_OK;
        }
        int childID = event.childID;
        if (childID == ACC.CHILDID_NONE) {
    ...
    int get_accState(long varChild, long pvarState) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accState(" + v.lVal + ") returning" + getStateString(state) + hresult(COM.S_OK));
    ...
    int get_accValue(long varChild, long pszValue) {
        ...
        if (iaccessible != null) {
            ...
            if (accessibleControlListenersSize() == 0 && !(control instanceof Text)) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::get_accValue(" + v.lVal + ") returning value=" + osValue + " from super" + hresult(code));
                return code;
            }
        }
        AccessibleControlEvent event = new AccessibleControlEvent(this.getApi());
		...
		*/
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible::get_accValue(" + v.lVal + ") returning " + event.result + hresult(event.result == null ? code : COM.S_OK));
        if (event.result == null)
            return code;
    ...
    int put_accValue(long varChild, long szValue) {
        ...
        if (v.lVal == COM.CHILDID_SELF && accessibleEditableTextListenersSize() > 0) {
            ...
            if (event.end >= 0) {
                ...
                if (event.result != null && event.result.equals(ACC.OK))
                    code = COM.S_OK;
                if (DEBUG)
                    print(this.getApi() + ".IAccessible::put_accValue(" + v.lVal + ", \"" + event.string + "\") returning " + hresult(code));
            }
        }
        if (code != COM.S_OK && iaccessible != null) {
            ...
            if (code == COM.E_INVALIDARG)
                code = COM.DISP_E_MEMBERNOTFOUND;
            if (DEBUG)
                print(this.getApi() + ".IAccessible::put_accValue(" + v.lVal + ") returning " + hresult(code) + " from proxy");
        }
        return code;
    }
        ...
        if (nextItems != null) {
            for (int i = 0; i < nextItems.length; i++) {
                ...
                if (nextItem instanceof Integer) {
                    ...
                    ((SwtAccessible) accessible.getImpl()).AddRef();
                    setPtrVARIANT(rgvar + i * VARIANT.sizeof, COM.VT_DISPATCH, ((SwtAccessible) accessible.getImpl()).getAddress());
                }
            }
            if (pceltFetched != 0)
    ...
    int get_nRelations(long pNRelations) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_nRelations returning " + count + hresult(COM.S_OK));
    ...
    int get_relation(int relationIndex, long ppRelation) {
        ...
        for (int type = 0; type < MAX_RELATION_TYPES; type++) {
            ...
            if (i == relationIndex) {
                if (DEBUG)
                    print(this.getApi() + ".IAccessible2::get_relation(" + relationIndex + ") returning " + relation.getAddress() + hresult(COM.S_OK));
                relation.AddRef();
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_relation(" + relationIndex + ") returning" + hresult(COM.E_INVALIDARG));
        return COM.E_INVALIDARG;
    }
    ...
    int get_relations(int maxRelations, long ppRelations, long pNRelations) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_relations(" + maxRelations + ") returning " + count + hresult(COM.S_OK));
        OS.MoveMemory(pNRelations, new int[] { count }, 4);
        return COM.S_OK;
    }
    ...
    int get_role(long pRole) {
        ...
        if (role == 0)
            role = getDefaultRole();
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_role() returning " + getRoleString(role) + hresult(COM.S_OK));
    ...
    int get_groupPosition(long pGroupLevel, long pSimilarItemsInGroup, long pPositionInGroup) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_groupPosition() returning level=" + groupLevel + ", count=" + similarItemsInGroup + ", index=" + positionInGroup + hresult(groupLevel == 0 && similarItemsInGroup == 0 && positionInGroup == 0 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_states(long pStates) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_states returning" + getIA2StatesString(ia2States) + hresult(COM.S_OK));
    ...
    int get_uniqueID(long pUniqueID) {
        ...
        if (uniqueID == -1)
            uniqueID = UniqueID--;
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_uniqueID returning " + uniqueID + hresult(COM.S_OK));
    ...
    int get_windowHandle(long pWindowHandle) {
        if (control != null && control.isDisposed())
            return COM.CO_E_OBJNOTCONNECTED;
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_windowHandle returning " + control.handle + hresult(COM.S_OK));
    ...
    int get_indexInParent(long pIndexInParent) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_indexInParent returning " + indexInParent + hresult(indexInParent == -1 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_locale(long pLocale) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_locale() returning" + hresult(COM.S_OK));
        return COM.S_OK;
    }
    ...
    int get_attributes(long pbstrAttributes) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessible2::get_attributes() returning " + attributes + hresult(attributes.length() == 0 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_nActions(long pNActions) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleAction::get_nActions() returning " + event.count + hresult(COM.S_OK));
    ...
    int doAction(int actionIndex) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleAction::doAction(" + actionIndex + ") returning" + hresult(event.result == null || !event.result.equals(ACC.OK) ? COM.E_INVALIDARG : COM.S_OK));
        if (event.result == null || !event.result.equals(ACC.OK))
            return COM.E_INVALIDARG;
        return COM.S_OK;
    }
    ...
    int get_description(int actionIndex, long pbstrDescription) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleAction::get_description(" + actionIndex + ") returning " + event.result + hresult(event.result == null || event.result.length() == 0 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_keyBinding(int actionIndex, int nMaxBindings, long ppbstrKeyBindings, long pNBindings) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleAction::get_keyBinding(index=" + actionIndex + " max=" + nMaxBindings + ") returning count=" + count + hresult(count == 0 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_name(int actionIndex, long pbstrName) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleAction::get_name(" + actionIndex + ") returning " + event.result + hresult(event.result == null || event.result.length() == 0 ? COM.S_FALSE : COM.S_OK));
        if (event.result == null || event.result.length() == 0) {
    ...
    int get_localizedName(int actionIndex, long pbstrLocalizedName) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleAction::get_localizedName(" + actionIndex + ") returning " + event.result + hresult(event.result == null || event.result.length() == 0 ? COM.S_FALSE : COM.S_OK));
        if (event.result == null || event.result.length() == 0) {
    ...
    int get_appName(long pbstrName) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleApplication::get_appName() returning " + appName + hresult(appName == null || appName.length() == 0 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_appVersion(long pbstrVersion) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleApplication::get_appVersion() returning" + appVersion + hresult(appVersion == null || appVersion.length() == 0 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_toolkitName(long pbstrName) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleApplication::get_toolkitName() returning" + toolkitName + hresult(COM.S_OK));
    ...
    int get_toolkitVersion(long pbstrVersion) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleApplication::get_toolkitVersion() returning" + toolkitVersion + hresult(COM.S_OK));
    ...
    int get_anchor(int index, long pAnchor) {
        ...
        if (accessible != null) {
            ((SwtAccessible) accessible.getImpl()).AddRef();
            setPtrVARIANT(pAnchor, COM.VT_DISPATCH, ((SwtAccessible) accessible.getImpl()).getAddress());
            return COM.S_OK;
        }
    ...
    int get_anchorTarget(int index, long pAnchorTarget) {
        ...
        if (accessible != null) {
            ((SwtAccessible) accessible.getImpl()).AddRef();
            setPtrVARIANT(pAnchorTarget, COM.VT_DISPATCH, ((SwtAccessible) accessible.getImpl()).getAddress());
            return COM.S_OK;
        }
    ...
    int get_hyperlink(int index, long ppHyperlink) {
        ...
        ((SwtAccessible) accessible.getImpl()).AddRef();
        OS.MoveMemory(ppHyperlink, new long[] { ((SwtAccessible) accessible.getImpl()).getAddress() }, C.PTR_SIZEOF);
        return COM.S_OK;
    }
    ...
    int get_cellAt(int row, int column, long ppCell) {
        ...
        if (accessible == null)
            return COM.E_INVALIDARG;
        ((SwtAccessible) accessible.getImpl()).AddRef();
        OS.MoveMemory(ppCell, new long[] { ((SwtAccessible) accessible.getImpl()).getAddress() }, C.PTR_SIZEOF);
        return COM.S_OK;
    }
    ...
    int get_caption(long ppAccessible) {
        ...
        ((SwtAccessible) accessible.getImpl()).AddRef();
        OS.MoveMemory(ppAccessible, new long[] { ((SwtAccessible) accessible.getImpl()).getAddress() }, C.PTR_SIZEOF);
        return COM.S_OK;
    }
    ...
    int get_selectedCells(long ppCells, long pNSelectedCells) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (accessible != null) {
                ((SwtAccessible) accessible.getImpl()).AddRef();
                OS.MoveMemory(pv + i * C.PTR_SIZEOF, new long[] { ((SwtAccessible) accessible.getImpl()).getAddress() }, C.PTR_SIZEOF);
                count++;
            }
        }
    ...
    int get_table(long ppTable) {
        ...
        ((SwtAccessible) accessible.getImpl()).AddRef();
        OS.MoveMemory(ppTable, new long[] { ((SwtAccessible) accessible.getImpl()).getAddress() }, C.PTR_SIZEOF);
        return COM.S_OK;
    }
    ...
    int get_caretOffset(long pOffset) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::get_caretOffset returning " + offset + hresult(offset == -1 ? COM.S_FALSE : COM.S_OK));
    ...
    int get_offsetAtPoint(int x, int y, int coordType, long pOffset) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::get_offsetAtPoint(" + x + ", " + y + ") returning " + event.offset + hresult(event.offset == -1 ? COM.S_FALSE : COM.S_OK));
        /*
    ...
    int get_text(int startOffset, int endOffset, long pbstrText) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::get_text(" + startOffset + ", " + endOffset + ") returning " + event.result + hresult(event.result == null ? COM.E_INVALIDARG : COM.S_OK));
    ...
    int get_textBeforeOffset(int offset, int boundaryType, long pStartOffset, long pEndOffset, long pbstrText) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::get_textBeforeOffset(" + offset + ") returning start=" + event.start + ", end=" + event.end + " " + event.result + hresult(event.result == null ? COM.S_FALSE : COM.S_OK));
        OS.MoveMemory(pStartOffset, new int[] { event.start }, 4);
        OS.MoveMemory(pEndOffset, new int[] { event.end }, 4);
        setString(pbstrText, event.result);
        if (event.result == null)
    ...
    int get_textAfterOffset(int offset, int boundaryType, long pStartOffset, long pEndOffset, long pbstrText) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::get_textAfterOffset(" + offset + ") returning start=" + event.start + ", end=" + event.end + " " + event.result + hresult(event.result == null ? COM.S_FALSE : COM.S_OK));
        OS.MoveMemory(pStartOffset, new int[] { event.start }, 4);
        OS.MoveMemory(pEndOffset, new int[] { event.end }, 4);
        setString(pbstrText, event.result);
        if (event.result == null)
    ...
    int get_textAtOffset(int offset, int boundaryType, long pStartOffset, long pEndOffset, long pbstrText) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::get_textAtOffset(" + offset + ") returning start=" + event.start + ", end=" + event.end + " " + event.result + hresult(event.result == null ? COM.S_FALSE : COM.S_OK));
        OS.MoveMemory(pStartOffset, new int[] { event.start }, 4);
        OS.MoveMemory(pEndOffset, new int[] { event.end }, 4);
        setString(pbstrText, event.result);
        if (event.result == null)
    ...
    int removeSelection(int selectionIndex) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::removeSelection(" + selectionIndex + ") returning" + hresult(event.result == null || !event.result.equals(ACC.OK) ? COM.E_INVALIDARG : COM.S_OK));
        if (event.result == null || !event.result.equals(ACC.OK))
            return COM.E_INVALIDARG;
        return COM.S_OK;
    }
    ...
    int setCaretOffset(int offset) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleText::setCaretOffset(" + offset + ") returning" + hresult(event.result == null || !event.result.equals(ACC.OK) ? COM.E_INVALIDARG : COM.S_OK));
    ...
    int get_currentValue(long pCurrentValue) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleValue::get_currentValue returning " + event.value + hresult(event.value == null ? COM.S_FALSE : COM.S_OK));
    ...
    int get_maximumValue(long pMaximumValue) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleValue::get_maximumValue returning " + event.value + hresult(event.value == null ? COM.S_FALSE : COM.S_OK));
    ...
    int get_minimumValue(long pMinimumValue) {
        ...
        if (DEBUG)
            print(this.getApi() + ".IAccessibleValue::get_minimumValue returning " + event.value + hresult(event.value == null ? COM.S_FALSE : COM.S_OK));
    ...
    String guidString(GUID guid) {
        if (DEBUG) {
            //$NON-NLS-1$
            final GUID IIDIAccessibleHandler = IIDFromString("{03022430-ABC4-11D0-BDE2-00AA001A1953}");
            //$NON-NLS-1$
            final GUID IIDIAccessor = IIDFromString("{0C733A8C-2A1C-11CE-ADE5-00AA0044773D}");
            //$NON-NLS-1$
            final GUID IIDIAdviseSink2 = IIDFromString("{00000125-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIBindCtx = IIDFromString("{0000000E-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDICreateErrorInfo = IIDFromString("{22F03340-547D-101B-8E65-08002B2BD119}");
            //$NON-NLS-1$
            final GUID IIDICreateTypeInfo = IIDFromString("{00020405-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDICreateTypeLib = IIDFromString("{00020406-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIDataAdviseHolder = IIDFromString("{00000110-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIEnumConnectionPoints = IIDFromString("{B196B285-BAB4-101A-B69C-00AA00341D07}");
            //$NON-NLS-1$
            final GUID IIDIEnumConnections = IIDFromString("{B196B287-BAB4-101A-B69C-00AA00341D07}");
            //$NON-NLS-1$
            final GUID IIDIEnumMoniker = IIDFromString("{00000102-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIEnumOLEVERB = IIDFromString("{00000104-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIEnumSTATDATA = IIDFromString("{00000105-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIEnumSTATSTG = IIDFromString("{0000000D-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIEnumString = IIDFromString("{00000101-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIEnumUnknown = IIDFromString("{00000100-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIErrorInfo = IIDFromString("{1CF2B120-547D-101B-8E65-08002B2BD119}");
            //$NON-NLS-1$
            final GUID IIDIErrorLog = IIDFromString("{3127CA40-446E-11CE-8135-00AA004BB851}");
            //$NON-NLS-1$
            final GUID IIDIExternalConnection = IIDFromString("{00000019-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIFontDisp = IIDFromString("{BEF6E003-A874-101A-8BBA-00AA00300CAB}");
            //$NON-NLS-1$
            final GUID IIDILockBytes = IIDFromString("{0000000A-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIMalloc = IIDFromString("{00000002-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIMallocSpy = IIDFromString("{0000001D-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIMarshal = IIDFromString("{00000003-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIMessageFilter = IIDFromString("{00000016-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIMoniker = IIDFromString("{0000000F-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIOleAdviseHolder = IIDFromString("{00000111-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIOleCache = IIDFromString("{0000011E-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIOleCache2 = IIDFromString("{00000128-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIOleCacheControl = IIDFromString("{00000129-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIOleItemContainer = IIDFromString("{0000011C-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIParseDisplayName = IIDFromString("{0000011A-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIPerPropertyBrowsing = IIDFromString("{376BD3AA-3845-101B-84ED-08002B2EC713}");
            //$NON-NLS-1$
            final GUID IIDIPersistMemory = IIDFromString("{BD1AE5E0-A6AE-11CE-BD37-504200C10000}");
            //$NON-NLS-1$
            final GUID IIDIPersistPropertyBag = IIDFromString("{37D84F60-42CB-11CE-8135-00AA004BB851}");
            //$NON-NLS-1$
            final GUID IIDIPicture = IIDFromString("{7BF80980-BF32-101A-8BBB-00AA00300CAB}");
            //$NON-NLS-1$
            final GUID IIDIPictureDisp = IIDFromString("{7BF80981-BF32-101A-8BBB-00AA00300CAB}");
            //$NON-NLS-1$
            final GUID IIDIPropertyBag = IIDFromString("{55272A00-42CB-11CE-8135-00AA004BB851}");
            //$NON-NLS-1$
            final GUID IIDIPropertyPage = IIDFromString("{B196B28D-BAB4-101A-B69C-00AA00341D07}");
            //$NON-NLS-1$
            final GUID IIDIPropertyPage2 = IIDFromString("{01E44665-24AC-101B-84ED-08002B2EC713}");
            //$NON-NLS-1$
            final GUID IIDIPropertyPageSite = IIDFromString("{B196B28C-BAB4-101A-B69C-00AA00341D07}");
            //$NON-NLS-1$
            final GUID IIDIPSFactoryBuffer = IIDFromString("{D5F569D0-593B-101A-B569-08002B2DBF7A}");
            //$NON-NLS-1$
            final GUID IIDIRootStorage = IIDFromString("{00000012-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIROTData = IIDFromString("{F29F6BC0-5021-11CE-AA15-00006901293F}");
            //$NON-NLS-1$
            final GUID IIDIRpcChannelBuffer = IIDFromString("{D5F56B60-593B-101A-B569-08002B2DBF7A}");
            //$NON-NLS-1$
            final GUID IIDIRpcProxyBuffer = IIDFromString("{D5F56A34-593B-101A-B569-08002B2DBF7A}");
            //$NON-NLS-1$
            final GUID IIDIRpcStubBuffer = IIDFromString("{D5F56AFC-593B-101A-B569-08002B2DBF7A}");
            //$NON-NLS-1$
            final GUID IIDIRunnableObject = IIDFromString("{00000126-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIRunningObjectTable = IIDFromString("{00000010-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDISimpleFrameSite = IIDFromString("{742B0E01-14E6-101B-914E-00AA00300CAB}");
            //$NON-NLS-1$
            final GUID IIDIStdMarshalInfo = IIDFromString("{00000018-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDISupportErrorInfo = IIDFromString("{DF0B3D60-548F-101B-8E65-08002B2BD119}");
            //$NON-NLS-1$
            final GUID IIDITypeComp = IIDFromString("{00020403-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDITypeLib = IIDFromString("{00020402-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIViewObject = IIDFromString("{0000010D-0000-0000-C000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDIdentityUnmarshal = IIDFromString("{0000001b-0000-0000-c000-000000000046}");
            //$NON-NLS-1$
            final GUID IIDInternalMSMarshaller = IIDFromString("{4c1e39e1-e3e3-4296-aa86-ec938d896e92}");
            //$NON-NLS-1$
            final GUID IIDIAccIdentity = IIDFromString("{7852B78D-1CFD-41C1-A615-9C0C85960B5F}");
            //$NON-NLS-1$
            final GUID IIDIAccPropServer = IIDFromString("{76C0DBBB-15E0-4E7B-B61B-20EEEA2001E0}");
            //$NON-NLS-1$
            final GUID IIDIAccPropServices = IIDFromString("{6E26E776-04F0-495D-80E4-3330352E3169}");
