                ...
                switch(event.type) {
					...
					*/
                            ...
                            if (doit1) {
                                ...
                                Variant variant1 = new Variant(auto);
					...
					*/
                            ...
                            if (html != null && url2.equals(ABOUT_BLANK)) {
                                ...
                                Variant variant2 = new Variant(auto);
                                /* does not need to be disposed */
						...
						*/
                                //$NON-NLS-1$
                                int[] rgdispid1 = auto.getIDsOfNames(new String[] { "ReadyState" });
                                ...
                                if (globalDispatch != 0 && dispatch2.getAddress() == globalDispatch) {
                                    ...
                                    if (ie.installFunctionsOnDocumentComplete) {
                                        ...
                                        while (elements1.hasNext()) {
                                            ...
                                            execute(((SwtBrowserFunction) function1.getImpl()).functionString);
                                        }
                                    }
					...
					*/
                            ...
                            while (elements2.hasNext()) {
                                ...
                                execute(((SwtBrowserFunction) function2.getImpl()).functionString);
                            }
                            if (!isRefresh)
                                break;
                            isRefresh = false;
                    ...
                    case NavigateComplete2:
                        {
                            ...
                            if (!performingInitialNavigate) {
                                ...
                                Variant variant3 = new Variant(auto);
                                /* does not need to be disposed */
					...
					*/
							...
							*/
                            ...
                            Variant variant4 = new Variant(auto);
                            /* does not need to be disposed */
                            ...
                            if (isTop) {
                                ...
                                while (elements3.hasNext()) {
                                    ...
                                    execute(((SwtBrowserFunction) function3.getImpl()).functionString);
                                }
                            }
                            if (!isPDF) {
                    ...
                    case OnVisible:
                        {
							...
							*/
                                    //$NON-NLS-1$
                                    int[] rgdispid2 = auto.getIDsOfNames(new String[] { "AddressBar" });
                    ...
                    case ProgressChange:
                        {
                            ...
                            // may be -1
                            int nProgress = arg12.getType() != OLE.VT_I4 ? 0 : arg12.getInt();
	...
	*/
    ...
    void handleDOMEvent(OleEvent e) {
		...
		*/
            switch(lastKeyCode) {
                case SWT.BS:
                    lastCharCode = keyEvent.character = SWT.BS;
                    break;
                case SWT.CR:
                    lastCharCode = keyEvent.character = SWT.CR;
                    break;
                case SWT.DEL:
                    lastCharCode = keyEvent.character = SWT.DEL;
                    break;
                case SWT.TAB:
                    lastCharCode = keyEvent.character = SWT.TAB;
                    break;
            }
