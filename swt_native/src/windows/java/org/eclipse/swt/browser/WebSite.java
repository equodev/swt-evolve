    ...
    protected void createCOMInterfaces() {
        ...
        iDocHostUIHandler = new COMObject(new int[] { 2, 0, 0, 4, 1, 5, 0, 0, 1, 1, 1, 3, 3, 2, 2, 1, 3, 2 }) {
            ...
            public long method3(long[] args) {
                return ShowContextMenu((int) args[0], args[1], args[2], args[3]);
            }
            ...
            public long method5(long[] args) {
                return ShowUI((int) args[0], args[1], args[2], args[3], args[4]);
            }
            ...
            public long method8(long[] args) {
                return EnableModeless((int) args[0]);
            }

            @Override
            public long method9(long[] args) {
                return OnDocWindowActivate((int) args[0]);
            }

            @Override
            public long method10(long[] args) {
                return OnFrameWindowActivate((int) args[0]);
            }

            @Override
            public long method11(long[] args) {
                return ResizeBorder(args[0], args[1], (int) args[2]);
            }

            @Override
            public long method12(long[] args) {
                return TranslateAccelerator(args[0], args[1], (int) args[2]);
            }

            @Override
            public long method13(long[] args) {
                return GetOptionKeyPath(args[0], (int) args[1]);
            }
            ...
            public long method16(long[] args) {
                return TranslateUrl((int) args[0], args[1], args[2]);
            }
        ...
        iDocHostShowUI = new COMObject(new int[] { 2, 0, 0, 7, 6 }) {
            ...
            @Override
            public long method3(long[] args) {
                return ShowMessage(args[0], args[1], args[2], (int) args[3], args[4], (int) args[5], args[6]);
            }

            @Override
            public long method4(long[] args) {
                return ShowHelp(args[0], args[1], (int) args[2], (int) args[3], args[4], args[5]);
            }
        };
        ...
        iInternetSecurityManager = new COMObject(new int[] { 2, 0, 0, 1, 1, 3, 4, 8, 7, 3, 3 }) {
            ...
            @Override
            public long method5(long[] args) {
                return MapUrlToZone(args[0], args[1], (int) args[2]);
            }
            ...
            @Override
            public long method7(long[] args) {
                return ProcessUrlAction(args[0], (int) args[1], args[2], (int) args[3], args[4], (int) args[5], (int) args[6], (int) args[7]);
            }

            @Override
            public long method8(long[] args) {
                return QueryCustomPolicy(args[0], args[1], args[2], args[3], args[4], (int) args[5], (int) args[6]);
            }

            @Override
            public long method9(long[] args) {
                return SetZoneMapping((int) args[0], args[1], (int) args[2]);
            }

            @Override
            public long method10(long[] args) {
                return GetZoneMappings((int) args[0], args[1], (int) args[2]);
            }
        };
        iOleCommandTarget = new COMObject(new int[] { 2, 0, 0, 4, 5 }) {
            ...
            @Override
            public long method3(long[] args) {
                return QueryStatus(args[0], (int) args[1], args[2], args[3]);
            }

            @Override
            public long method4(long[] args) {
                return Exec(args[0], (int) args[1], (int) args[2], args[3], args[4]);
            }
        };
        ...
        iDispatch = new COMObject(new int[] { 2, 0, 0, 1, 3, 5, 8 }) {
            ...
            @Override
            public long method4(long[] args) {
                return GetTypeInfo((int) args[0], (int) args[1], args[2]);
            }

            @Override
            public long method5(long[] args) {
                return GetIDsOfNames((int) args[0], args[1], (int) args[2], (int) args[3], args[4]);
            }

            @Override
            public long method6(long[] args) {
                return Invoke((int) args[0], (int) args[1], (int) args[2], (int) args[3], args[4], args[5], args[6], args[7]);
            }
        };
    }
        ...
        if (msg.message == OS.WM_KEYDOWN) {
            switch((int) msg.wParam) {
                ...
                case OS.VK_O:
                    if (OS.GetKeyState(OS.VK_CONTROL) < 0 && OS.GetKeyState(OS.VK_MENU) >= 0 && OS.GetKeyState(OS.VK_SHIFT) >= 0) {
                        if (msg.wParam == OS.VK_N || IE.IEVersion >= 8) {
                            //$NON-NLS-1$
                            frame.setData(CONSUME_KEY, "false");
                            result = COM.S_OK;
                            break;
                        }
                    }
                ...
                default:
                    ...
                    //$NON-NLS-1$
                    frame.setData(CONSUME_KEY, "true");
                    break;
            }
        }
        switch(msg.message) {
