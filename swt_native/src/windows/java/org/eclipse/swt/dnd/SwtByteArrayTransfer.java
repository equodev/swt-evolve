 ...
 *  @see Transfer
 */
public abstract class SwtByteArrayTransfer extends SwtTransfer implements IByteArrayTransfer {
    ...
    public boolean isSupportedType(TransferData transferData) {
        ...
        for (int type : getTypeIds()) {
            ...
            if (format.cfFormat == type && (format.dwAspect & COM.DVASPECT_CONTENT) == COM.DVASPECT_CONTENT && (format.tymed & COM.TYMED_HGLOBAL) == COM.TYMED_HGLOBAL)
                return true;
        }
        return false;
    }
