 ...
 * @since 3.3
 */
public class SwtTableDropTargetEffect extends SwtDropTargetEffect implements ITableDropTargetEffect {
    ...
    public void dragOver(DropTargetEvent event) {
        ...
        // To Pixels
        coordinates = Win32DPIUtils.pointToPixelAsLocation(table.toControl(coordinates), DPIUtil.getZoomForAutoscaleProperty(table.nativeZoom));
    ...
    public TableDropTargetEffect getApi() {
        ...
        return (TableDropTargetEffect) api;
    }
}
