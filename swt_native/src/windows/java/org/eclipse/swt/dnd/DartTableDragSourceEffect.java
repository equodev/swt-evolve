 ...
 * @since 3.3
 */
public class DartTableDragSourceEffect extends DartDragSourceEffect implements ITableDragSourceEffect {
     ...
     */
    public DartTableDragSourceEffect(Table table, TableDragSourceEffect api) {
        super(table, api);
    }
    ...
    public TableDragSourceEffect getApi() {
        ...
        return (TableDragSourceEffect) api;
    }
}
