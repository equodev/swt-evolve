...
public class Gdip extends Platform {
     ...
     */
    public static final native int Graphics_DrawDriverString(long graphics, long text, int length, long font, long brush, PointF /*long*/
    positions, int flags, long matrix);
