...
public class OS extends C {
	...
	*/
    ...
    public static final int WIN32_BUILD_WIN10_1607 = 14393;
	...
	*/
    ...
    /* Macros */
    public static final int GET_WHEEL_DELTA_WPARAM(long wParam) {
    ...
    public static final int HIWORD(long l) {
        return (int) l >>> 16;
    }
    ...
    public static final long MAKELPARAM(int l, int h) {
        return ((l & 0xffff) | (h << 16)) & 0xffffffffL;
    }
    ...
    public static final void POINTSTOPOINT(POINT pt, long pts) {
    ...
    public static final int TOUCH_COORD_TO_PIXEL(int touchCoord) {
