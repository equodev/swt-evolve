...
*/
    ...
    public FontData[] getFontList(String faceName, boolean scalable) {
        ...
        for (int i = offset; i < nFonts; i++) {
            FontData fd = SwtFontData.win32_new(logFonts[i], pixels[i] * 72f / logPixelsY);
            int j;
            for (j = 0; j < count; j++) {
    ...
    public Color getSystemColor(int id) {
        ...
        return SwtColor.win32_new(this.getApi(), pixel, alpha);
    }
    ...
    public Font getSystemFont() {
        ...
        return SwtFont.win32_new(this.getApi(), hFont);
    }
