 ...
 */
public class SwtScale extends SwtControl implements IScale {
    ...
    Point computeSizeInPixels(int wHint, int hHint, boolean changed) {
        ...
        RECT rect = new RECT();
        OS.SendMessage(getApi().handle, OS.TBM_GETTHUMBRECT, 0, rect);
    ...
    void createHandle() {
        super.createHandle();
        getApi().state |= THEME_BACKGROUND | DRAW_BACKGROUND;
        OS.SendMessage(getApi().handle, OS.TBM_SETRANGEMAX, 0, 100);
        OS.SendMessage(getApi().handle, OS.TBM_SETPAGESIZE, 0, 10);
        OS.SendMessage(getApi().handle, OS.TBM_SETTICFREQ, 10, 0);
    ...
    public int getIncrement() {
        checkWidget();
        return (int) OS.SendMessage(getApi().handle, OS.TBM_GETLINESIZE, 0, 0);
    }
    ...
    public int getMaximum() {
        checkWidget();
        return (int) OS.SendMessage(getApi().handle, OS.TBM_GETRANGEMAX, 0, 0);
    }
    ...
    public int getMinimum() {
        checkWidget();
        return (int) OS.SendMessage(getApi().handle, OS.TBM_GETRANGEMIN, 0, 0);
    }
    ...
    public int getPageIncrement() {
        checkWidget();
        return (int) OS.SendMessage(getApi().handle, OS.TBM_GETPAGESIZE, 0, 0);
    }
    ...
    public int getSelection() {
        checkWidget();
        return (int) OS.SendMessage(getApi().handle, OS.TBM_GETPOS, 0, 0);
    }
	...
	*/
        ignoreResize = true;
        OS.SendMessage(getApi().handle, OS.WM_SIZE, 0, 0);
        ignoreResize = false;
    }
	...
	*/
    ...
    public void setIncrement(int increment) {
        ...
        if (increment < 1)
            return;
        int minimum = (int) OS.SendMessage(getApi().handle, OS.TBM_GETRANGEMIN, 0, 0);
        int maximum = (int) OS.SendMessage(getApi().handle, OS.TBM_GETRANGEMAX, 0, 0);
        if (increment > maximum - minimum)
            return;
        OS.SendMessage(getApi().handle, OS.TBM_SETLINESIZE, 0, increment);
    }
    ...
    public void setMaximum(int value) {
        ...
        if (0 <= minimum && minimum < value) {
            OS.SendMessage(getApi().handle, OS.TBM_SETRANGEMAX, 1, value);
        }
    }
    ...
    public void setMinimum(int value) {
        ...
        if (0 <= value && value < maximum) {
            OS.SendMessage(getApi().handle, OS.TBM_SETRANGEMIN, 1, value);
        }
    }
    ...
    public void setPageIncrement(int pageIncrement) {
        ...
        if (pageIncrement > maximum - minimum)
            return;
        OS.SendMessage(getApi().handle, OS.TBM_SETPAGESIZE, 0, pageIncrement);
        OS.SendMessage(getApi().handle, OS.TBM_SETTICFREQ, pageIncrement, 0);
    }
    ...
    public void setSelection(int value) {
        checkWidget();
        OS.SendMessage(getApi().handle, OS.TBM_SETPOS, 1, value);
    }
	...
	*/
        int oldPosition = (int) OS.SendMessage(getApi().handle, OS.TBM_GETPOS, 0, 0);
        ignoreSelection = true;
        long code = callWindowProc(getApi().handle, OS.WM_MOUSEWHEEL, wParam, lParam);
        ignoreSelection = false;
        int newPosition = (int) OS.SendMessage(getApi().handle, OS.TBM_GETPOS, 0, 0);
