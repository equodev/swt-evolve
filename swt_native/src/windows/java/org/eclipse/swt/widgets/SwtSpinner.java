...
public class SwtSpinner extends SwtComposite implements ISpinner {
    ...
    long callWindowProc(long hwnd, int msg, long wParam, long lParam) {
        ...
        return OS.DefWindowProc(getApi().handle, msg, wParam, lParam);
    }
	...
	*/
    ...
    void createHandle() {
        ...
        hwndText = OS.CreateWindowEx(textExStyle, EditClass, null, textStyle, 0, 0, 0, 0, getApi().handle, 0, hInstance, null);
        if (hwndText == 0)
        ...
        hwndUpDown = OS.CreateWindowEx(0, UpDownClass, null, upDownStyle, 0, 0, 0, 0, getApi().handle, 0, hInstance, null);
        if (hwndUpDown == 0)
            error(SWT.ERROR_NO_HANDLES);
	...
	*/
    ...
    void setToolTipText(Shell shell, String string) {
        ...
        ((SwtShell) shell.getImpl()).setToolTipText(hwndUpDown, string);
    }
	 ...
	 */
        ...
        if (((getApi().style & SWT.BORDER) != 0) && !((SwtDisplay) display.getImpl()).useWsBorderText) {
