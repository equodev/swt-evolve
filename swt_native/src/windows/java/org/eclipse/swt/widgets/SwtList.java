...
public class SwtList extends SwtScrollable implements IList {
    ...
    public void add(String string) {
        ...
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_ADDSTRING, 0, buffer);
        if (result == OS.LB_ERR)
    ...
    public void add(String string, int index) {
        ...
        TCHAR buffer = new TCHAR(getCodePage(), string, true);
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_INSERTSTRING, index, buffer);
        if (result == OS.LB_ERRSPACE)
            error(SWT.ERROR_ITEM_NOT_ADDED);
        if (result == OS.LB_ERR) {
        ...
        if (wHint == SWT.DEFAULT) {
            if ((getApi().style & SWT.H_SCROLL) != 0) {
                ...
                for (int i = 0; i < count; i++) {
                    int length = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXTLEN, i, 0);
                    if (length != OS.LB_ERR) {
                        if (length + 1 > buffer.length) {
                            buffer = new char[length + 1];
                        }
                        int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXT, i, buffer);
                        if (result != OS.LB_ERR) {
    ...
    public void deselect(int[] indices) {
        ...
        if ((getApi().style & SWT.SINGLE) != 0) {
            int oldIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETCURSEL, 0, 0);
            if (oldIndex == OS.LB_ERR)
                return;
            for (int index : indices) {
                if (oldIndex == index) {
                    OS.SendMessage(getApi().handle, OS.LB_SETCURSEL, -1, 0);
                    return;
                }
            }
            return;
        ...
        for (int index : indices) {
            if (index != -1) {
                OS.SendMessage(getApi().handle, OS.LB_SETSEL, 0, index);
            }
        }
    }
	...
	*/
        ...
        OS.SendMessage(getApi().handle, OS.LB_SELITEMRANGEEX, end, start);
    }
    ...
    public void deselectAll() {
        ...
        if ((getApi().style & SWT.SINGLE) != 0) {
            ...
            OS.SendMessage(getApi().handle, OS.LB_SETSEL, 0, -1);
        }
    }
    ...
    public int getFocusIndex() {
        checkWidget();
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETCARETINDEX, 0, 0);
        if (result == 0) {
            int count = (int) OS.SendMessage(getApi().handle, OS.LB_GETCOUNT, 0, 0);
            if (count == 0)
                return -1;
    ...
    public String getItem(int index) {
        checkWidget();
        int length = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXTLEN, index, 0);
        if (length != OS.LB_ERR) {
            char[] buffer = new char[length + 1];
            int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXT, index, buffer);
            if (result != OS.LB_ERR)
                return ((getApi().state & HAS_AUTO_DIRECTION) != 0) ? new String(buffer, 1, length - 1) : new String(buffer, 0, length);
        }
        int count = (int) OS.SendMessage(getApi().handle, OS.LB_GETCOUNT, 0, 0);
        if (0 <= index && index < count)
    ...
    public int getItemCount() {
        checkWidget();
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETCOUNT, 0, 0);
        if (result == OS.LB_ERR)
    ...
    int getItemHeightInPixels() {
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETITEMHEIGHT, 0, 0);
        if (result == OS.LB_ERR)
    ...
    public int getSelectionCount() {
        checkWidget();
        if ((getApi().style & SWT.SINGLE) != 0) {
            int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETCURSEL, 0, 0);
            if (result == OS.LB_ERR)
                return 0;
            return 1;
        }
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETSELCOUNT, 0, 0);
        if (result == OS.LB_ERR)
            error(SWT.ERROR_CANNOT_GET_COUNT);
        return result;
    }
    ...
    public int getSelectionIndex() {
        checkWidget();
        if ((getApi().style & SWT.SINGLE) != 0) {
            return (int) OS.SendMessage(getApi().handle, OS.LB_GETCURSEL, 0, 0);
        }
        int count = (int) OS.SendMessage(getApi().handle, OS.LB_GETSELCOUNT, 0, 0);
        if (count == OS.LB_ERR)
            error(SWT.ERROR_CANNOT_GET_SELECTION);
        if (count == 0)
            return -1;
        int index = (int) OS.SendMessage(getApi().handle, OS.LB_GETCARETINDEX, 0, 0);
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETSEL, index, 0);
        if (result == OS.LB_ERR)
            error(SWT.ERROR_CANNOT_GET_SELECTION);
        if (result != 0)
            return index;
        int[] buffer = new int[1];
        result = (int) OS.SendMessage(getApi().handle, OS.LB_GETSELITEMS, 1, buffer);
        if (result != 1)
            error(SWT.ERROR_CANNOT_GET_SELECTION);
        return buffer[0];
    }
    ...
    public int[] getSelectionIndices() {
        ...
        int length = (int) OS.SendMessage(getApi().handle, OS.LB_GETSELCOUNT, 0, 0);
        if (length == OS.LB_ERR)
            error(SWT.ERROR_CANNOT_GET_SELECTION);
        int[] indices = new int[length];
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETSELITEMS, length, indices);
        if (result != length)
            error(SWT.ERROR_CANNOT_GET_SELECTION);
        return indices;
    }
    ...
    public int getTopIndex() {
        checkWidget();
        return (int) OS.SendMessage(getApi().handle, OS.LB_GETTOPINDEX, 0, 0);
    }
	...
	*/
        ...
        TCHAR buffer = new TCHAR(getCodePage(), string, true);
        do {
            index = (int) OS.SendMessage(getApi().handle, OS.LB_FINDSTRINGEXACT, last = index, buffer);
    ...
    public void remove(int[] indices) {
        ...
        int topIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETTOPINDEX, 0, 0);
        RECT rect = null;
        ...
        while (i < newIndices.length) {
            ...
            if (index != last) {
                ...
                int length = 0;
                if ((getApi().style & SWT.H_SCROLL) != 0) {
                    length = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXTLEN, index, 0);
                    if (length == OS.LB_ERR)
                        break;
                    buffer = new char[length + 1];
                    int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXT, index, buffer);
                ...
                int result = (int) OS.SendMessage(getApi().handle, OS.LB_DELETESTRING, index, 0);
                if (result == OS.LB_ERR)
                    break;
                if ((getApi().style & SWT.H_SCROLL) != 0) {
                    int flags = OS.DT_CALCRECT | OS.DT_SINGLELINE | OS.DT_NOPREFIX;
        ...
        OS.SendMessage(getApi().handle, OS.LB_SETTOPINDEX, topIndex, 0);
    ...
    public void remove(int start, int end) {
        ...
        while (index <= end) {
            ...
            int length = 0;
            if ((getApi().style & SWT.H_SCROLL) != 0) {
                length = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXTLEN, start, 0);
                if (length == OS.LB_ERR)
                    break;
                buffer = new char[length + 1];
                int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXT, start, buffer);
                if (result == OS.LB_ERR)
                    break;
            }
            int result = (int) OS.SendMessage(getApi().handle, OS.LB_DELETESTRING, start, 0);
            if (result == OS.LB_ERR)
                break;
            if ((getApi().style & SWT.H_SCROLL) != 0) {
                OS.DrawText(hDC, buffer, length, rect, flags);
    ...
    public void removeAll() {
        checkWidget();
        OS.SendMessage(getApi().handle, OS.LB_RESETCONTENT, 0, 0);
        if ((getApi().style & SWT.H_SCROLL) != 0) {
            OS.SendMessage(getApi().handle, OS.LB_SETHORIZONTALEXTENT, 0, 0);
        }
    }
    ...
    void select(int index, boolean scroll) {
        ...
        if (scroll) {
            if ((getApi().style & SWT.SINGLE) != 0) {
                OS.SendMessage(getApi().handle, OS.LB_SETCURSEL, index, 0);
            } else {
                OS.SendMessage(getApi().handle, OS.LB_SETSEL, 1, index);
            }
            return;
        }
        int topIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETTOPINDEX, 0, 0);
        RECT itemRect = new RECT(), selectedRect = null;
        OS.SendMessage(getApi().handle, OS.LB_GETITEMRECT, index, itemRect);
        ...
        if ((getApi().style & SWT.SINGLE) != 0) {
            ...
            if (oldIndex != -1) {
                ...
                OS.SendMessage(getApi().handle, OS.LB_GETITEMRECT, oldIndex, selectedRect);
            }
            OS.SendMessage(getApi().handle, OS.LB_SETCURSEL, index, 0);
        } else {
            focusIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETCARETINDEX, 0, 0);
            OS.SendMessage(getApi().handle, OS.LB_SETSEL, 1, index);
        }
        if ((getApi().style & SWT.MULTI) != 0) {
            if (focusIndex != -1) {
                OS.SendMessage(getApi().handle, OS.LB_SETCARETINDEX, focusIndex, 0);
            }
        }
        OS.SendMessage(getApi().handle, OS.LB_SETTOPINDEX, topIndex, 0);
        if (redraw) {
            ...
            OS.InvalidateRect(getApi().handle, itemRect, true);
            if (selectedRect != null) {
                OS.InvalidateRect(getApi().handle, selectedRect, true);
            }
        }
    }
	...
	*/
        ...
        OS.SendMessage(getApi().handle, OS.LB_SELITEMRANGEEX, start, end);
        if (scroll)
            showSelection();
    }
    ...
    public void selectAll() {
        ...
        if ((getApi().style & SWT.SINGLE) != 0)
            return;
        OS.SendMessage(getApi().handle, OS.LB_SETSEL, 1, -1);
    }
    ...
    void setFocusIndex(int index) {
        ...
        if (!(0 <= index && index < count))
            return;
        OS.SendMessage(getApi().handle, OS.LB_SETCARETINDEX, index, 0);
    }
    ...
    public void setItems(String... items) {
        ...
        OS.SetWindowLongPtr(getApi().handle, OS.GWLP_WNDPROC, ListProc);
        boolean redraw = getDrawing() && OS.IsWindowVisible(getApi().handle);
        if (redraw) {
            OS.SendMessage(getApi().handle, OS.WM_SETREDRAW, 0, 0);
        }
        ...
        OS.SendMessage(getApi().handle, OS.LB_RESETCONTENT, 0, 0);
        OS.SendMessage(getApi().handle, OS.LB_INITSTORAGE, length, length * 32);
        int index = 0;
        int cp = getCodePage();
        while (index < length) {
        ...
        if ((getApi().style & SWT.H_SCROLL) != 0) {
            if (newFont != 0)
                OS.SelectObject(hDC, oldFont);
            OS.ReleaseDC(getApi().handle, hDC);
            OS.SendMessage(getApi().handle, OS.LB_SETHORIZONTALEXTENT, newWidth + INSET, 0);
        }
        if (redraw) {
            OS.SendMessage(getApi().handle, OS.WM_SETREDRAW, 1, 0);
            /*
    ...
    void setScrollWidth(int newWidth, boolean grow) {
        newWidth += INSET;
        int width = (int) OS.SendMessage(getApi().handle, OS.LB_GETHORIZONTALEXTENT, 0, 0);
        if (grow) {
            if (newWidth <= width)
                return;
            OS.SendMessage(getApi().handle, OS.LB_SETHORIZONTALEXTENT, newWidth, 0);
        } else {
            if (newWidth < width)
                return;
            setScrollWidth();
    ...
    public void setTopIndex(int index) {
        checkWidget();
        int result = (int) OS.SendMessage(getApi().handle, OS.LB_SETTOPINDEX, index, 0);
        if (result == OS.LB_ERR) {
            int count = (int) OS.SendMessage(getApi().handle, OS.LB_GETCOUNT, 0, 0);
            index = Math.min(count - 1, Math.max(0, index));
            OS.SendMessage(getApi().handle, OS.LB_SETTOPINDEX, index, 0);
        }
    }
    ...
    public void showSelection() {
        ...
        int index;
        if ((getApi().style & SWT.SINGLE) != 0) {
            index = (int) OS.SendMessage(getApi().handle, OS.LB_GETCURSEL, 0, 0);
        } else {
            int[] indices = new int[1];
            int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETSELITEMS, 1, indices);
            index = indices[0];
            if (result != 1)
                index = -1;
        }
        ...
        if (count == 0)
            return;
        int height = (int) OS.SendMessage(getApi().handle, OS.LB_GETITEMHEIGHT, 0, 0);
        forceResize();
        RECT rect = new RECT();
        ...
        OS.SendMessage(getApi().handle, OS.LB_SETTOPINDEX, newTop, 0);
    }
    ...
    void updateMenuLocation(Event event) {
        ...
        if (focusIndex != -1) {
            ...
            int flags = OS.DT_CALCRECT | OS.DT_SINGLELINE | OS.DT_NOPREFIX;
            char[] buffer = new char[64 + 1];
            int length = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXTLEN, focusIndex, 0);
            if (length != OS.LB_ERR) {
                if (length + 1 > buffer.length) {
                    buffer = new char[length + 1];
                }
                int result = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXT, focusIndex, buffer);
                if (result != OS.LB_ERR) {
                    OS.DrawText(hDC, buffer, length, rect, flags);
                }
            }
            ...
            OS.SendMessage(getApi().handle, OS.LB_GETITEMRECT, focusIndex, rect);
    ...
    boolean updateTextDirection(int textDirection) {
        ...
        if (count == OS.LB_ERR)
            return false;
        int selection = (int) OS.SendMessage(getApi().handle, OS.LB_GETCURSEL, 0, 0);
        addedUCC = false;
        while (count-- > 0) {
            int length = (int) OS.SendMessage(getApi().handle, OS.LB_GETTEXTLEN, count, 0);
            if (length == OS.LB_ERR)
                break;
            if (length == 0)
                continue;
            char[] buffer = new char[length + 1];
            if (OS.SendMessage(getApi().handle, OS.LB_GETTEXT, count, buffer) == OS.LB_ERR)
                break;
            if (OS.SendMessage(getApi().handle, OS.LB_DELETESTRING, count, 0) == OS.LB_ERR)
                break;
            if ((getApi().state & HAS_AUTO_DIRECTION) == 0) {
                /* Should remove UCC */
            ...
            if (OS.SendMessage(getApi().handle, OS.LB_INSERTSTRING, count, buffer) == OS.LB_ERR)
                break;
        }
        if (selection != OS.LB_ERR) {
            OS.SendMessage(getApi().handle, OS.LB_SETCURSEL, selection, 0);
        }
    ...
    long windowProc(long hwnd, int msg, long wParam, long lParam) {
        ...
        if (getApi().handle != 0 && lParam != 0 && (getApi().state & HAS_AUTO_DIRECTION) != 0) {
            switch(msg) {
                case OS.LB_ADDSTRING:
                case OS.LB_INSERTSTRING:
                case OS.LB_FINDSTRINGEXACT:
                    // we are always Unicode here
            ...
            if ((bits & OS.LBS_EXTENDEDSEL) != 0) {
                switch((int) wParam) {
                    case OS.VK_SPACE:
                        {
                            int index = (int) OS.SendMessage(getApi().handle, OS.LB_GETCARETINDEX, 0, 0);
                            int code = (int) OS.SendMessage(getApi().handle, OS.LB_GETSEL, index, 0);
                            if (code == OS.LB_ERR)
                                break;
                            OS.SendMessage(getApi().handle, OS.LB_SETSEL, code != 0 ? 0 : 1, index);
                            OS.SendMessage(getApi().handle, OS.LB_SETANCHORINDEX, index, 0);
            ...
            if ((bits & OS.LBS_EXTENDEDSEL) != 0) {
                ...
                switch((int) wParam) {
					...
					*/
                    ...
                    case OS.VK_DOWN:
                        {
                            int oldIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETCARETINDEX, 0, 0);
				...
				*/
					...
					*/
                        ...
                        int oldIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETCARETINDEX, 0, 0);
                        OS.SendMessage(getApi().handle, OS.LB_GETITEMRECT, oldIndex, itemRect);
                        OS.InvalidateRect(getApi().handle, itemRect, true);
                    }
                    OS.SendMessage(getApi().handle, OS.LB_SETCARETINDEX, newIndex, 0);
                    return LRESULT.ZERO;
                }
            }
        }
	...
	*/
        int oldIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETTOPINDEX, 0, 0);
        LRESULT result = super.WM_SIZE(wParam, lParam);
        if (!isDisposed()) {
            SCROLLINFO info = new SCROLLINFO();
            info.cbSize = SCROLLINFO.sizeof;
            info.fMask = OS.SIF_POS;
            if (OS.GetScrollInfo(getApi().handle, OS.SB_HORZ, info)) {
                if (info.nPos != 0)
                    OS.InvalidateRect(getApi().handle, null, true);
            }
            int newIndex = (int) OS.SendMessage(getApi().handle, OS.LB_GETTOPINDEX, 0, 0);
