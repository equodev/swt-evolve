    ...
    public void setVisible(boolean visible) {
        ...
        if (item == null) {
            ...
            if (text.length() != 0) {
                ...
                if ((getApi().style & SWT.ICON_INFORMATION) != 0)
                    icon = OS.TTI_INFO;
                if ((getApi().style & SWT.ICON_WARNING) != 0)
                    icon = OS.TTI_WARNING;
                if ((getApi().style & SWT.ICON_ERROR) != 0)
                    icon = OS.TTI_ERROR;
                ((SwtShell) shell.getImpl()).setToolTipTitle(hwndToolTip, text, icon);
            } else {
        ...
        if (item != null) {
            if (visible) {
                ...
                iconData.uID = ((SwtTrayItem) item.getImpl()).id;
