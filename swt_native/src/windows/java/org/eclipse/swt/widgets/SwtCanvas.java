...
public class SwtCanvas extends SwtComposite implements ICanvas {
    ...
    void scrollInPixels(int destX, int destY, int x, int y, int width, int height, boolean all) {
        ...
        if (findImageControl() != null) {
            ...
            OS.RedrawWindow(getApi().handle, sourceRect, 0, flags);
		...
		*/
            ...
            OS.ScrollWindowEx(getApi().handle, deltaX, deltaY, sourceRect, null, 0, null, flags);
        }
        if (all) {
    ...
    @Override
    TCHAR windowClass() {
        if (((SwtDisplay) display.getImpl()).useOwnDC)
            return ((SwtDisplay) display.getImpl()).windowOwnDCClass;
    ...
    LRESULT WM_IME_COMPOSITION(long wParam, long lParam) {
        if (ime != null) {
            LRESULT result = ((SwtIME) ime.getImpl()).WM_IME_COMPOSITION(wParam, lParam);
            if (result != null)
                return result;
        }
    ...
    LRESULT WM_IME_COMPOSITION_START(long wParam, long lParam) {
        if (ime != null) {
            LRESULT result = ((SwtIME) ime.getImpl()).WM_IME_COMPOSITION_START(wParam, lParam);
            if (result != null)
                return result;
        }
    ...
    LRESULT WM_IME_ENDCOMPOSITION(long wParam, long lParam) {
        if (ime != null) {
            LRESULT result = ((SwtIME) ime.getImpl()).WM_IME_ENDCOMPOSITION(wParam, lParam);
            if (result != null)
                return result;
        }
    ...
    LRESULT WM_INPUTLANGCHANGE(long wParam, long lParam) {
        ...
        if (caret != null && ((SwtCaret) caret.getImpl()).isFocusCaret()) {
            ((SwtCaret) caret.getImpl()).setIMEFont();
            ((SwtCaret) caret.getImpl()).resizeIME();
        }
        return result;
    }
    ...
    LRESULT WM_KEYDOWN(long wParam, long lParam) {
        ...
        if (result != null)
            return result;
        if (ime != null) {
            ((SwtIME) ime.getImpl()).WM_KEYDOWN(wParam, lParam);
        }
        return result;
    }
    ...
    LRESULT WM_KILLFOCUS(long wParam, long lParam) {
        if (ime != null) {
            LRESULT result = ((SwtIME) ime.getImpl()).WM_KILLFOCUS(wParam, lParam);
            if (result != null)
                return result;
        }
    ...
    LRESULT WM_LBUTTONDOWN(long wParam, long lParam) {
        if (ime != null) {
            LRESULT result = ((SwtIME) ime.getImpl()).WM_LBUTTONDOWN(wParam, lParam);
            if (result != null)
                return result;
        }
	...
	*/
        boolean isFocus = (getApi().style & SWT.RIGHT_TO_LEFT) != 0 && caret != null && ((SwtCaret) caret.getImpl()).isFocusCaret();
        if (isFocus)
            ((SwtCaret) caret.getImpl()).setFocus();
        return result;
    }
