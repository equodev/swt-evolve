...
class ButtonSizeTest extends SizeTestBase {
    ...
    void java_size_should_equals_flutter_with_bold(int style, String text, int size, int fontStyle) {
        DartButton w = createButton(style, NoImg, text, size, fontStyle);
        ConfigFlags config = ConfigFlags.use_swt_fonts(size != FromTheme);
        //
        Measure javaSize = ButtonSizes.computeSizes(w, SWT.DEFAULT, SWT.DEFAULT, true);;
        //
    ...
    static DartButton createButton(int style, String image, String text, int size) {
        return createButton(style, image, text, size, SWT.NORMAL);
    }

    static DartButton createButton(int style, String image, String text, int size, int fontStyle) {
        DartButton w = new DartButton(dartShell(), style, null);
