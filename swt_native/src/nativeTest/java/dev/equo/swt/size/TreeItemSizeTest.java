...
class TreeItemSizeTest extends SizeTestBase {
    ...
    void java_size_should_equals_flutter(int style, String image, String text, int size) {
        DartTreeItem w = createTreeItem(style, image, text, size);
        ConfigFlags config = ConfigFlags.use_swt_fonts(size != FromTheme);
        //
        Measure javaSize = TreeItemSizes.computeSizes(w, SWT.DEFAULT, SWT.DEFAULT, true);;
        //
    ...
    void java_size_should_equals_flutter_with_bold(int style, String text, int size, int fontStyle) {
        DartTreeItem w = createTreeItem(style, NoImg, text, size, fontStyle);
        ConfigFlags config = ConfigFlags.use_swt_fonts(size != FromTheme);
        //
        Measure javaSize = TreeItemSizes.computeSizes(w, SWT.DEFAULT, SWT.DEFAULT, true);;
        //
    ...
    static DartTreeItem createTreeItem(int style, String image, String text, int size) {
        return createTreeItem(style, image, text, size, SWT.NORMAL);
    }

    static DartTreeItem createTreeItem(int style, String image, String text, int size, int fontStyle) {
        DartTreeItem w = new DartTreeItem(dartTree(), style, null);
