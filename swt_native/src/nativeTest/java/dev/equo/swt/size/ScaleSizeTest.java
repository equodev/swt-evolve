...
class ScaleSizeTest extends SizeTestBase {
    ...
    void java_size_should_equals_flutter(int style) {
        DartScale w = createScale(style);
        ConfigFlags config = ConfigFlags.use_swt_fonts(false);
        //
        Measure javaSize = ScaleSizes.computeSizes(w, SWT.DEFAULT, SWT.DEFAULT, true);;
        //
    ...
    static DartScale createScale(int style) {
        DartScale w = new DartScale(dartShell(), style, null);
        return w;
    }
