...
public class TreeItem extends Item {
    ...
    TreeItem(Tree parent, TreeItem parentItem, int style, int index, boolean create) {
        this((ITreeItem) null);
        setImpl(Config.isEquo(TreeItem.class, parent) ? new DartTreeItem(parent, parentItem, style, index, create, this) : new SwtTreeItem(parent, parentItem, style, index, create, this));
    }
