...
public final class DartFont extends DartResource implements IFont {
    ...
    public boolean equals(Object object) {
        if (object != null && !(((Font) object).getImpl() instanceof DartFont))
            return java.util.Arrays.equals(this.getApi().getFontData(), ((Font) object).getFontData());
    ...
    public FontData[] getFontData() {
        ...
        for (int i = 0; i < fontData.length; i++) {
            result[i] = new FontData(fontData[i].getName(), fontData[i].getHeight(), fontData[i].getStyle());
        }
        return result;
    }
