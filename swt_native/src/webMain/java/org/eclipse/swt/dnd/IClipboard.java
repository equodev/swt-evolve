...
public interface IClipboard extends ImplClipboard {
     ...
     * @since 3.132
     */
    CompletableFuture<Object> getContentsAsync(Transfer transfer);
     ...
     * @since 3.132
     */
    CompletableFuture<Object> getContentsAsync(Transfer transfer, int clipboards);
