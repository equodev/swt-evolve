 ...
 */
public abstract class DartTransfer implements ITransfer {
    ...
    protected VTransfer value;

    public VTransfer getValue() {
        if (value == null)
            value = new VTransfer(this);
        return (VTransfer) value;
    }

    public DartTransfer(Transfer api) {
        setApi(api);
    }
}
