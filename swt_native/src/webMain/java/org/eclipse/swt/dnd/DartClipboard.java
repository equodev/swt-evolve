 ...
 */
public class DartClipboard implements IClipboard {
     ...
     */
    public DartClipboard(Display display, Clipboard api) {
        setApi(api);
        checkSubclass();
        if (display == null) {
    ...
    public void checkSubclass() {
        ...
        String validName = DartClipboard.class.getName();
    ...
    String[] availableTypeNames = new String[0];

    TransferData[] availableTypes = new TransferData[0];
    ...
    public String[] _availableTypeNames() {
        return availableTypeNames;
    }

    public TransferData[] _availableTypes() {
    ...
    protected VClipboard value;

    public VClipboard getValue() {
        if (value == null)
            value = new VClipboard(this);
        return (VClipboard) value;
    }
}
