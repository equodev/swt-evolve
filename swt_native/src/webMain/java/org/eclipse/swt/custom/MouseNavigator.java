...
class MouseNavigator {
    ...
    void onMouseDown(Event e) {
        ...
        if (!parent.isVisible() || !parent.getEnabled() || ((DartStyledText) parent.getImpl()).middleClickPressed) {
            return;
        }
    ...
    private Point getMouseLocation() {
        final Point cursorLocation = DartDisplay.getCurrent().getCursorLocation();
