 ...
 * @since 3.8
 */
public class DartTreeCursor extends DartCanvas implements ITreeCursor {
     ...
     * @see Widget#getStyle()
     */
    public DartTreeCursor(Tree parent, int style, TreeCursor api) {
    ...
    public TreeItem _row() {
        return row;
    }

    public TreeColumn _column() {
        return column;
    }
    ...
    public Listener _treeListener() {
        return treeListener;
    }

    public Listener _resizeListener() {
        return resizeListener;
    }

    public Listener _disposeItemListener() {
        return disposeItemListener;
    }

    public Listener _disposeColumnListener() {
        return disposeColumnListener;
    }
    ...
    public TreeCursor getApi() {
        if (api == null)
            api = TreeCursor.createApi(this);
        return (TreeCursor) api;
    }

    public VTreeCursor getValue() {
        if (value == null)
            value = new VTreeCursor(this);
        return (VTreeCursor) value;
    }
}
