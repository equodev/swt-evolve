...
public class DartAnimatedProgress extends DartCanvas implements IAnimatedProgress {
     ...
     */
    @Deprecated
    public DartAnimatedProgress(Composite parent, int style, AnimatedProgress api) {
    ...
    public AnimatedProgress getApi() {
        if (api == null)
            api = AnimatedProgress.createApi(this);
        return (AnimatedProgress) api;
    }

    public VAnimatedProgress getValue() {
        if (super.value == null)
            super.value = new VAnimatedProgress(this);
        return (VAnimatedProgress) super.value;
    }
}
