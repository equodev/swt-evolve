 ...
 */
public final class DartPDFDocument extends DartDevice implements IPDFDocument {
     ...
     * @see #getBounds()
     */
    public DartPDFDocument(String filename, PageSize pageSize, PDFDocument api) {
     ...
     * @see #getBounds()
     */
    public DartPDFDocument(String filename, double widthInPoints, double heightInPoints, PDFDocument api) {
    ...
    public long _pdfContext() {
        return pdfContext;
    }

    public boolean _isGCCreated() {
        return isGCCreated;
    }

    public boolean _pageStarted() {
        return pageStarted;
    }
    ...
    public double _widthInPoints() {
        return widthInPoints;
    }

    public double _heightInPoints() {
        return heightInPoints;
    }
    ...
    public VPDFDocument getValue() {
        if (value == null)
            value = new VPDFDocument(this);
        return (VPDFDocument) value;
    }
}
