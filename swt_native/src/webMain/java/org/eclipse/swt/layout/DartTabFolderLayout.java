 ...
 * @since 3.128
 */
public class DartTabFolderLayout extends DartLayout implements ITabFolderLayout {
    ...
    public TabFolderLayout getApi() {
        if (api == null)
            api = TabFolderLayout.createApi(this);
        return (TabFolderLayout) api;
    }

    public DartTabFolderLayout(TabFolderLayout api) {
        super(api);
    }
}
