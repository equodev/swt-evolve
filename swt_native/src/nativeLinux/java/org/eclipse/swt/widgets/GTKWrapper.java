 ...
 * Generated for SWT version 3.134.0.
 *
 * This class provides static methods that delegate to the correct GTK implementation
 * based on the SWT version being used. SwtEmbeddedBridge uses this class exclusively
...
public class GTKWrapper {
    ...
    public static void setupThreadLocking() {
        OS.swt_set_lock_functions();
        GDK.gdk_threads_init();
        GDK.gdk_threads_enter();
    }

    public static boolean gtk_init_check(long[] argc, long[] argv) {
        return GTK3.gtk_init_check(argc, argv);
    }

    public static boolean gtk_init_check() {
        return GTK4.gtk_init_check();
    }
}
