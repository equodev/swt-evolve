 ...
 *  @see Transfer
 */
public abstract class DartByteArrayTransfer extends DartTransfer implements IByteArrayTransfer {
    ...
    public VByteArrayTransfer getValue() {
        if (value == null)
            value = new VByteArrayTransfer(this);
        return (VByteArrayTransfer) value;
    }

    public DartByteArrayTransfer(ByteArrayTransfer api) {
        super(api);
    }
}
