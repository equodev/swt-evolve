...
public final class DartPrinter extends DartDevice implements IPrinter {
     ...
     * @see Device#dispose
     */
    public DartPrinter(Printer api) {
        this(null, api);
    }
     ...
     * @see Device#dispose
     */
    public DartPrinter(PrinterData data, Printer api) {
    ...
    public VPrinter getValue() {
        if (value == null)
            value = new VPrinter(this);
        return (VPrinter) value;
    }
}
