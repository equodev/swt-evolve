 ...
 */
public abstract class DartDialog implements IDialog {
     ...
     * </ul>
     */
    public DartDialog(Shell parent, Dialog api) {
     ...
     */
    public DartDialog(Shell parent, int style, Dialog api) {
        setApi(api);
        checkParent(parent);
        this.parent = parent;
        this.style = style;
    ...
    static int checkStyle(Shell parent, int style) {
        ...
        return DartWidget.checkBits(style, SWT.LEFT_TO_RIGHT, SWT.RIGHT_TO_LEFT, 0, 0, 0, 0);
    }
    ...
    protected int openDialogWithFlutter(Object value, int fallback) {
        ...
        DisplayBridge bridge = display != null ? ((DartDisplay) display.getImpl()).displayBridge : null;
    ...
    protected VDialog value;

    public VDialog getValue() {
        if (value == null)
            value = new VDialog(this);
        return (VDialog) value;
    }
}
