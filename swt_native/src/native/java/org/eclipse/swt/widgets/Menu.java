...
public class Menu extends Widget {
    ...
    public Menu(Control parent) {
        this((IMenu) null);
        setImpl(new DartMenu(parent, this));
    }
    ...
    public Menu(Decorations parent, int style) {
        this((IMenu) null);
        setImpl(new DartMenu(parent, style, this));
    }
    ...
    public Menu(Menu parentMenu) {
        this((IMenu) null);
        setImpl(new DartMenu(parentMenu, this));
    }
    ...
    public Menu(MenuItem parentItem) {
        this((IMenu) null);
        setImpl(new DartMenu(parentItem, this));
    }

    Menu(Display display) {
        this((IMenu) null);
        setImpl(new DartMenu(display, this));
    }
