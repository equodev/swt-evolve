...
public class Shell extends Decorations {
    ...
    public Shell(int style) {
        this((IShell) null);
        setImpl(new DartShell(style, this));
    }
    ...
    public Shell(Display display) {
        this((IShell) null);
        setImpl(new DartShell(display, this));
    }
    ...
    public Shell(Display display, int style) {
        this((IShell) null);
        setImpl(new DartShell(display, style, this));
    }

    Shell(Display display, Shell parent, int style, long handle, boolean embedded) {
        this((IShell) null);
        setImpl(new DartShell(display, parent, style, handle, embedded, this));
    }
    ...
    public Shell(Shell parent) {
        this((IShell) null);
        setImpl(new DartShell(parent, this));
    }
    ...
    public Shell(Shell parent, int style) {
        this((IShell) null);
        setImpl(new DartShell(parent, style, this));
    }
    ...
    public static Shell internal_new(Display display, long handle) {
        return DartShell.internal_new(display, handle);
    }
