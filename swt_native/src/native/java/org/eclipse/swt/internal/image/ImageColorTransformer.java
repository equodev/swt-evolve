...
public interface ImageColorTransformer {
    ...
    public static final ImageColorTransformer DEFAULT_DISABLED_IMAGE_TRANSFORMER = switch(IMAGE_DISABLEMENT_ALGORITHM) {
        ...
        case IMAGE_DISABLEMENT_ALGORITHM_DESATURATED ->
            ImageColorTransformer.forSaturationBrightness(0.2f, 0.9f, 0.5f);
        default ->
            ImageColorTransformer.forGrayscaledContrastBrightness(0.2f, 2.9f);
    };
