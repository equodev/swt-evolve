...
public class DartTableCursor extends DartCanvas implements ITableCursor {
     ...
     * @see Widget#getStyle()
     */
    public DartTableCursor(Table parent, int style, TableCursor api) {
    ...
    public TableItem _row() {
        return row;
    }

    public TableColumn _column() {
        return column;
    }
    ...
    public Listener _tableListener() {
    ...
    public TableCursor getApi() {
        if (api == null)
            api = TableCursor.createApi(this);
        return (TableCursor) api;
    }

    public VTableCursor getValue() {
        if (value == null)
            value = new VTableCursor(this);
        return (VTableCursor) value;
    }
}
