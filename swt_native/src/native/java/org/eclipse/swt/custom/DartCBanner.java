 ...
 */
public class DartCBanner extends DartComposite implements ICBanner {
     ...
     * </ul>
     */
    public DartCBanner(Composite parent, int style, CBanner api) {
...
*/
    ...
    public void setRightMinimumSize(Point size) {
        ...
        this.rightMinimumSize = newValue;
        layout(false);
    }
    ...
    Point rightMinimumSize;

    public Control _left() {
        return left;
    }

    public Control _right() {
        return right;
    }

    public Control _bottom() {
        return bottom;
    }
    ...
    public int _curveStart() {
        return curveStart;
    }

    public Rectangle _curveRect() {
        return curveRect;
    }

    public int _curve_width() {
        return curve_width;
    }

    public int _curve_indent() {
        return curve_indent;
    }

    public int _rightWidth() {
        return rightWidth;
    }

    public int _rightMinWidth() {
        return rightMinWidth;
    }

    public int _rightMinHeight() {
        return rightMinHeight;
    }
    ...
    public int _rightDragDisplacement() {
        return rightDragDisplacement;
    }
    ...
    public Point _rightMinimumSize() {
        return rightMinimumSize;
    }
    ...
    public CBanner getApi() {
        if (api == null)
            api = CBanner.createApi(this);
        return (CBanner) api;
    }

    public VCBanner getValue() {
        if (value == null)
            value = new VCBanner(this);
        return (VCBanner) value;
    }
}
