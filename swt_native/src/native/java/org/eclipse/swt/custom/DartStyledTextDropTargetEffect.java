 ...
 * @since 3.3
 */
public class DartStyledTextDropTargetEffect extends DartDropTargetEffect implements IStyledTextDropTargetEffect {
     ...
     */
    public DartStyledTextDropTargetEffect(StyledText styledText, StyledTextDropTargetEffect api) {
    ...
    public void dragOver(DropTargetEvent event) {
        ...
        if ((effect & DND.FEEDBACK_SELECT) != 0) {
            ...
            int newOffset = ((DartStyledText) text.getImpl()).getOffsetAtPoint(pt.x, pt.y, trailing, false);
    ...
    public Listener _paintListener() {
        return paintListener;
    }

    public StyledTextDropTargetEffect getApi() {
        if (api == null)
            api = StyledTextDropTargetEffect.createApi(this);
        return (StyledTextDropTargetEffect) api;
    }
}
