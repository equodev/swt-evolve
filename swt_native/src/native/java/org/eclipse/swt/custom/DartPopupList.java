 ...
 */
public class DartPopupList implements IPopupList {
     ...
     */
    public DartPopupList(Shell parent, PopupList api) {
        this(parent, 0, api);
    }
     ...
     * @since 3.0
     */
    public DartPopupList(Shell parent, int style, PopupList api) {
        setApi(api);
    ...
    protected VPopupList value;

    public VPopupList getValue() {
        if (value == null)
            value = new VPopupList(this);
        return (VPopupList) value;
    }
}
