...
public final class Font extends Resource {
    ...
    Font(Device device) {
        this((IFont) null);
        setImpl(new DartFont(device, this));
    }
    ...
    public Font(Device device, FontData fd) {
        this((IFont) null);
        setImpl(new DartFont(device, fd, this));
    }
    ...
    public Font(Device device, FontData[] fds) {
        this((IFont) null);
        setImpl(new DartFont(device, fds, this));
    }
    ...
    public Font(Device device, String name, int height, int style) {
        this((IFont) null);
        setImpl(new DartFont(device, name, height, style, this));
    }
