...
public final class Cursor extends Resource {
    ...
    Cursor(Device device) {
        this((ICursor) null);
        setImpl(new DartCursor(device, this));
    }
    ...
    public Cursor(Device device, int style) {
        this((ICursor) null);
        setImpl(new DartCursor(device, style, this));
    }
    ...
    public Cursor(Device device, ImageData source, ImageData mask, int hotspotX, int hotspotY) {
        this((ICursor) null);
        setImpl(new DartCursor(device, source, mask, hotspotX, hotspotY, this));
    }
    ...
    public Cursor(Device device, ImageData source, int hotspotX, int hotspotY) {
        this((ICursor) null);
        setImpl(new DartCursor(device, source, hotspotX, hotspotY, this));
    }
    ...
    public Cursor(Device device, ImageDataProvider imageDataProvider, int hotspotX, int hotspotY) {
        this((ICursor) null);
        setImpl(new DartCursor(device, imageDataProvider, hotspotX, hotspotY, this));
    }
