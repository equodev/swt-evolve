...
public final class Color extends Resource {
    ...
    Color(Device device) {
        this((IColor) null);
        setImpl(new DartColor(device, this));
    }
    ...
    public Color(Device device, int red, int green, int blue) {
        this((IColor) null);
        setImpl(new DartColor(device, red, green, blue, this));
    }
    ...
    public Color(int red, int green, int blue) {
        this((IColor) null);
        setImpl(new DartColor(red, green, blue, this));
    }
    ...
    public Color(Device device, int red, int green, int blue, int alpha) {
        this((IColor) null);
        setImpl(new DartColor(device, red, green, blue, alpha, this));
    }
    ...
    public Color(int red, int green, int blue, int alpha) {
        this((IColor) null);
        setImpl(new DartColor(red, green, blue, alpha, this));
    }
    ...
    public Color(Device device, RGB rgb) {
        this((IColor) null);
        setImpl(new DartColor(device, rgb, this));
    }
    ...
    public Color(RGB rgb) {
        this((IColor) null);
        setImpl(new DartColor(rgb, this));
    }
    ...
    public Color(Device device, RGBA rgba) {
        this((IColor) null);
        setImpl(new DartColor(device, rgba, this));
    }
    ...
    public Color(RGBA rgba) {
        this((IColor) null);
        setImpl(new DartColor(rgba, this));
    }
    ...
    public Color(Device device, RGB rgb, int alpha) {
        this((IColor) null);
        setImpl(new DartColor(device, rgb, alpha, this));
    }
    ...
    public Color(RGB rgb, int alpha) {
        this((IColor) null);
        setImpl(new DartColor(rgb, alpha, this));
    }
