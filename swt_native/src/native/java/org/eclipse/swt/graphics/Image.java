...
public final class Image extends Resource implements Drawable {
    ...
    Image(Device device) {
        this((IImage) null);
        setImpl(new DartImage(device, this));
    }
    ...
    public Image(Device device, Image srcImage, int flag) {
        this((IImage) null);
        setImpl(new DartImage(device, srcImage, flag, this));
    }
    ...
    public Image(Device device, Rectangle bounds) {
        this((IImage) null);
        setImpl(new DartImage(device, bounds, this));
    }
    ...
    public Image(Device device, ImageData data) {
        this((IImage) null);
        setImpl(new DartImage(device, data, this));
    }
    ...
    public Image(Device device, ImageData source, ImageData mask) {
        this((IImage) null);
        setImpl(new DartImage(device, source, mask, this));
    }
    ...
    public Image(Device device, InputStream stream) {
        this((IImage) null);
        setImpl(new DartImage(device, stream, this));
    }
    ...
    public Image(Device device, String filename) {
        this((IImage) null);
        setImpl(new DartImage(device, filename, this));
    }
    ...
    public Image(Device device, ImageFileNameProvider imageFileNameProvider) {
        this((IImage) null);
        setImpl(new DartImage(device, imageFileNameProvider, this));
    }
    ...
    public Image(Device device, ImageDataProvider imageDataProvider) {
        this((IImage) null);
        setImpl(new DartImage(device, imageDataProvider, this));
    }
    ...
    public Image(Device device, ImageGcDrawer imageGcDrawer, int width, int height) {
        this((IImage) null);
        setImpl(new DartImage(device, imageGcDrawer, width, height, this));
    }
    ...
    public static void drawAtSize(GC gc, ImageData imageData, int width, int height) {
        DartImage.drawAtSize(gc, imageData, width, height);
    }
