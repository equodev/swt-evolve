 ...
 */
public final class DartGridLayout extends DartLayout implements IGridLayout {

    /**
     * Constructs a new instance of this class
     * with a single column.
     */
    public DartGridLayout(GridLayout api) {
        super(api);
    }
     ...
     * @since 2.0
     */
    public DartGridLayout(int numColumns, boolean makeColumnsEqualWidth, GridLayout api) {
        super(api);
