...
public class COM extends OS {
    ...
    //$NON-NLS-1$
    public static final GUID CLSID_DestinationList = IIDFromString("{77f10cf0-3db5-4966-b520-b7c54fd35ed6}");

    //$NON-NLS-1$
    public static final GUID CLSID_DragDropHelper = COM.IIDFromString("{4657278A-411B-11d2-839A-00C04FD918D0}");

    //$NON-NLS-1$
    public static final GUID CLSID_EnumerableObjectCollection = IIDFromString("{2d3468c1-36a7-43b6-ac24-d3f02fd9607a}");

    //$NON-NLS-1$
    public static final GUID CLSID_FileOpenDialog = IIDFromString("{DC1C5A9C-E88A-4dde-A5A1-60F82A20AEF7}");

    //$NON-NLS-1$
    public static final GUID CLSID_FileSaveDialog = IIDFromString("{C0B4E2F3-BA21-4773-8DBA-335EC946EB8B}");

    //$NON-NLS-1$
    public static final GUID CLSID_ShellLink = IIDFromString("{00021401-0000-0000-C000-000000000046}");

    //$NON-NLS-1$
    public static final GUID CLSID_TaskbarList = IIDFromString("{56FDF344-FD6D-11d0-958A-006097C9A090}");

    //$NON-NLS-1$
    public static final GUID CLSID_TF_InputProcessorProfiles = IIDFromString("{33C53A50-F456-4884-B049-85FD643ECFED}");

    //$NON-NLS-1$
    public static final GUID GUID_TFCAT_TIP_KEYBOARD = IIDFromString("{34745C63-B2F0-4784-8B67-5E12C8701A31}");

    //$NON-NLS-1$
    public static final GUID IID_ICustomDestinationList = IIDFromString("{6332debf-87b5-4670-90c0-5e57b408a49e}");

    //$NON-NLS-1$
    public static final GUID IID_IDropTargetHelper = COM.IIDFromString("{4657278B-411B-11D2-839A-00C04FD918D0}");

    //$NON-NLS-1$
    public static final GUID IID_IFileOpenDialog = IIDFromString("{d57c7288-d4ad-4768-be02-9d969532d960}");

    //$NON-NLS-1$
    public static final GUID IID_IFileSaveDialog = IIDFromString("{84bccd23-5fde-4cdb-aea4-af64b83d78ab}");

    public static final GUID IID_IMLangFontLink2 = IIDFromString("{DCCFC162-2B38-11d2-B7EC-00C04F8F5D9A}");

    //$NON-NLS-1$
    public static final GUID IID_IObjectArray = IIDFromString("{92CA9DCD-5622-4bba-A805-5E9F541BD8C9}");

    //$NON-NLS-1$
    public static final GUID IID_IObjectCollection = IIDFromString("{5632b1a4-e38a-400a-928a-d4cd63230295}");

    //$NON-NLS-1$
    public static final GUID IID_IPropertyStore = IIDFromString("{886d8eeb-8cf2-4446-8d02-cdba1dbdcf99}");

    //$NON-NLS-1$
    public static final GUID IID_IShellItem = IIDFromString("{43826d1e-e718-42ee-bc55-a1e261c37bfe}");

    //$NON-NLS-1$
    public static final GUID IID_IShellLinkW = IIDFromString("{000214F9-0000-0000-C000-000000000046}");

    //$NON-NLS-1$
    public static final GUID IID_ITaskbarList3 = IIDFromString("{ea1afb91-9e28-4b86-90e9-9e9f8a5eefaf}");

    //$NON-NLS-1$
    public static final GUID IID_ITfDisplayAttributeProvider = IIDFromString("{fee47777-163c-4769-996a-6e9c50ad8f54}");

    //$NON-NLS-1$
    public static final GUID IID_ITfInputProcessorProfiles = IIDFromString("{1F02B6C5-7842-4EE6-8A0B-9A24183A95CA}");
    ...
    IIDIHTMLDocumentEvents2 = /*IIDFromString(*/
    ...
    //$NON-NLS-1$
    public static final GUID IID_ICoreWebView2Environment2 = IIDFromString("{41F3632B-5EF4-404F-AD82-2D606C5A9A21}");

    //$NON-NLS-1$
    public static final GUID IID_ICoreWebView2_2 = IIDFromString("{9E8F0CF8-E670-4B5E-B2BC-73E061E3184C}");

    //$NON-NLS-1$
    public static final GUID IID_ICoreWebView2_10 = IIDFromString("{B1690564-6F5A-4983-8E48-31D1143FECDB}");

    //$NON-NLS-1$
    public static final GUID IID_ICoreWebView2_11 = IIDFromString("{0BE78E56-C193-4051-B943-23B460C08BDB}");

    //$NON-NLS-1$
    public static final GUID IID_ICoreWebView2_12 = IIDFromString("{35D69927-BCFA-4566-9349-6B3E0D154CAC}");

    //$NON-NLS-1$
    public static final GUID IID_ICoreWebView2_13 = IIDFromString("{F75F09A8-667E-4983-88D6-C8773F315E84}");
