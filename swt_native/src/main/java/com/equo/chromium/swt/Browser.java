...
public class Browser extends Composite {
     ...
     * @since 3.0
     */
    private static final ProxyCreator CHROMIUM =
            new ProxyCreator(IBrowser.class, "com.equo.chromium", "com.equo.chromium.swt.Browser");

    public Browser(Composite parent, int style) {
        this((IBrowser) null);
        setImpl(Config.isEquo(Browser.class, parent) ? new DartBrowser(parent, style, this)
                : CHROMIUM.createProxy(parent, style));
    }
