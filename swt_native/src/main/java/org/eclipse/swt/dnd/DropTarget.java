 ...
 */
public class DropTarget extends SWTWidget {
    ...
    static {
        //$NON-NLS-1$
        Drag_Motion = new Callback(DropTarget.class, "Drag_Motion", 5);
        //$NON-NLS-1$
     ...
     *  @see DND#DROP_LINK
     */
    public DropTarget(SWTControl control, int style) {
        ...
        if (GTK.GTK4) {
            ...
            dragOverHeartbeat = () -> {
                SWTControl control1 = DropTarget.this.control;
