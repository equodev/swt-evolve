...
class WebKit extends WebBrowser {
    ...
    // $NON-NLS-1$
    static final byte[] SWT_PROTOCOL = Converter.wcsToMbcs("swt", true);

    // $NON-NLS-1$
    static final byte[] JSON_MIME_TYPE = Converter.wcsToMbcs("application/json", true);
    ...
    // Used for events like keyboard/mouse input. See Bug 528549 and Bug 533833.
    ...
    void updateUserScript() {
        ...
        if (!functions.isEmpty()) {
            ...
            long script = WebKitGTK.webkit_user_script_new(scriptData, WebKitGTK.WEBKIT_USER_SCRIPT_INJECT_AT_DOCUMENT_START, WebKitGTK.WEBKIT_USER_CONTENT_INJECT_TOP_FRAME, 0, 0);
    ...
    long webViewProc(long handle, long user_data) {
        switch((int) user_data) {
            case CLOSE_WEB_VIEW:
                return webkit_close_web_view(handle);
            case WEB_VIEW_READY:
                return webkit_web_view_ready(handle);
            default:
                return 0;
        }
    }
    ...
    long webViewProc(long handle, long arg0, long user_data) {
        switch((int) user_data) {
            case CREATE_WEB_VIEW:
                return webkit_create_web_view(handle, arg0);
            case LOAD_CHANGED:
                return webkit_load_changed(handle, (int) arg0, user_data);
            case NOTIFY_PROGRESS:
                return webkit_notify_progress(handle, arg0);
            case NOTIFY_TITLE:
                return webkit_notify_title(handle, arg0);
            case AUTHENTICATE:
                return webkit_authenticate(handle, arg0);
            default:
                return 0;
        }
    }
    ...
    long webViewProc(long handle, long arg0, long arg1, long user_data) {
        switch((int) user_data) {
            // Webkit2 only.
            case MOUSE_TARGET_CHANGED:
                return webkit_mouse_target_changed(handle, arg0, arg1);
            case DECIDE_POLICY:
                return webkit_decide_policy(handle, arg0, (int) arg1, user_data);
            default:
                return 0;
        }
    }
    ...
    long webViewProc(long handle, long arg0, long arg1, long arg2, long user_data) {
        switch((int) user_data) {
            case CONTEXT_MENU:
                return webkit_context_menu(handle, arg0, arg1, arg2);
            case LOAD_FAILED_TLS:
                return webkit_load_failed_tls(handle, arg0, arg1, arg2);
            default:
                return 0;
        }
    }
	...
	*/
    ...
    boolean close(boolean showPrompters) {
        ...
        // $NON-NLS-1$
        String functionName = EXECUTE_ID + "CLOSE";
        // $NON-NLS-1$
	 ...
	 */
        try {
            // $NON-NLS-1$ // $NON-NLS-2$
            result = (Boolean) evaluate("return " + functionName + "(window);");
            // Default to assume that webkit is disposed and allow disposal of Browser.
            if (result == null)
                return true;
        } catch (SWTException e) {
            // Permit browser to be disposed if javascript execution failed.
            return true;
        }
    ...
    private static class Webkit2AsyncToSync {
        ...
        // Only called directly from C (from javascript).
        ...
        private static void runjavascript_callback(long GObject_source, long GAsyncResult, long user_data) {
            ...
            if (retObj != null) {
                // retObj can be null if there was a timeout.
                // GError **
        ...
        // Callback only called only by C directly
        @SuppressWarnings("unused")
        ...
        static boolean setCookie(String cookieUrl, String cookieValue) {
            ...
            Consumer<Integer> asyncFunc = (callbackID) -> WebKitGTK.webkit_cookie_manager_add_cookie(cookieManager, soupCookie, 0, setCookie_callback.getAddress(), callbackID);
		 ...
		 * triggers.
		 */
            Consumer<Integer> asyncFunc = (callbackID) -> WebKitGTK.webkit_cookie_manager_get_cookies(cookieManager, uri, 0, getCookie_callback.getAddress(), GDBus.convertJavaToGVariant(new Object[] { cookieName, callbackID }));
    ...
    public Object evaluate(String script) throws SWTException {
        if ("".equals(script)) {
            // A litte optimization. Sometimes evaluate() is called with a generated script, where the generated script is sometimes empty.
            return null;
        }
        if (!isJavascriptEnabled()) {
            return null;
	...
	*/
        ...
        if (isMouseEvent) {
            ...
            //WebKitGTK.webkit_dom_mouse_event_get_related_target (event) != 0;
	...
	*/
        ...
        if (type.equals(DOMEVENT_KEYDOWN) || type.equals(DOMEVENT_KEYPRESS) || type.equals(DOMEVENT_KEYUP)) {
            return handleKeyEvent(type, ((Double) arguments[1]).intValue(), ((Double) arguments[2]).intValue(), ((Boolean) arguments[3]).booleanValue(), ((Boolean) arguments[4]).booleanValue(), ((Boolean) arguments[5]).booleanValue(), ((Boolean) arguments[6]).booleanValue());
        }
        return handleMouseEvent(type, ((Double) arguments[1]).intValue(), ((Double) arguments[2]).intValue(), ((Double) arguments[3]).intValue(), (arguments[4] != null ? ((Double) arguments[4]).intValue() : 0) + 1, ((Boolean) arguments[5]).booleanValue(), ((Boolean) arguments[6]).booleanValue(), ((Boolean) arguments[7]).booleanValue(), ((Boolean) arguments[8]).booleanValue(), ((Boolean) arguments[9]).booleanValue());
    }
	...
	*/
    ...
    public boolean setText(String html, boolean trusted) {
        ...
        //$NON-NLS-1$
        byte[] html_bytes = (html + '\0').getBytes(StandardCharsets.UTF_8);
	...
	*/
        try {
            ...
            try {
                new URL(testUrl);
                url = testUrl;
                /* adding the protocol made the url valid */
	...
	*/
        ...
        if (postData != null) {
            ...
            // Webkit 2 only
            final int lastRequest = w2_bug527738LastRequestCounter.incrementAndGet();
            Thread send_request = new Thread(() -> {
                ...
                try {
                    ...
                    // MalformedURLException is an IOException also.
                    html = e.getMessage();
                } finally {
                    if (html != null && lastRequest == w2_bug527738LastRequestCounter.get()) {
                        ...
                        SWTDisplay.getDefault().syncExec(() -> {
                            ...
                            // as per glib/tests/keyfile:test_bytes()..
    ...
    long webkit_create_web_view(long web_view, long frame) {
        ...
        try {
            // running evaluate() inside openWindowListener and waiting for return leads to deadlock. Bug 512001
            nonBlockingEvaluate++;
