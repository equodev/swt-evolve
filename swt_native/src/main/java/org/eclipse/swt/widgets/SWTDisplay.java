 ...
 */
public class SWTDisplay extends Device implements Executor, IDisplay {
    ...
    long snapshotDrawProc, keyPressReleaseProc, focusProc, windowActiveProc, enterMotionProc, leaveProc, scrollProc, resizeProc, activateProc, gesturePressReleaseProc;
    ...
    Callback snapshotDraw, keyPressReleaseCallback, focusCallback, windowActiveCallback, enterMotionCallback, computeSizeCallback, scrollCallback, leaveCallback, resizeCallback, activateCallback, gesturePressReleaseCallback;
    ...
    // events are dispatched outside SWT, e.g. when system dialog is open
    ...
    /* Modality */
    SWTShell[] modalShells;

    SWTDialog modalDialog;
    ...
    SWTControl focusControl;

    SWTShell activeShell;
    ...
    SWTControl imControl;

    long preeditWindow, preeditLabel;

    /* Sync/Async Widget Communication */
    SWTSynchronizer synchronizer = new SWTSynchronizer(this);
    ...
    private class SessionManagerListener implements SessionManagerDBus.IListener {
        ...
        public SessionManagerListener(SWTDisplay parent) {
            this.parent = parent;
        }
    ...
    { GDK.GDK_Alt_L, SWT.ALT }, { GDK.GDK_Alt_R, SWT.ALT }, { GDK.GDK_Meta_L, SWT.ALT }, { GDK.GDK_Meta_R, SWT.ALT }, { GDK.GDK_Shift_L, SWT.SHIFT }, { GDK.GDK_Shift_R, SWT.SHIFT }, { GDK.GDK_Control_L, SWT.CONTROL }, { GDK.GDK_Control_R, SWT.CONTROL }, { GDK.GDK_ISO_Level3_Shift, SWT.ALT_GR }, //		{OS.GDK_????,		SWT.COMMAND},
    //		{OS.GDK_????,		SWT.COMMAND},
    /* Non-Numeric Keypad Keys */
    { GDK.GDK_Up, SWT.ARROW_UP }, { GDK.GDK_KP_Up, SWT.ARROW_UP }, { GDK.GDK_Down, SWT.ARROW_DOWN }, { GDK.GDK_KP_Down, SWT.ARROW_DOWN }, { GDK.GDK_Left, SWT.ARROW_LEFT }, { GDK.GDK_KP_Left, SWT.ARROW_LEFT }, { GDK.GDK_Right, SWT.ARROW_RIGHT }, { GDK.GDK_KP_Right, SWT.ARROW_RIGHT }, { GDK.GDK_Page_Up, SWT.PAGE_UP }, { GDK.GDK_KP_Page_Up, SWT.PAGE_UP }, { GDK.GDK_Page_Down, SWT.PAGE_DOWN }, { GDK.GDK_KP_Page_Down, SWT.PAGE_DOWN }, { GDK.GDK_Home, SWT.HOME }, { GDK.GDK_KP_Home, SWT.HOME }, { GDK.GDK_End, SWT.END }, { GDK.GDK_KP_End, SWT.END }, { GDK.GDK_Insert, SWT.INSERT }, { GDK.GDK_KP_Insert, SWT.INSERT }, /* Virtual and Ascii Keys */
    { GDK.GDK_BackSpace, SWT.BS }, { GDK.GDK_Return, SWT.CR }, { GDK.GDK_Delete, SWT.DEL }, { GDK.GDK_KP_Delete, SWT.DEL }, { GDK.GDK_Escape, SWT.ESC }, { GDK.GDK_Linefeed, SWT.LF }, { GDK.GDK_Tab, SWT.TAB }, { GDK.GDK_ISO_Left_Tab, SWT.TAB }, /* Functions Keys */
    { GDK.GDK_F1, SWT.F1 }, { GDK.GDK_F2, SWT.F2 }, { GDK.GDK_F3, SWT.F3 }, { GDK.GDK_F4, SWT.F4 }, { GDK.GDK_F5, SWT.F5 }, { GDK.GDK_F6, SWT.F6 }, { GDK.GDK_F7, SWT.F7 }, { GDK.GDK_F8, SWT.F8 }, { GDK.GDK_F9, SWT.F9 }, { GDK.GDK_F10, SWT.F10 }, { GDK.GDK_F11, SWT.F11 }, { GDK.GDK_F12, SWT.F12 }, { GDK.GDK_F13, SWT.F13 }, { GDK.GDK_F14, SWT.F14 }, { GDK.GDK_F15, SWT.F15 }, { GDK.GDK_F16, SWT.F16 }, { GDK.GDK_F17, SWT.F17 }, { GDK.GDK_F18, SWT.F18 }, { GDK.GDK_F19, SWT.F19 }, { GDK.GDK_F20, SWT.F20 }, /* Numeric Keypad Keys */
    { GDK.GDK_KP_Multiply, SWT.KEYPAD_MULTIPLY }, { GDK.GDK_KP_Add, SWT.KEYPAD_ADD }, { GDK.GDK_KP_Enter, SWT.KEYPAD_CR }, { GDK.GDK_KP_Subtract, SWT.KEYPAD_SUBTRACT }, { GDK.GDK_KP_Decimal, SWT.KEYPAD_DECIMAL }, { GDK.GDK_KP_Divide, SWT.KEYPAD_DIVIDE }, { GDK.GDK_KP_0, SWT.KEYPAD_0 }, { GDK.GDK_KP_1, SWT.KEYPAD_1 }, { GDK.GDK_KP_2, SWT.KEYPAD_2 }, { GDK.GDK_KP_3, SWT.KEYPAD_3 }, { GDK.GDK_KP_4, SWT.KEYPAD_4 }, { GDK.GDK_KP_5, SWT.KEYPAD_5 }, { GDK.GDK_KP_6, SWT.KEYPAD_6 }, { GDK.GDK_KP_7, SWT.KEYPAD_7 }, { GDK.GDK_KP_8, SWT.KEYPAD_8 }, { GDK.GDK_KP_9, SWT.KEYPAD_9 }, { GDK.GDK_KP_Equal, SWT.KEYPAD_EQUAL }, /* Other keys */
    { GDK.GDK_Caps_Lock, SWT.CAPS_LOCK }, { GDK.GDK_Num_Lock, SWT.NUM_LOCK }, { GDK.GDK_Scroll_Lock, SWT.SCROLL_LOCK }, { GDK.GDK_Pause, SWT.PAUSE }, { GDK.GDK_Break, SWT.BREAK }, { GDK.GDK_Print, SWT.PRINT_SCREEN }, { GDK.GDK_Help, SWT.HELP } };
    ...
    /* Multiple Displays. */
    static SWTDisplay Default;

    static SWTDisplay[] Displays = new SWTDisplay[1];

    /* Skinning support */
    SWTWidget[] skinList = new SWTWidget[GROW_SIZE];
    ...
    {
        trimWidths[TRIM_NONE] = 0;
        trimHeights[TRIM_NONE] = 0;
        trimWidths[TRIM_BORDER] = 4;
        trimHeights[TRIM_BORDER] = 4;
        trimWidths[TRIM_RESIZE] = 6;
        trimHeights[TRIM_RESIZE] = 6;
        trimWidths[TRIM_TITLE_BORDER] = 5;
        trimHeights[TRIM_TITLE_BORDER] = 28;
        trimWidths[TRIM_TITLE_RESIZE] = 6;
        trimHeights[TRIM_TITLE_RESIZE] = 29;
        trimWidths[TRIM_TITLE] = 0;
        trimHeights[TRIM_TITLE] = 23;
        //$NON-NLS-1$
...
*/
    ...
    void addLayoutDeferred(SWTComposite comp) {
        if (layoutDeferred == null)
            layoutDeferred = new SWTComposite[64];
        if (layoutDeferredCount == layoutDeferred.length) {
            SWTComposite[] temp = new SWTComposite[layoutDeferred.length + 64];
    ...
    private void gdbus_init_methods() {
        GDBusMethod[] methods = { new GDBusMethod(// FileOpen call can be reached via:
        ...
        "FileOpen", new String[][] { { OS.DBUS_TYPE_STRING_ARRAY, "A String array containing file paths or URLs for OpenDocument/OpenUrl signal" } }, new String[0][0], (args) -> {
            ...
            for (int i = 0; i < fileNames.length; i++) {
                ...
                try {
                    if (new URI(fileNames[i]).getScheme() != null) {
                        // For specs, see: https://docs.oracle.com/javase/8/docs/api/java/net/URI.html
    ...
    void addPopup(SWTMenu menu) {
        if (popups == null)
            popups = new SWTMenu[4];
        ...
        if (index == length) {
            SWTMenu[] newPopups = new SWTMenu[length + 4];
    ...
    void addSkinnableWidget(SWTWidget widget) {
        if (skinCount >= skinList.length) {
            SWTWidget[] newSkinWidgets = new SWTWidget[(skinList.length + 1) * 3 / 2];
    ...
    long cellDataProc(long tree_column, long cell, long tree_model, long iter, long data) {
        SWTWidget widget = (SWTWidget) (getWidget(data));
        if (widget == null)
            return 0;
    ...
    void clearModal(SWTShell shell) {
        if (modalShells == null)
            return;
        ...
        if (index == 0 && modalShells[0] == null)
            modalShells = null;
        SWTShell[] shells = (SWTShell[]) (getShells());
    ...
    void createDisplay(DeviceData data) {
        ...
        if (GTK.GTK4) {
            if (rendererSnapshotProc == 0) {
                //$NON-NLS-1$
                rendererSnapshotCallback = new Callback(getClass(), "rendererSnapshotProc", 6);
                rendererSnapshotProc = rendererSnapshotCallback.getAddress();
            }
        } else {
            if (rendererRenderProc == 0) {
                //$NON-NLS-1$
                rendererRenderCallback = new Callback(getClass(), "rendererRenderProc", 6);
                rendererRenderProc = rendererRenderCallback.getAddress();
            }
        }
        if (rendererGetPreferredWidthProc == 0) {
            //$NON-NLS-1$
            rendererGetPreferredWidthCallback = new Callback(getClass(), "rendererGetPreferredWidthProc", 4);
        ...
        if (text_renderer_type == 0) {
            ...
            //$NON-NLS-1$
            byte[] type_name = Converter.wcsToMbcs("SwtTextRenderer", true);
	 ...
	 */
        if (!GTK.GTK4) {
            if (pixbuf_renderer_type == 0) {
                ...
                //$NON-NLS-1$
                byte[] type_name = Converter.wcsToMbcs("SwtPixbufRenderer", true);
            ...
            if (toggle_renderer_type == 0) {
                ...
                //$NON-NLS-1$
                byte[] type_name = Converter.wcsToMbcs("SwtToggleRenderer", true);
        ...
        //$NON-NLS-1$
        keysChangedCallback = new Callback(this, "keysChangedProc", 2);
    ...
    static void deregister(SWTDisplay display) {
        synchronized (Device.class) {
            for (int i = 0; i < Displays.length; i++) {
     ...
     */
    public static SWTDisplay findDisplay(Thread thread) {
        synchronized (Device.class) {
            for (int i = 0; i < Displays.length; i++) {
                SWTDisplay display = (SWTDisplay) (Displays[i]);
	...
	*/
     ...
     */
    public IWidget findWidget(long handle) {
        checkDevice();
     ...
     * @since 3.1
     */
    public IWidget findWidget(long handle, long id) {
        checkDevice();
        return null;
    }
     ...
     * @since 3.3
     */
    public IWidget findWidget(IWidget widget__, long id) {
        SWTWidget widget_ = (SWTWidget) widget__;
        SWTWidget widget = (SWTWidget) widget_;
        checkDevice();
        return null;
    }
    ...
    void snapshotDrawProc(long handle, long snapshot) {
        SWTDisplay display = (SWTDisplay) (getCurrent());
     ...
     */
    public static SWTDisplay getCurrent() {
	...
	*/
     ...
     * </ul>
     */
    public IControl getCursorControl() {
        checkDevice();
    ...
    Point getCursorLocationInPixels() {
		 ...
		 */
            if (OS.isWayland() && activeShell != null) {
                SWTShell tempShell = (SWTShell) (activeShell);
                int[] offsetX = new int[1], offsetY = new int[1];
                while (((SWTComposite) (tempShell.getParent())) != null) {
                    GTK3.gtk_window_get_position(tempShell.shellHandle, offsetX, offsetY);
                    x[0] += offsetX[0];
                    y[0] += offsetY[0];
                    tempShell = ((SWTShell) (tempShell.getParent().getShell()));
                }
            }
        }
     ...
     */
    public static SWTDisplay getDefault() {
        synchronized (Device.class) {
            if (Default == null)
                Default = new SWTDisplay();
            return Default;
        }
    }
     ...
     * </ul>
     */
    public IControl getFocusControl() {
        checkDevice();
    ...
    public IMonitor[] getMonitors() {
        checkDevice();
        SWTMonitor[] monitors = (SWTMonitor[]) (null);
        ...
        if (display != 0) {
            ...
            if (monitorCount > 0) {
                monitors = new SWTMonitor[monitorCount];
                GdkRectangle geometry = new GdkRectangle();
                for (int i = 0; i < monitorCount; i++) {
                    ...
                    SWTMonitor monitor = new SWTMonitor();
        ...
        if (monitors == null) {
            ...
            monitors = new SWTMonitor[] { monitor };
        }
        return monitors;
    }
    ...
    public IMonitor getPrimaryMonitor() {
        ...
        checkDevice();
        SWTMonitor[] monitors = (SWTMonitor[]) (getMonitors());
    ...
    public IShell[] getShells() {
            ...
            if (!widget.isDisposed()) {
                ...
                if (j == index) {
                    if (index == result.length) {
                        SWTShell[] newResult = new SWTShell[index + 16];
                        System.arraycopy(result, 0, newResult, 0, index);
                        result = newResult;
                    }
                    result[index++] = (SWTShell) widget;
                }
            } else {
        ...
        if (index == result.length)
            return result;
        SWTShell[] newResult = new SWTShell[index];
        System.arraycopy(result, 0, newResult, 0, index);
        return newResult;
    }
    ...
    public Color getSystemColor(int id) {
        ...
        switch(id) {
            case SWT.COLOR_LINK_FOREGROUND:
                gdkRGBA = copyRGBA(COLOR_LINK_FOREGROUND_RGBA);
                break;
            case SWT.COLOR_INFO_FOREGROUND:
                gdkRGBA = copyRGBA(COLOR_INFO_FOREGROUND_RGBA);
                break;
            case SWT.COLOR_INFO_BACKGROUND:
                gdkRGBA = copyRGBA(COLOR_INFO_BACKGROUND_RGBA);
                break;
            case SWT.COLOR_TITLE_FOREGROUND:
                gdkRGBA = copyRGBA(COLOR_TITLE_FOREGROUND_RGBA);
                break;
            case SWT.COLOR_TITLE_BACKGROUND:
                gdkRGBA = copyRGBA(COLOR_TITLE_BACKGROUND_RGBA);
                break;
            case SWT.COLOR_TITLE_BACKGROUND_GRADIENT:
                gdkRGBA = copyRGBA(COLOR_TITLE_BACKGROUND_GRADIENT_RGBA);
                break;
            case SWT.COLOR_TITLE_INACTIVE_FOREGROUND:
                gdkRGBA = copyRGBA(COLOR_TITLE_INACTIVE_FOREGROUND_RGBA);
                break;
            case SWT.COLOR_TITLE_INACTIVE_BACKGROUND:
                gdkRGBA = copyRGBA(COLOR_TITLE_INACTIVE_BACKGROUND_RGBA);
                break;
            ...
            case SWT.COLOR_WIDGET_NORMAL_SHADOW:
                gdkRGBA = copyRGBA(COLOR_WIDGET_NORMAL_SHADOW_RGBA);
                break;
            case SWT.COLOR_WIDGET_LIGHT_SHADOW:
                gdkRGBA = copyRGBA(COLOR_WIDGET_LIGHT_SHADOW_RGBA);
                break;
            case SWT.COLOR_WIDGET_HIGHLIGHT_SHADOW:
                gdkRGBA = copyRGBA(COLOR_WIDGET_HIGHLIGHT_SHADOW_RGBA);
                break;
            case SWT.COLOR_WIDGET_BACKGROUND:
                gdkRGBA = copyRGBA(COLOR_WIDGET_BACKGROUND_RGBA);
                break;
            case SWT.COLOR_WIDGET_FOREGROUND:
                gdkRGBA = copyRGBA(COLOR_WIDGET_FOREGROUND_RGBA);
                break;
            case SWT.COLOR_WIDGET_BORDER:
                gdkRGBA = copyRGBA(COLOR_WIDGET_BORDER_RGBA);
                break;
            case SWT.COLOR_LIST_FOREGROUND:
                gdkRGBA = copyRGBA(COLOR_LIST_FOREGROUND_RGBA);
                break;
            case SWT.COLOR_LIST_BACKGROUND:
                gdkRGBA = copyRGBA(COLOR_LIST_BACKGROUND_RGBA);
                break;
            case SWT.COLOR_LIST_SELECTION:
                gdkRGBA = copyRGBA(COLOR_LIST_SELECTION_RGBA);
                break;
            case SWT.COLOR_LIST_SELECTION_TEXT:
                gdkRGBA = copyRGBA(COLOR_LIST_SELECTION_TEXT_RGBA);
                break;
            case SWT.COLOR_WIDGET_DISABLED_FOREGROUND:
                gdkRGBA = copyRGBA(COLOR_WIDGET_DISABLED_FOREGROUND_RGBA);
                break;
            case SWT.COLOR_TEXT_DISABLED_BACKGROUND:
                gdkRGBA = copyRGBA(COLOR_TEXT_DISABLED_BACKGROUND_RGBA);
                break;
            default:
    ...
    public Image getSystemImage(int id) {
        ...
        switch(id) {
            case SWT.ICON_ERROR:
                if (errorImage == null) {
                    //$NON-NLS-1$
                    errorImage = createImage("dialog-error-symbolic");
                }
                return errorImage;
            ...
            case SWT.ICON_WORKING:
                if (infoImage == null) {
                    //$NON-NLS-1$
                    infoImage = createImage("dialog-information-symbolic");
                }
                return infoImage;
            case SWT.ICON_QUESTION:
                if (questionImage == null) {
                    //$NON-NLS-1$
                    questionImage = createImage("dialog-question-symbolic");
                }
                return questionImage;
            case SWT.ICON_WARNING:
                if (warningImage == null) {
                    //$NON-NLS-1$
                    warningImage = createImage("dialog-warning-symbolic");
                }
                return warningImage;
        }
        return null;
	...
	*/
     ...
     * @since 3.6
     */
    public ITaskBar getSystemTaskBar() {
        checkDevice();
        return null;
    }
     ...
     * @since 3.0
     */
    public ITray getSystemTray() {
        checkDevice();
        if (tray != null)
            return tray;
        return tray = new SWTTray(this, SWT.NONE);
    }
    ...
    void initializeCallbacks() {
        closures = new long[SWTWidget.LAST_SIGNAL];
        closuresCount = new int[SWTWidget.LAST_SIGNAL];
        closuresProc = new long[SWTWidget.LAST_SIGNAL];
        signalIds = new int[SWTWidget.LAST_SIGNAL];
        /* Cache signals for GtkWidget */
        signalIds[SWTWidget.BUTTON_PRESS_EVENT] = OS.g_signal_lookup(OS.button_press_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.BUTTON_RELEASE_EVENT] = OS.g_signal_lookup(OS.button_release_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.CONFIGURE_EVENT] = OS.g_signal_lookup(OS.configure_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.DELETE_EVENT] = OS.g_signal_lookup(OS.delete_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.ENTER_NOTIFY_EVENT] = OS.g_signal_lookup(OS.enter_notify_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.EVENT_AFTER] = OS.g_signal_lookup(OS.event_after, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.EXPOSE_EVENT] = OS.g_signal_lookup(OS.draw, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.EXPOSE_EVENT_INVERSE] = OS.g_signal_lookup(OS.draw, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.FOCUS] = OS.g_signal_lookup(OS.focus, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.FOCUS_IN_EVENT] = OS.g_signal_lookup(OS.focus_in_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.FOCUS_OUT_EVENT] = OS.g_signal_lookup(OS.focus_out_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.GRAB_FOCUS] = OS.g_signal_lookup(OS.grab_focus, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.HIDE] = OS.g_signal_lookup(OS.hide, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.KEY_PRESS_EVENT] = OS.g_signal_lookup(OS.key_press_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.KEY_RELEASE_EVENT] = OS.g_signal_lookup(OS.key_release_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.LEAVE_NOTIFY_EVENT] = OS.g_signal_lookup(OS.leave_notify_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.MAP] = OS.g_signal_lookup(OS.map, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.MAP_EVENT] = OS.g_signal_lookup(OS.map_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.MNEMONIC_ACTIVATE] = OS.g_signal_lookup(OS.mnemonic_activate, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.MOTION_NOTIFY_EVENT] = OS.g_signal_lookup(OS.motion_notify_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.COMPUTE_SIZE] = OS.g_signal_lookup(OS.compute_size, GTK.GTK_TYPE_WIDGET());
        /*
	 ...
	 */
        if (OS.SWT_MENU_LOCATION_DEBUGGING) {
            ...
            signalIds[SWTWidget.POPPED_UP] = OS.g_signal_lookup(OS.popped_up, menuType);
        } else {
            signalIds[SWTWidget.POPPED_UP] = 0;
        }
        signalIds[SWTWidget.POPUP_MENU] = OS.g_signal_lookup(OS.popup_menu, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.REALIZE] = OS.g_signal_lookup(OS.realize, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.SCROLL_EVENT] = OS.g_signal_lookup(OS.scroll_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.SHOW] = OS.g_signal_lookup(OS.show, GTK.GTK_TYPE_WIDGET());
        if (!GTK.GTK4)
            signalIds[SWTWidget.SHOW_HELP] = OS.g_signal_lookup(OS.show_help, GTK.GTK_TYPE_WIDGET());
        if (!GTK.GTK4)
            signalIds[SWTWidget.SIZE_ALLOCATE] = OS.g_signal_lookup(OS.size_allocate, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.STYLE_UPDATED] = OS.g_signal_lookup(OS.style_updated, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.UNMAP] = OS.g_signal_lookup(OS.unmap, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.UNMAP_EVENT] = OS.g_signal_lookup(OS.unmap_event, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.UNREALIZE] = OS.g_signal_lookup(OS.realize, GTK.GTK_TYPE_WIDGET());
        signalIds[SWTWidget.WINDOW_STATE_EVENT] = OS.g_signal_lookup(OS.window_state_event, GTK.GTK_TYPE_WIDGET());
        //$NON-NLS-1$
        windowCallback2 = new Callback(this, "windowProc", 2);
        windowProc2 = windowCallback2.getAddress();
        if (GTK.GTK4) {
            //$NON-NLS-1$
            snapshotDraw = new Callback(this, "snapshotDrawProc", void.class, new Type[] { long.class, long.class });
            snapshotDrawProc = snapshotDraw.getAddress();
            keyPressReleaseCallback = new Callback(this, "keyPressReleaseProc", boolean.class, new Type[] { long.class, int.class, int.class, int.class, //$NON-NLS-1$
            long.class });
            keyPressReleaseProc = keyPressReleaseCallback.getAddress();
            //$NON-NLS-1$
            focusCallback = new Callback(this, "focusProc", void.class, new Type[] { long.class, long.class });
            focusProc = focusCallback.getAddress();
            //$NON-NLS-1$
            windowActiveCallback = new Callback(this, "windowActiveProc", void.class, new Type[] { long.class, long.class });
            windowActiveProc = windowActiveCallback.getAddress();
            enterMotionCallback = new Callback(this, "enterMotionProc", void.class, new Type[] { long.class, double.class, double.class, //$NON-NLS-1$
            long.class });
            enterMotionProc = enterMotionCallback.getAddress();
            scrollCallback = new Callback(this, "scrollProc", boolean.class, new Type[] { long.class, double.class, double.class, //$NON-NLS-1$
            long.class });
            scrollProc = scrollCallback.getAddress();
            gesturePressReleaseCallback = new Callback(this, "gesturePressReleaseProc", void.class, new Type[] { long.class, int.class, double.class, double.class, //$NON-NLS-1$
            long.class });
            gesturePressReleaseProc = gesturePressReleaseCallback.getAddress();
            //$NON-NLS-1$
            leaveCallback = new Callback(this, "leaveProc", void.class, new Type[] { long.class, long.class });
            leaveProc = leaveCallback.getAddress();
            //$NON-NLS-1$
            resizeCallback = new Callback(this, "resizeProc", void.class, new Type[] { long.class, int.class, int.class });
            resizeProc = resizeCallback.getAddress();
            //$NON-NLS-1$
            activateCallback = new Callback(this, "activateProc", void.class, new Type[] { long.class, long.class, long.class });
            activateProc = activateCallback.getAddress();
            //$NON-NLS-1$
            computeSizeCallback = new Callback(this, "computeSizeProc", void.class, new Type[] { long.class, long.class, long.class });
            computeSizeProc = computeSizeCallback.getAddress();
        }
        notifyCallback = new Callback(this, "notifyProc", long.class, new Type[] { long.class, long.class, //$NON-NLS-1$
        long.class });
        notifyProc = notifyCallback.getAddress();
        closuresProc[SWTWidget.NOTIFY_STATE] = notifyProc;
        closuresProc[SWTWidget.DPI_CHANGED] = notifyProc;
        closuresProc[SWTWidget.ACTIVATE] = windowProc2;
        closuresProc[SWTWidget.ACTIVATE_INVERSE] = windowProc2;
        closuresProc[SWTWidget.CHANGED] = windowProc2;
        closuresProc[SWTWidget.CLICKED] = windowProc2;
        closuresProc[SWTWidget.CLOSE_REQUEST] = windowProc2;
        closuresProc[SWTWidget.CREATE_MENU_PROXY] = windowProc2;
        closuresProc[SWTWidget.DAY_SELECTED] = windowProc2;
        closuresProc[SWTWidget.DAY_SELECTED_DOUBLE_CLICK] = windowProc2;
        closuresProc[SWTWidget.HIDE] = windowProc2;
        closuresProc[SWTWidget.GRAB_FOCUS] = windowProc2;
        closuresProc[SWTWidget.MAP] = windowProc2;
        closuresProc[SWTWidget.MONTH_CHANGED] = windowProc2;
        closuresProc[SWTWidget.OUTPUT] = windowProc2;
        closuresProc[SWTWidget.POPUP_MENU] = windowProc2;
        closuresProc[SWTWidget.PREEDIT_CHANGED] = windowProc2;
        closuresProc[SWTWidget.REALIZE] = windowProc2;
        closuresProc[SWTWidget.SELECT] = windowProc2;
        closuresProc[SWTWidget.SELECTION_DONE] = windowProc2;
        closuresProc[SWTWidget.SHOW] = windowProc2;
        closuresProc[SWTWidget.START_INTERACTIVE_SEARCH] = windowProc2;
        closuresProc[SWTWidget.STYLE_UPDATED] = windowProc2;
        closuresProc[SWTWidget.VALUE_CHANGED] = windowProc2;
        closuresProc[SWTWidget.UNMAP] = windowProc2;
        closuresProc[SWTWidget.UNREALIZE] = windowProc2;
        closuresProc[SWTWidget.BACKSPACE] = windowProc2;
        closuresProc[SWTWidget.BACKSPACE_INVERSE] = windowProc2;
        closuresProc[SWTWidget.COPY_CLIPBOARD] = windowProc2;
        closuresProc[SWTWidget.COPY_CLIPBOARD_INVERSE] = windowProc2;
        closuresProc[SWTWidget.CUT_CLIPBOARD] = windowProc2;
        closuresProc[SWTWidget.CUT_CLIPBOARD_INVERSE] = windowProc2;
        closuresProc[SWTWidget.PASTE_CLIPBOARD] = windowProc2;
        closuresProc[SWTWidget.PASTE_CLIPBOARD_INVERSE] = windowProc2;
        //$NON-NLS-1$
        windowCallback3 = new Callback(this, "windowProc", 3);
        windowProc3 = windowCallback3.getAddress();
        closuresProc[SWTWidget.BUTTON_PRESS_EVENT] = windowProc3;
        closuresProc[SWTWidget.BUTTON_PRESS_EVENT_INVERSE] = windowProc3;
        closuresProc[SWTWidget.BUTTON_RELEASE_EVENT] = windowProc3;
        closuresProc[SWTWidget.BUTTON_RELEASE_EVENT_INVERSE] = windowProc3;
        closuresProc[SWTWidget.COMMIT] = windowProc3;
        closuresProc[SWTWidget.CONFIGURE_EVENT] = windowProc3;
        closuresProc[SWTWidget.DELETE_EVENT] = windowProc3;
        closuresProc[SWTWidget.ENTER_NOTIFY_EVENT] = windowProc3;
        closuresProc[SWTWidget.EVENT_AFTER] = windowProc3;
        closuresProc[SWTWidget.EXPOSE_EVENT] = windowProc3;
        closuresProc[SWTWidget.EXPOSE_EVENT_INVERSE] = windowProc3;
        closuresProc[SWTWidget.FOCUS] = windowProc3;
        closuresProc[SWTWidget.FOCUS_IN_EVENT] = windowProc3;
        closuresProc[SWTWidget.FOCUS_OUT_EVENT] = windowProc3;
        closuresProc[SWTWidget.KEY_PRESS_EVENT] = windowProc3;
        closuresProc[SWTWidget.KEY_RELEASE_EVENT] = windowProc3;
        closuresProc[SWTWidget.INPUT] = windowProc3;
        closuresProc[SWTWidget.LEAVE_NOTIFY_EVENT] = windowProc3;
        closuresProc[SWTWidget.MAP_EVENT] = windowProc3;
        closuresProc[SWTWidget.MNEMONIC_ACTIVATE] = windowProc3;
        closuresProc[SWTWidget.MOTION_NOTIFY_EVENT] = windowProc3;
        closuresProc[SWTWidget.MOTION_NOTIFY_EVENT_INVERSE] = windowProc3;
        closuresProc[SWTWidget.MOVE_FOCUS] = windowProc3;
        closuresProc[SWTWidget.POPULATE_POPUP] = windowProc3;
        closuresProc[SWTWidget.SCROLL_EVENT] = windowProc3;
        closuresProc[SWTWidget.SHOW_HELP] = windowProc3;
        closuresProc[SWTWidget.SIZE_ALLOCATE] = windowProc3;
        closuresProc[SWTWidget.TOGGLED] = windowProc3;
        closuresProc[SWTWidget.UNMAP_EVENT] = windowProc3;
        closuresProc[SWTWidget.WINDOW_STATE_EVENT] = windowProc3;
        closuresProc[SWTWidget.DIRECTION_CHANGED] = windowProc3;
        //$NON-NLS-1$
        windowCallback4 = new Callback(this, "windowProc", 4);
        windowProc4 = windowCallback4.getAddress();
        closuresProc[SWTWidget.DELETE_RANGE] = windowProc4;
        closuresProc[SWTWidget.DELETE_TEXT] = windowProc4;
        closuresProc[SWTWidget.ICON_RELEASE] = windowProc4;
        closuresProc[SWTWidget.ROW_ACTIVATED] = windowProc4;
        closuresProc[SWTWidget.SCROLL_CHILD] = windowProc4;
        closuresProc[SWTWidget.STATUS_ICON_POPUP_MENU] = windowProc4;
        closuresProc[SWTWidget.SWITCH_PAGE] = windowProc4;
        closuresProc[SWTWidget.TEST_COLLAPSE_ROW] = windowProc4;
        closuresProc[SWTWidget.TEST_EXPAND_ROW] = windowProc4;
        closuresProc[SWTWidget.ROW_HAS_CHILD_TOGGLED] = windowProc4;
        closuresProc[SWTWidget.DELETE_FROM_CURSOR] = windowProc4;
        closuresProc[SWTWidget.DELETE_FROM_CURSOR_INVERSE] = windowProc4;
        closuresProc[SWTWidget.SIZE_ALLOCATE_GTK4] = windowProc4;
        //$NON-NLS-1$
	 ...
	 */
        //$NON-NLS-1$
        changeValue = new Callback(this, "changeValue", boolean.class, new Type[] { long.class, int.class, double.class, long.class });
        changeValueProc = changeValue.getAddress();
        closuresProc[SWTWidget.CHANGE_VALUE] = changeValueProc;
        closuresProc[SWTWidget.EXPAND_COLLAPSE_CURSOR_ROW] = windowProc5;
        closuresProc[SWTWidget.INSERT_TEXT] = windowProc5;
        closuresProc[SWTWidget.TEXT_BUFFER_INSERT_TEXT] = windowProc5;
        closuresProc[SWTWidget.MOVE_CURSOR] = windowProc5;
        closuresProc[SWTWidget.MOVE_CURSOR_INVERSE] = windowProc5;
        if (signalIds[SWTWidget.POPPED_UP] != 0) {
            //$NON-NLS-1$
            windowCallback6 = new Callback(this, "windowProc", 6);
            windowProc6 = windowCallback6.getAddress();
            closuresProc[SWTWidget.POPPED_UP] = windowProc6;
        }
        for (int i = 0; i < SWTWidget.LAST_SIGNAL; i++) {
            if (closuresProc[i] != 0) {
     ...
     * @since 2.1.2
     */
    public Point map(IControl from__, IControl to__, Point point) {
     ...
     * @since 2.1.2
     */
    public Point map(IControl from__, IControl to__, int x, int y) {
        SWTControl to_ = (SWTControl) to__;
        SWTControl from_ = (SWTControl) from__;
        SWTControl to = (SWTControl) to_;
        SWTControl from = (SWTControl) from_;
    ...
    Point mapInPixels(SWTControl from, SWTControl to, int x, int y) {
        checkDevice();
        if (from != null && from.isDisposed())
            error(SWT.ERROR_INVALID_ARGUMENT);
        if (to != null && to.isDisposed())
    ...
    Rectangle mapInPixels(SWTControl from, SWTControl to, Rectangle rectangle) {
        checkDevice();
        if (rectangle == null)
            error(SWT.ERROR_NULL_ARGUMENT);
    ...
    Rectangle mapInPixels(SWTControl from, SWTControl to, int x, int y, int width, int height) {
        checkDevice();
        if (from != null && from.isDisposed())
            error(SWT.ERROR_INVALID_ARGUMENT);
        if (to != null && to.isDisposed())
        ...
        synchronized (Device.class) {
            ...
            switch(type) {
				 ...
				 */
                        ...
                        switch(modifier) {
                            case SWT.SHIFT:
                                state |= GDK.GDK_SHIFT_MASK;
                                break;
                            case SWT.ALT:
                                state |= GDK.GDK_MOD1_MASK;
                                break;
                            case SWT.CONTROL:
                                state |= GDK.GDK_CONTROL_MASK;
                                break;
                            case SWT.ALT_GR:
                                state |= GDK.GDK_MOD5_MASK;
                                break;
                            default:
	...
	*/
    ...
    static void register(SWTDisplay display) {
        synchronized (Device.class) {
            for (int i = 0; i < Displays.length; i++) {
                if (Displays[i] == null) {
                    Displays[i] = display;
            ...
            SWTDisplay[] newDisplays = new SWTDisplay[Displays.length + 4];
    ...
    protected void release() {
        try (ExceptionStash exceptions = new ExceptionStash()) {
            ...
            for (SWTShell shell : ((SWTShell[]) (getShells()))) {
                try {
                    if (!shell.isDisposed())
                        shell.dispose();
                } catch (Error | RuntimeException ex) {
    ...
    void releaseDisplay() {
        windowCallback2.dispose();
        windowCallback2 = null;
        windowCallback3.dispose();
        windowCallback3 = null;
        windowCallback4.dispose();
        windowCallback4 = null;
        windowCallback5.dispose();
        windowCallback5 = null;
        if (windowCallback6 != null) {
            windowCallback6.dispose();
            windowCallback6 = null;
        }
        ...
        checkIfEventCallback.dispose();
        checkIfEventCallback = null;
        checkIfEventProc = 0;
        ...
        sizeAllocateCallback.dispose();
        sizeAllocateCallback = null;
        sizeAllocateProc = 0;
        sizeRequestCallback.dispose();
        sizeRequestCallback = null;
        sizeRequestProc = 0;
        /* Dispose the shell map callback */
        shellMapCallback.dispose();
        shellMapCallback = null;
        shellMapProc = 0;
        /* Dispose the run async messages callback */
        idleCallback.dispose();
        idleCallback = null;
        idleProc = 0;
        if (idleHandle != 0)
        ...
        cellDataCallback.dispose();
        cellDataCallback = null;
        cellDataProc = 0;
        /* Dispose the set direction callback */
        setDirectionCallback.dispose();
        setDirectionCallback = null;
        setDirectionProc = 0;
        /* Dispose the emission proc callback */
        emissionProcCallback.dispose();
        emissionProcCallback = null;
        emissionProc = 0;
        /* Dispose the set direction callback */
        allChildrenCallback.dispose();
        allChildrenCallback = null;
        allChildrenProc = 0;
    ...
    String dumpWidgetTableInfo() {
        ...
        IdentityHashMap<SWTWidget, Collection<Integer>> disposed = new IdentityHashMap<>();
        for (int i = 0; i < widgetTable.length; i++) {
            SWTWidget w = (SWTWidget) (widgetTable[i]);
        ...
        if (!disposed.isEmpty()) {
            ...
            Set<Entry<SWTWidget, Collection<Integer>>> set = disposed.entrySet();
            for (Entry<SWTWidget, Collection<Integer>> entry : set) {
	...
	*/
    ...
    boolean runDeferredLayouts() {
        if (layoutDeferredCount != 0) {
            SWTComposite[] temp = (SWTComposite[]) (layoutDeferred);
            int count = layoutDeferredCount;
            layoutDeferred = null;
            layoutDeferredCount = 0;
            for (int i = 0; i < count; i++) {
                SWTComposite comp = (SWTComposite) (temp[i]);
                if (!comp.isDisposed())
    ...
    boolean runSettings() {
        ...
        SWTShell[] shells = (SWTShell[]) (getShells());
        for (int i = 0; i < shells.length; i++) {
            SWTShell shell = (SWTShell) (shells[i]);
            if (!shell.isDisposed()) {
                shell.fixStyle();
                shell.redraw(true);
    ...
    boolean runSkin() {
        if (skinCount > 0) {
            SWTWidget[] oldSkinWidgets = (SWTWidget[]) (skinList);
            int count = skinCount;
            skinList = new SWTWidget[GROW_SIZE];
            skinCount = 0;
            if (eventTable != null && eventTable.hooks(SWT.Skin)) {
                for (int i = 0; i < count; i++) {
                    SWTWidget widget = (SWTWidget) (oldSkinWidgets[i]);
                    if (widget != null && !widget.isDisposed()) {
                        widget.state &= ~SWTWidget.SKIN_NEEDED;
                        oldSkinWidgets[i] = null;
                        Event event = new Event();
                        event.widget = Widget.getInstance(widget);
    ...
    public void setData(String key, Object value) {
        ...
        if (key.equals(SET_MODAL_DIALOG)) {
            setModalDialog((SWTDialog) value);
            return;
        }
    ...
    void setModalDialog(SWTDialog modalDailog) {
        this.modalDialog = modalDailog;
        SWTShell[] shells = (SWTShell[]) (getShells());
        for (int i = 0; i < shells.length; i++) shells[i].updateModal();
    }

    void setModalShell(SWTShell shell) {
        if (modalShells == null)
            modalShells = new SWTShell[4];
        int index = 0, length = modalShells.length;
        while (index < length) {
            if (modalShells[index] == shell)
                return;
        ...
        if (index == length) {
            SWTShell[] newModalShells = new SWTShell[length + 4];
     ...
     * </ul>
     */
    public void setSynchronizer(ISynchronizer synchronizer__) {
        SWTSynchronizer synchronizer_ = (SWTSynchronizer) synchronizer__;
        SWTSynchronizer synchronizer = (SWTSynchronizer) synchronizer_;
        checkDevice();
        if (synchronizer == null)
            error(SWT.ERROR_NULL_ARGUMENT);
        if (synchronizer == this.synchronizer)
            return;
        SWTSynchronizer oldSynchronizer;
        synchronized (Device.class) {
    ...
    void showIMWindow(SWTControl control) {
        imControl = control;
        if (preeditWindow == 0) {
        ...
        if (preeditString[0] != 0 && C.strlen(preeditString[0]) > 0) {
            SWTControl widget = (SWTControl) (control.findBackgroundControl());
            if (widget == null)
                widget = control;
    ...
    long caretProc(long clientData) {
		 ...
		 */
            ((SWTCanvas) (currentCaret.getParent())).blink = true;
            if (GTK.GTK4) {
 ...
 */
    ...
    long sizeAllocateProc(long handle, long arg0, long user_data) {
        SWTWidget widget = (SWTWidget) (getWidget(user_data));
        if (widget == null)
            return 0;
    ...
    private void sendJDKInternalEvent(int eventType, int detail) {
        ...
        Event event = new Event();
        event.detail = detail;
        event.display = Display.getInstance(this);
    ...
    void setCurrentCaret(SWTCaret caret) {
        if (caretId != 0)
            OS.g_source_remove(caretId);
        caretId = 0;
        currentCaret = caret;
