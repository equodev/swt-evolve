...
public class SWTCanvas extends SWTComposite implements ICanvas {
     ...
     * @see Widget#getStyle
     */
    public SWTCanvas(SWTComposite parent, int style) {
     ...
     * </ul>
     */
    public void setCaret(ICaret caret_) {
        SWTCaret caret = (SWTCaret) caret_;
        checkWidget();
        SWTCaret newCaret = (SWTCaret) (caret);
        SWTCaret oldCaret = this.caret;
        this.caret = newCaret;
        if (hasFocus()) {
            if (oldCaret != null)
                oldCaret.killFocus();
     ...
     * @since 3.4
     */
    public void setIME(IIME ime_) {
        SWTIME ime = (SWTIME) ime_;
        checkWidget();
