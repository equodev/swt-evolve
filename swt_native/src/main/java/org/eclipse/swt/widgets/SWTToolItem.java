...
public class SWTToolItem extends SWTItem implements IToolItem {
     ...
     * @see Widget#getStyle
     */
    public SWTToolItem(SWTToolBar parent, int style, int index) {
        super(parent, checkStyle(style));
        this.parent = parent;
						 ...
						 */
                            ...
                            if (isArrow) {
                                ...
                                if ((style & SWT.MIRRORED) != 0)
                                    event.x = DPIUtil.autoScaleDown(parent.getClientWidth() - allocation.width) - event.x;
        ...
        if (image != null) {
            ...
            if (imageList != null) {
				 ...
				 */
                    ...
                    OS.g_signal_connect(menuItem, OS.activate, SWTToolBar.menuItemSelectedFunc.getAddress(), handle);
                    return 1;
                }
            }
        }
    ...
    boolean isTabGroup() {
        ...
        if (index == 0)
            return true;
        SWTToolItem previous = (SWTToolItem) (parent.getItem(index - 1));
