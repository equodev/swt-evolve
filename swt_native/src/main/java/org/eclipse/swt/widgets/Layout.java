...
public abstract class Layout {
     ...
     */
    protected abstract Point computeSize(IComposite composite, int wHint, int hHint, boolean flushCache);
     ...
     * @param flushCache <code>true</code> means flush cached layout values
     */
    protected abstract void layout(IComposite composite, boolean flushCache);
}
