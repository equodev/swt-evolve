...
public class SWTDecorations extends SWTCanvas implements IDecorations {
    ...
    SWTControl savedFocus;

    SWTButton defaultButton, saveDefault;
     ...
     * @see Widget#getStyle
     */
    public SWTDecorations(SWTComposite parent, int style) {
    ...
    void addMenu(SWTMenu menu) {
        ...
        SWTMenu[] newMenus = new SWTMenu[menus.length + 4];
    ...
    void fixDecorations(SWTDecorations newDecorations, SWTControl control, SWTMenu[] menus) {
     ...
     */
    public IButton getDefaultButton() {
        checkWidget();
        SWTButton button = (SWTButton) (defaultButton != null ? defaultButton : saveDefault);
    ...
    void setSavedFocus(SWTControl control) {
        if (this == control)
            return;
        savedFocus = control;
    }
