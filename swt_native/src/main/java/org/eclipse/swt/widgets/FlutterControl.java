...
//        return null;
    ...
    public Rectangle getBounds() {
        return builder().getBounds().orElse(new Rectangle(0, 0, 0, 0));
    }
...
//        parent.removeControl(this);
    ...
    public void setCapture(boolean capture) {
        /* FIXME !!!!! */
        /*
         * if (capture) { OS.gtk_widget_grab_focus (handle); } else {
    ...
    /// * TODO: Panning gesture requires a GtkOrientation object. Need to discuss
    // what orientation should be default. */
    // }
    /**
    ...
    public void setOrientation(int orientation) {
        checkWidget();
        if ((orientation & (SWT.LEFT_TO_RIGHT | SWT.RIGHT_TO_LEFT)) == 0)
            return;
