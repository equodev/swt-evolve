 ...
 */
public class FlutterComposite extends FlutterScrollable implements IComposite {
     ...
     * @see Widget#getStyle
     */
    public FlutterComposite(IComposite parent, int style) {
    ...
    public int getBackgroundMode() {
        return builder().getBackgroundMode().orElse(0);
    }
    ...
    public IControl[] getChildren() {
        ...
        return children.stream().filter(IControl.class::isInstance).toArray(IControl[]::new);
    }
    ...
    public Layout getLayout() {
        return builder().getLayout().orElse(null);
    }
    ...
    public boolean getLayoutDeferred() {
        return builder().getLayoutDeferred().orElse(false);
    }
        ...
        try (ExceptionStash exceptions = new ExceptionStash()) {
            for (IControl child : _getChildren()) {
                if (child == null || child.isDisposed())
                    continue;
                try {
                    if (child instanceof FlutterComposite childComposite) {
                        childComposite.release(false);
                    }
                    if (child instanceof SWTComposite childComposite) {
                        childComposite.release(false);
                    }
    ...
    public void setBackgroundMode(int mode) {
        builder().setBackgroundMode(mode);
    ...
    public void setLayoutDeferred(boolean defer) {
        builder().setLayoutDeferred(defer);
        FlutterSwt.dirty(this);
    }
     ...
     * </ul>
     */
    public void setTabList(IControl[] tabList) {
    }
