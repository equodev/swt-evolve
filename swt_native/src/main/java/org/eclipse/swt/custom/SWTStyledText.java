...
public class SWTStyledText extends SWTCanvas implements IStyledText {
     ...
     */
    static class SWTPrinting implements Runnable {
         ...
         */
        SWTPrinting(SWTStyledText styledText, Printer printer, StyledTextPrintOptions printOptions) {
         ...
         * 	line data for.
         */
        void cacheLineData(SWTStyledText styledText) {
            ...
            Point screenDPI = ((SWTDisplay) (styledText.getDisplay())).getDPI();
     ...
     * @see #getStyle
     */
    public SWTStyledText(SWTComposite parent, int style) {
        ...
        if (isBidiCaret()) {
            ...
            Runnable runnable = () -> {
                ...
                if (direction == caretDirection)
                    return;
                if (((SWTCaret) (getCaret())) != defaultCaret)
                    return;
    ...
    void calculateScrollBars() {
        SWTScrollBar horizontalBar = (SWTScrollBar) (getHorizontalBar());
        SWTScrollBar verticalBar = (SWTScrollBar) (getVerticalBar());
        setScrollBars(true);
        if (verticalBar != null) {
    ...
    void doAutoScroll(int direction, int distance) {
        ...
        Runnable timer = null;
        final SWTDisplay display = (SWTDisplay) (getDisplay());
    ...
    public Color getBackground() {
        checkWidget();
        if (background == null) {
            return ((SWTDisplay) (getDisplay())).getSystemColor(SWT.COLOR_LIST_BACKGROUND);
        }
        return background;
    }
     ...
     */
    int getCaretWidth() {
        SWTCaret caret = (SWTCaret) (getCaret());
        if (caret == null)
            return 0;
    ...
    public Color getForeground() {
        checkWidget();
        if (foreground == null) {
            return ((SWTDisplay) (getDisplay())).getSystemColor(SWT.COLOR_LIST_FOREGROUND);
        }
        return foreground;
    }
    ...
    public Color getSelectionBackground() {
        ...
        if (selectionBackground == null) {
            return ((SWTDisplay) (getDisplay())).getSystemColor(SWT.COLOR_LIST_SELECTION);
        }
    ...
    public Color getSelectionForeground() {
        ...
        if (selectionForeground == null) {
            return ((SWTDisplay) (getDisplay())).getSystemColor(SWT.COLOR_LIST_SELECTION_TEXT);
        }
 ...
 */
    ...
    void handleHorizontalScroll(Event event) {
        int scrollPixel = ((SWTScrollBar) (getHorizontalBar())).getSelection() - horizontalScrollOffset;
    ...
    void handleMenuDetect(Event event) {
        if (event.detail == SWT.MENU_KEYBOARD) {
            Point point = ((SWTDisplay) (getDisplay())).map(this, null, getPointAtOffset(caretOffsets[0]));
            event.x = point.x;
    ...
    void handleMouseDown(Event event) {
        ...
        if (event.button == 2) {
            ...
            if (IS_GTK && mouseNavigator != null) {
                ...
                ((SWTDisplay) (getDisplay())).timerExec(200, () -> {
    ...
    void handlePaint(Event event) {
        ...
        if (carets != null) {
            for (int i = 1; i < carets.length; i++) {
                ...
                SWTCaret caret = (SWTCaret) (carets[i]);
                if (caret.isVisible()) {
    ...
    void handleVerticalScroll(Event event) {
        int scrollPixel = ((SWTScrollBar) (getVerticalBar())).getSelection() - getVerticalScrollOffset();
    ...
    void initializeAccessible() {
        ...
        accTextExtendedAdapter = new AccessibleTextExtendedAdapter() {
            ...
            public void getCaretOffset(AccessibleTextEvent e) {
                e.offset = SWTStyledText.this.getCaretOffset();
            }

            @Override
            public void setCaretOffset(AccessibleTextEvent e) {
                SWTStyledText.this.setCaretOffset(e.offset);
                e.result = ACC.OK;
            }

            @Override
            public void getSelectionRange(AccessibleTextEvent e) {
                Point selection = SWTStyledText.this.getSelectionRange();
            ...
            public void addSelection(AccessibleTextEvent e) {
                SWTStyledText st = (SWTStyledText) (SWTStyledText.this);
            ...
            public void getCharacterCount(AccessibleTextEvent e) {
                e.count = SWTStyledText.this.getCharCount();
            }
            ...
            public void getOffsetAtPoint(AccessibleTextEvent e) {
                ...
                SWTDisplay display = (SWTDisplay) (st.getDisplay());
        ...
        accControlAdapter = new AccessibleControlAdapter() {
            ...
            public void getValue(AccessibleControlEvent e) {
                e.result = SWTStyledText.this.getText();
            }
        };
    ...
    String getAssociatedLabel() {
        ...
        for (int i = 0; i < siblings.length; i++) {
            if (siblings[i] == SWTStyledText.this) {
                if (i > 0) {
                    SWTControl sibling = (SWTControl) (siblings[i - 1]);
                    if (sibling instanceof SWTLabel)
                        return ((SWTLabel) sibling).getText();
                    if (sibling instanceof SWTCLabel)
                        return ((SWTCLabel) sibling).getText();
                }
                break;
            }
        }
 ...
 */
    ...
    public void print() {
        ...
        new SWTPrinting(this, printer, options).run();
        printer.dispose();
    }
    ...
    public Runnable print(Printer printer, StyledTextPrintOptions options) {
        ...
        return new SWTPrinting(this, printer, options);
    }
    ...
    public void scroll(int destX, int destY, int x, int y, int width, int height, boolean all) {
        ...
        if (all) {
            ...
            for (SWTControl child : ((SWTControl[]) (getChildren()))) {
    ...
    boolean scrollVertical(int pixels, boolean adjustScrollBar) {
        ...
        if (verticalScrollOffset != -1) {
            ...
            SWTControl[] children = (SWTControl[]) (getChildren());
    ...
    public void setBackground(Color color) {
        ...
        if (!this.enabled && color == null) {
            if (background != null) {
                Color disabledBg = ((SWTDisplay) (getDisplay())).getSystemColor(SWT.COLOR_TEXT_DISABLED_BACKGROUND);
     ...
     */
    @Override
    public void setCaret(ICaret caret__) {
        SWTCaret caret_ = (SWTCaret) caret__;
        SWTCaret caret = (SWTCaret) caret_;
        checkWidget();
    ...
    void setCaretLocations(final Point[] locations, int direction) {
        SWTCaret firstCaret = (SWTCaret) (getCaret());
        if (firstCaret != null) {
            if (carets == null || carets.length == 0) {
                carets = new SWTCaret[] { firstCaret };
            }
            ...
            if (locations.length > carets.length) {
                ...
                for (int i = formerCaretCount; i < carets.length; i++) {
                    carets[i] = new SWTCaret(this, firstCaret.getStyle());
            ...
            for (int i = Math.min(caretOffsets.length, locations.length) - 1; i >= 0; i--) {
                ...
                final SWTCaret caret = (SWTCaret) (carets[i]);
    ...
    void setClipboardContent(int start, int length, int clipboardType) throws SWTError {
        ...
        if (clipboardType == DND.SELECTION_CLIPBOARD) {
            ...
            try {
                ...
                RTFWriter rtfWriter = new RTFWriter(StyledText.getInstance(this), start, length);
                String rtfText = getPlatformDelimitedText(rtfWriter);
                HTMLTransfer htmlTransfer = HTMLTransfer.getInstance();
                HTMLWriter htmlWriter = new HTMLWriter(StyledText.getInstance(this), start, length, content);
    ...
    public void setForeground(Color color) {
        ...
        if (!this.enabled && color == null) {
            if (foreground != null) {
                Color disabledFg = ((SWTDisplay) (getDisplay())).getSystemColor(SWT.COLOR_WIDGET_DISABLED_FOREGROUND);
    ...
    public void setLineVerticalIndent(int lineIndex, int verticalLineIndent) {
        ...
        SWTScrollBar verticalScrollbar = (SWTScrollBar) (getVerticalBar());
    ...
    void setScrollBar(SWTScrollBar bar, int clientArea, int maximum, int margin) {
        int inactive = 1;
    ...
    void setScrollBars(boolean vertical) {
        ...
        if (!isFixedLineHeight() || !alwaysShowScroll)
            vertical = true;
        SWTScrollBar verticalBar = (SWTScrollBar) (vertical ? getVerticalBar() : null);
        SWTScrollBar horizontalBar = (SWTScrollBar) (getHorizontalBar());
        int oldHeight = clientAreaHeight;
        int oldWidth = clientAreaWidth;
        if (!alwaysShowScroll) {
     ...
     */
    public static void updateAndRefreshCarets(SWTStyledText styledText, Consumer<SWTCaret> caretUpdater) {
        caretUpdater.accept(((SWTCaret) (styledText.getCaret())));
        caretUpdater.accept(styledText.defaultCaret);
        for (SWTCaret caret : styledText.carets) {
