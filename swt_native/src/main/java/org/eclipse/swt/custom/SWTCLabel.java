 ...
 */
public class SWTCLabel extends SWTCanvas implements ICLabel {
     ...
     * @see #getStyle()
     */
    public SWTCLabel(SWTComposite parent, int style) {
 ...
 */
    ...
    private void initAccessible() {
        ...
        accessible.addAccessibleControlListener(new AccessibleControlAdapter() {
            ...
            public void getLocation(AccessibleControlEvent e) {
                Rectangle rect = ((SWTDisplay) (getDisplay())).map(((SWTComposite) (getParent())), null, getBounds());
                e.x = rect.x;
                e.y = rect.y;
                e.width = rect.width;
    ...
    private void paintBorder(GC gc, Rectangle r) {
        SWTDisplay disp = (SWTDisplay) (getDisplay());
        Color c1 = null;
        Color c2 = null;
        int style = getStyle();
    ...
    protected String shortenText(GC gc, String t, int width) {
        ...
        if (mid <= 0)
            return t;
        TextLayout layout = new TextLayout(((SWTDisplay) (getDisplay())));
        layout.setText(t);
