...
public class SWTSashForm extends SWTComposite implements ISashForm {
     ...
     * @see #getStyle()
     */
    public SWTSashForm(SWTComposite parent, int style) {
    ...
    SWTSash createSash() {
        SWTSash sash = new SWTSash(this, sashStyle);
     ...
     */
    public IControl getMaximizedControl() {
        /*
	 * This call is intentionally commented out, to allow this getter method to be
	 * called from a thread which is different from one that created the widget.
	 */
    ...
    void onDragSash(Event event) {
        SWTSash sash = (SWTSash) ((SWTSash) (SWTSash) (event.widget != null ? event.widget.delegate : null));
        int sashIndex = -1;
        ...
        if (sashIndex == -1)
            return;
        SWTControl c1 = (SWTControl) (controls[sashIndex]);
        SWTControl c2 = (SWTControl) (controls[sashIndex + 1]);
     ...
     * </ul>
     */
    public void setMaximizedControl(IControl control_) {
