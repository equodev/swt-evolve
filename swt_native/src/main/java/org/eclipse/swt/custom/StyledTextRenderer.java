...
class StyledTextRenderer {
    ...
    StyledTextRenderer(Device device, SWTStyledText styledText) {
        this.device = device;
    ...
    void calculateIdle() {
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                if (i < lineCount) {
                    SWTDisplay display = (SWTDisplay) (styledText.getDisplay());
                    display.asyncExec(this);
                } else {
                    idleRunning = false;
                    styledText.setScrollBars(true);
                    SWTScrollBar bar = (SWTScrollBar) (styledText.getVerticalBar());
                    if (bar != null) {
