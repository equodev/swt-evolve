...
/**
 * Auto-generated sizing for ProgressBar widgets.
 * Generated from Flutter measurements.
 *
 * DO NOT EDIT MANUALLY - regenerate from measure.dart
 */
public class ProgressBarSizes {

    static class HORIZONTAL {
        static final double MIN_WIDTH = 200.0;
    ...
    public static Point computeSize(DartProgressBar widget, int wHint, int hHint, boolean changed) {
        return computeSizes(widget, wHint, hHint, changed).widget;
    }

    static Measure computeSizes(DartProgressBar widget, int wHint, int hHint, boolean changed) {
        ...
        } else { // HORIZONTAL, HORIZONTAL|SMOOTH, HORIZONTAL|INDETERMINATE, VERTICAL|SMOOTH, VERTICAL|INDETERMINATE
