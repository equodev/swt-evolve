...
ToolItemThemeExtension _$ToolItemThemeExtensionFromJson(
  ...
  enabledColor: const ColorConverter().fromJson(json['enabledColor'] as String),
  ...
  dropdownIconColor: const ColorConverter().fromJson(
    json['dropdownIconColor'] as String,
  ),
  ...
  hoverZoomEnabled: json['hoverZoomEnabled'] as bool,
  hoverZoomScale: (json['hoverZoomScale'] as num).toDouble(),
  hoverZoomDuration: Duration(
    microseconds: (json['hoverZoomDuration'] as num).toInt(),
  ),
  iconSize: (json['iconSize'] as num).toDouble(),
  emptyButtonSize: (json['emptyButtonSize'] as num).toDouble(),
  dropdownArrowSize: (json['dropdownArrowSize'] as num).toDouble(),
  buttonPadding: const EdgeInsetsConverter().fromJson(
    json['buttonPadding'] as Map<String, dynamic>,
  ),
  textPadding: const EdgeInsetsConverter().fromJson(
    json['textPadding'] as Map<String, dynamic>,
  ),
  ...
  separatorBarMargin: const EdgeInsetsConverter().fromJson(
    json['separatorBarMargin'] as Map<String, dynamic>,
  ),
  tooltipMargin: const EdgeInsetsConverter().fromJson(
    json['tooltipMargin'] as Map<String, dynamic>,
  ),
  tooltipWaitDuration: Duration(
    microseconds: (json['tooltipWaitDuration'] as num).toInt(),
  ),
  segmentSelectedBackgroundColor: const ColorConverter().fromJson(
    json['segmentSelectedBackgroundColor'] as String,
  ),
  segmentInnerColor: const ColorConverter().fromJson(
    json['segmentInnerColor'] as String,
  ),
  segmentUnselectedBackgroundColor: const ColorConverter().fromJson(
    json['segmentUnselectedBackgroundColor'] as String,
  ),
  segmentSelectedTextColor: const ColorConverter().fromJson(
    json['segmentSelectedTextColor'] as String,
  ),
  segmentUnselectedTextColor: const ColorConverter().fromJson(
    json['segmentUnselectedTextColor'] as String,
  ),
  segmentBorderRadius: (json['segmentBorderRadius'] as num).toDouble(),
  segmentPadding: const EdgeInsetsConverter().fromJson(
    json['segmentPadding'] as Map<String, dynamic>,
  ),
  loadingIndicatorSizeFactor: (json['loadingIndicatorSizeFactor'] as num)
      .toDouble(),
  loadingIndicatorStrokeWidth: (json['loadingIndicatorStrokeWidth'] as num)
      .toDouble(),
  ...
  specialDropdownImageFilename: json['specialDropdownImageFilename'] as String?,
  specialDropdownText: json['specialDropdownText'] as String,
  specialDropdownBackgroundColor: const ColorConverter().fromJson(
    json['specialDropdownBackgroundColor'] as String,
  ),
  specialDropdownTextColor: const ColorConverter().fromJson(
    json['specialDropdownTextColor'] as String,
  ),
  specialDropdownSeparatorColor: const ColorConverter().fromJson(
    json['specialDropdownSeparatorColor'] as String,
  ),
  specialDropdownArrowColor: const ColorConverter().fromJson(
    json['specialDropdownArrowColor'] as String,
  ),
  specialDropdownPadding: const EdgeInsetsConverter().fromJson(
    json['specialDropdownPadding'] as Map<String, dynamic>,
  ),
  specialDropdownItemSpacing: (json['specialDropdownItemSpacing'] as num)
      .toDouble(),
  fontStyle: const TextStyleConverter().fromJson(
...
Map<String, dynamic> _$ToolItemThemeExtensionToJson(
  ...
  'hoverZoomEnabled': instance.hoverZoomEnabled,
  'hoverZoomScale': instance.hoverZoomScale,
  'hoverZoomDuration': instance.hoverZoomDuration.inMicroseconds,
  'iconSize': instance.iconSize,
  'emptyButtonSize': instance.emptyButtonSize,
  'dropdownArrowSize': instance.dropdownArrowSize,
  'buttonPadding': const EdgeInsetsConverter().toJson(instance.buttonPadding),
  ...
  'separatorBarMargin': const EdgeInsetsConverter().toJson(
    instance.separatorBarMargin,
  ),
  'tooltipMargin': const EdgeInsetsConverter().toJson(instance.tooltipMargin),
  'tooltipWaitDuration': instance.tooltipWaitDuration.inMicroseconds,
  'segmentSelectedBackgroundColor': const ColorConverter().toJson(
    instance.segmentSelectedBackgroundColor,
  ),
  'segmentInnerColor': const ColorConverter().toJson(
    instance.segmentInnerColor,
  ),
  'segmentUnselectedBackgroundColor': const ColorConverter().toJson(
    instance.segmentUnselectedBackgroundColor,
  ),
  'segmentSelectedTextColor': const ColorConverter().toJson(
    instance.segmentSelectedTextColor,
  ),
  'segmentUnselectedTextColor': const ColorConverter().toJson(
    instance.segmentUnselectedTextColor,
  ),
  'segmentBorderRadius': instance.segmentBorderRadius,
  'segmentPadding': const EdgeInsetsConverter().toJson(instance.segmentPadding),
  ...
  'segmentAnimationDuration': instance.segmentAnimationDuration.inMicroseconds,
  ...
  'specialDropdownTextColor': const ColorConverter().toJson(
    instance.specialDropdownTextColor,
  ),
  'specialDropdownSeparatorColor': const ColorConverter().toJson(
    instance.specialDropdownSeparatorColor,
  ),
  'specialDropdownArrowColor': const ColorConverter().toJson(
    instance.specialDropdownArrowColor,
  ),
  'specialDropdownPadding': const EdgeInsetsConverter().toJson(
    instance.specialDropdownPadding,
  ),
