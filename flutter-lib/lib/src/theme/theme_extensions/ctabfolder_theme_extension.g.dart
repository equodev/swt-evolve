...
CTabFolderThemeExtension _$CTabFolderThemeExtensionFromJson(
    ...
    CTabFolderThemeExtension(
      ...
      tabUnselectedTextOpacity:
          (json['tabUnselectedTextOpacity'] as num).toDouble(),
      tabCloseButtonSelectedOpacity:
          (json['tabCloseButtonSelectedOpacity'] as num).toDouble(),
      tabCloseButtonUnselectedOpacity:
          (json['tabCloseButtonUnselectedOpacity'] as num).toDouble(),
      tabHighlightColor:
          const ColorConverter().fromJson(json['tabHighlightColor'] as String),
      ...
      tabHighlightBorderWidth:
          (json['tabHighlightBorderWidth'] as num).toDouble(),
      ...
      tabCloseIconBottomPadding:
          (json['tabCloseIconBottomPadding'] as num).toDouble(),
      controlButtonColor:
          const ColorConverter().fromJson(json['controlButtonColor'] as String),
      controlButtonHoverColor: const ColorConverter()
          .fromJson(json['controlButtonHoverColor'] as String),
      ...
      hoverRevealDuration:
          Duration(microseconds: (json['hoverRevealDuration'] as num).toInt()),
      hoverHideDuration:
          Duration(microseconds: (json['hoverHideDuration'] as num).toInt()),
...
Map<String, dynamic> _$CTabFolderThemeExtensionToJson(
    ...
    <String, dynamic>{
      ...
      'tabCloseButtonUnselectedOpacity':
          instance.tabCloseButtonUnselectedOpacity,
      'tabHighlightColor':
          const ColorConverter().toJson(instance.tabHighlightColor),
      ...
      'controlButtonColor':
          const ColorConverter().toJson(instance.controlButtonColor),
      'controlButtonHoverColor':
          const ColorConverter().toJson(instance.controlButtonHoverColor),
