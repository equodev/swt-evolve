...
SashFormValue _$SashFormValueFromJson(Map<String, dynamic> json) =>
    SashFormValue()
...
Map<String, dynamic> _$SashFormValueToJson(SashFormValue instance) {
  ...
  writeNotNull('sashWidth', instance.sashWidth);
  return val;
}
