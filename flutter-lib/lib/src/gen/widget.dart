...
abstract class WidgetSwtState<T extends WidgetSwt, V extends VWidget> extends State<T> {
  late V state;
...
@JsonSerializable() class VWidget {
  VWidget() : this.empty();
  ...
  Map<String, dynamic> toJson() => throw UnsupportedError("Unsupported toJson in Widget");
}