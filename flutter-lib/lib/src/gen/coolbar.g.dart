...
VCoolBar _$VCoolBarFromJson(Map<String, dynamic> json) => VCoolBar()
...
Map<String, dynamic> _$VCoolBarToJson(VCoolBar instance) => <String, dynamic>{
      'swt': instance.swt,
      'id': instance.id,
      ...
      'wrapIndices': instance.wrapIndices,
    };
