...
class GCSwt<V extends VGC> extends WidgetSwt<V> {
  ...
  State createState() => GCImpl<GCSwt<VGC>, VGC>();
          ...
          abstract class GCState<T extends GCSwt, V extends VGC> extends WidgetSwtState<T, V> {          @override
          void initState() {
            super.initState();
            _registerListeners();
          }
    ...
    onOp("drawRoundRectangle", (p) => onDrawRoundRectangle(VGCDrawRoundRectangle.fromJson(p)));
    onOp("drawText", (p) => onDrawText(VGCDrawText.fromJson(p)));
    onOp("fillArc", (p) => onFillArc(VGCFillArc.fromJson(p)));
    onOp("fillGradientRectangle", (p) => onFillGradientRectangle(VGCFillGradientRectangle.fromJson(p)));
    ...
    onOp("fillRoundRectangle", (p) => onFillRoundRectangle(VGCFillRoundRectangle.fromJson(p)));
          }
...
@JsonSerializable() class VGC extends VWidget {
  VGC() : this.empty();
  VGC.empty()  { swt = "GC"; }
  ...
  bool paint;
              ...
              VGCCopyArea({this.srcX = 0, this.srcY = 0, this.width = 0, this.height = 0, this.destX = 0, this.destY = 0, this.paint = false});

              factory VGCCopyArea.fromJson(Map<String, dynamic> json) => _$VGCCopyAreaFromJson(json);
  ...
  int y;
              ...
              factory VGCCopyAreaImage.fromJson(Map<String, dynamic> json) => _$VGCCopyAreaImageFromJson(json);
  ...
  int arcAngle;
              ...
              VGCDrawArc({this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.startAngle = 0, this.arcAngle = 0});

              factory VGCDrawArc.fromJson(Map<String, dynamic> json) => _$VGCDrawArcFromJson(json);
  ...
  int height;
              ...
              factory VGCDrawFocus.fromJson(Map<String, dynamic> json) => _$VGCDrawFocusFromJson(json);
  ...
  bool simple;
              ...
              VGCDrawImage({this.srcX = 0, this.srcY = 0, this.srcWidth = 0, this.srcHeight = 0, this.destX = 0, this.destY = 0, this.destWidth = 0, this.destHeight = 0, this.simple = false});

              factory VGCDrawImage.fromJson(Map<String, dynamic> json) => _$VGCDrawImageFromJson(json);
  ...
  int y2;
              ...
              factory VGCDrawLine.fromJson(Map<String, dynamic> json) => _$VGCDrawLineFromJson(json);
  ...
  int height;
              ...
              factory VGCDrawOval.fromJson(Map<String, dynamic> json) => _$VGCDrawOvalFromJson(json);
  ...
  int y;
              ...
              factory VGCDrawPoint.fromJson(Map<String, dynamic> json) => _$VGCDrawPointFromJson(json);
            ...
            class VGCDrawPolygon {
              ...
              factory VGCDrawPolygon.fromJson(Map<String, dynamic> json) => _$VGCDrawPolygonFromJson(json);
            ...
            class VGCDrawPolyline {
              ...
              factory VGCDrawPolyline.fromJson(Map<String, dynamic> json) => _$VGCDrawPolylineFromJson(json);
  ...
  int height;
              ...
              factory VGCDrawRectangle.fromJson(Map<String, dynamic> json) => _$VGCDrawRectangleFromJson(json);
  ...
  int arcHeight;
              ...
              VGCDrawRoundRectangle({this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.arcWidth = 0, this.arcHeight = 0});

              factory VGCDrawRoundRectangle.fromJson(Map<String, dynamic> json) => _$VGCDrawRoundRectangleFromJson(json);
  ...
  int flags;
              ...
              factory VGCDrawText.fromJson(Map<String, dynamic> json) => _$VGCDrawTextFromJson(json);
  ...
  int arcAngle;
              ...
              VGCFillArc({this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.startAngle = 0, this.arcAngle = 0});

              factory VGCFillArc.fromJson(Map<String, dynamic> json) => _$VGCFillArcFromJson(json);
  ...
  bool vertical;
              ...
              VGCFillGradientRectangle({this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.vertical = false});

              factory VGCFillGradientRectangle.fromJson(Map<String, dynamic> json) => _$VGCFillGradientRectangleFromJson(json);
  ...
  int height;
              ...
              factory VGCFillOval.fromJson(Map<String, dynamic> json) => _$VGCFillOvalFromJson(json);
            ...
            class VGCFillPolygon {
              ...
              factory VGCFillPolygon.fromJson(Map<String, dynamic> json) => _$VGCFillPolygonFromJson(json);
  ...
  int height;
              ...
              factory VGCFillRectangle.fromJson(Map<String, dynamic> json) => _$VGCFillRectangleFromJson(json);
  ...
  int arcHeight;
              ...
              VGCFillRoundRectangle({this.x = 0, this.y = 0, this.width = 0, this.height = 0, this.arcWidth = 0, this.arcHeight = 0});

              factory VGCFillRoundRectangle.fromJson(Map<String, dynamic> json) => _$VGCFillRoundRectangleFromJson(json);
