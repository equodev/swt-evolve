...
part of 'cbanner.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VCBanner _$VCBannerFromJson(Map<String, dynamic> json) => VCBanner()
  ...
  ..bottom = json['bottom'] == null
      ? null
      : VControl.fromJson(json['bottom'] as Map<String, dynamic>)
  ..left = json['left'] == null
      ? null
      : VControl.fromJson(json['left'] as Map<String, dynamic>)
  ..right = json['right'] == null
      ? null
      : VControl.fromJson(json['right'] as Map<String, dynamic>)
  ..rightMinimumSize = json['rightMinimumSize'] == null
      ? null
      : VPoint.fromJson(json['rightMinimumSize'] as Map<String, dynamic>)
  ..rightWidth = (json['rightWidth'] as num?)?.toInt()
  ..simple = json['simple'] as bool?;

Map<String, dynamic> _$VCBannerToJson(VCBanner instance) => <String, dynamic>{
  'swt': instance.swt,
  'id': instance.id,
  ...
  'rightMinimumSize': ?instance.rightMinimumSize,
