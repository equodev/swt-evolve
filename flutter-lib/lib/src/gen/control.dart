...
@JsonSerializable() class VControl extends VWidget {
  VControl() : this.empty();
  VControl.empty()  { swt = "Control"; }
  ...
  factory VControl.fromJson(Map<String, dynamic> json) => mapWidgetValue(json) as VControl;
  Map<String, dynamic> toJson() => throw UnsupportedError("Unsupported toJson in Control");
}