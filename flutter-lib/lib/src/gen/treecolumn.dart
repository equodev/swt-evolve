...
class TreeColumnSwt<V extends VTreeColumn> extends ItemSwt<V> {
  ...
  @override
  State createState() => TreeColumnImpl<TreeColumnSwt<VTreeColumn>, VTreeColumn>();
...
@JsonSerializable() class VTreeColumn extends VItem {
  VTreeColumn() : this.empty();
  VTreeColumn.empty()  { swt = "TreeColumn"; }
  ...
  factory VTreeColumn.fromJson(Map<String, dynamic> json) => _$VTreeColumnFromJson(json);
