...
GestureDetector createGestureDetector(
  ...
  return GestureDetector(
    onSecondaryTapUp: (clickDetails) {
      _generateMenu(context, state, contextAttachKey, clickDetails, items);
    },
    child: Container(key: contextAttachKey, child: widget),
  );
}
...
void _generateMenu(
  ...
  showMenu(
    ...
    items: [PopupMenuItem(child: mapWidgetFromValue(state.menu as VMenu))],
    color: Colors.white,
  );
}
