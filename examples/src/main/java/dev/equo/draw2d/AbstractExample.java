...
public abstract class AbstractExample {
	...
	protected static final Font COURIER = new Font(Display.getDefault(), COURIER2, 9, 0);
	protected static final Font BOLD = new Font(Display.getDefault(), HELVETICA, 10, SWT.BOLD);
	protected static final Font ITALICS = new Font(Display.getDefault(), HELVETICA, 10, SWT.ITALIC);
	protected static final Font HEADING_1 = new Font(Display.getDefault(), HELVETICA, 15, SWT.BOLD);
